...
typedef struct _USBD_STORAGE {
   uint8_t (*Init)(uint8_t lun);
   uint8_t (*GetCapacity)(uint8_t lun, uint32_t *block_num,
                          uint16_t *block_size);
   uint8_t (*IsReady)(uint8_t lun);
   uint8_t (*IsWriteProtected)(uint8_t lun);
   uint8_t (*Read)(uint8_t lun, uint8_t *buf, uint32_t blk_addr,
                   uint16_t blk_len);
   uint8_t (*Write)(uint8_t lun, uint8_t *buf, uint32_t blk_addr,
                    uint16_t blk_len);
