...
typedef struct {
   ...
   uint32_t
       HorizontalSync; /*!< configures the number of Horizontal synchronization
   ...
   uint32_t AccumulatedHBP; /*!< configures the accumulated horizontal back
                               porch width. This parameter must be a number
                               between Min_Data = LTDC_HorizontalSync and
                               Max_Data = 0xFFF. */

   uint32_t AccumulatedVBP; /*!< configures the accumulated vertical back porch
                               height. This parameter must be a number between
                                 Min_Data = LTDC_VerticalSync and Max_Data =
                               0x7FF. */

   uint32_t AccumulatedActiveW; /*!< configures the accumulated active width.
                                     This parameter must be a number between
                                     Min_Data = LTDC_AccumulatedHBP and Max_Data
                                   = 0xFFF. */

   uint32_t AccumulatedActiveH; /*!< configures the accumulated active height.
                                     This parameter must be a number between
                                     Min_Data = LTDC_AccumulatedVBP and Max_Data
                                   = 0x7FF. */

   uint32_t TotalWidth; /*!< configures the total width.
                             This parameter must be a number between
                             Min_Data = LTDC_AccumulatedActiveW and Max_Data =
                           0xFFF. */

   uint32_t TotalHeigh; /*!< configures the total height.
                             This parameter must be a number between
                             Min_Data = LTDC_AccumulatedActiveH and Max_Data =
                           0x7FF. */
   ...
   LTDC_ExtDispTypeDef
       ExtDisp; /*!< Configure the external display interface. */
} LTDC_InitTypeDef;
...
typedef struct {
   ...
   uint8_t BlendingOrder; /*!< Select the blending order.
                           This parameter can be one of between Min_Data = 0x00
                           and Max_Data = 0x0F. */
   ...
   uint8_t BurstLength; /*!< Select the burst length.
                       ...
                       and Max_Data = 0x10. */
   LTDC_PlanarTypeDef
       Planar; /*!< Configures the planar or semiplanar buffer. */
   ...
   LTDC_ConversionTypeDef
       Conversion; /*!< Configure the conversion YCbCr to RGB. */
...
#endif /* USE_HAL_LTDC_REGISTER_CALLBACKS */
{
   ...
   void (*LineEventCallback)(
       struct __LTDC_HandleTypeDef *hltdc); /*!< LTDC Line Event Callback    */
   void (*ReloadEventCallback)(
       struct __LTDC_HandleTypeDef *hltdc); /*!< LTDC Reload Event Callback  */
   void (*ErrorCallback)(
       struct __LTDC_HandleTypeDef *hltdc); /*!< LTDC Error Callback         */

   void (*SecureLineEventCallback)(
       struct __LTDC_HandleTypeDef *hltdc); /*!< LTDC Line Event Callback    */
   void (*SecureReloadEventCallback)(
       struct __LTDC_HandleTypeDef *hltdc); /*!< LTDC Reload Event Callback  */
   void (*SecureErrorCallback)(
       struct __LTDC_HandleTypeDef *hltdc); /*!< LTDC Error Callback         */

   void (*MspInitCallback)(
       struct __LTDC_HandleTypeDef *hltdc); /*!< LTDC Msp Init callback      */
   void (*MspDeInitCallback)(
       struct __LTDC_HandleTypeDef *hltdc); /*!< LTDC Msp DeInit callback    */
...
typedef enum {
   ...
   HAL_LTDC_SECURE_LINE_EVENT_CB_ID =
       0x05U, /*!< LTDC Secure Line Event Callback ID    */
   HAL_LTDC_SECURE_RELOAD_EVENT_CB_ID =
       0x06U, /*!< LTDC Secure Reload Callback ID        */
 ...
 */
typedef void (*pLTDC_CallbackTypeDef)(
    LTDC_HandleTypeDef *hltdc); /*!< pointer to an LTDC callback function */
...
#define HAL_LTDC_ERROR_INVALID_CALLBACK                                        \
   0x00000040U /*!< LTDC Invalid Callback error  */
#endif         /* USE_HAL_LTDC_REGISTER_CALLBACKS */
/**
 * @}
 */
...
#define LTDC_HSPOLARITY_AL                                                     \
   0x00000000U /*!< Horizontal Synchronization is active low. */
...
#define LTDC_VSPOLARITY_AL                                                     \
   0x00000000U /*!< Vertical Synchronization is active low. */
#define LTDC_VSPOLARITY_AH                                                     \
   LTDC_GCR_VSPOL /*!< Vertical Synchronization is active high. */
/**
 * @}
 */
...
#define LTDC_PIXEL_FORMAT_ABGR8888                                             \
   0x00000001U /*!< ABGR8888 LTDC pixel format             */
#define LTDC_PIXEL_FORMAT_RGBA8888                                             \
   0x00000002U /*!< RGBA8888 LTDC pixel format             */
#define LTDC_PIXEL_FORMAT_BGRA8888                                             \
   0x00000003U /*!< BGRA8888 LTDC pixel format             */
#define LTDC_PIXEL_FORMAT_RGB565                                               \
   0x00000004U /*!< RGB565 LTDC pixel format               */
#define LTDC_PIXEL_FORMAT_BGR565                                               \
   0x00000005U /*!< RGB565 LTDC pixel format               */
#define LTDC_PIXEL_FORMAT_RGB888                                               \
   0x00000006U /*!< RGB888 LTDC pixel format               */
#define LTDC_PIXEL_FORMAT_ARGB1555                                             \
   0x00000007U /*!< ARGB1555 LTDC pixel format             */
#define LTDC_PIXEL_FORMAT_ARGB4444                                             \
   0x00000008U /*!< ARGB4444 LTDC pixel format             */
#define LTDC_PIXEL_FORMAT_L8                                                   \
   0x00000009U /*!< L8 LTDC pixel format                   */
#define LTDC_PIXEL_FORMAT_AL44                                                 \
   0x0000000AU /*!< AL44 LTDC pixel format                 */
#define LTDC_PIXEL_FORMAT_AL88                                                 \
   0x0000000BU /*!< AL88 LTDC pixel format                 */
#define LTDC_PIXEL_FORMAT_UYVY                                                 \
   0x0000000CU /*!< UYVY Interleave LTDC pixel format      */
#define LTDC_PIXEL_FORMAT_VYUY                                                 \
   0x0000000DU /*!< VYUY Interleave LTDC pixel format      */
#define LTDC_PIXEL_FORMAT_YUYV                                                 \
   0x0000000EU /*!< YUYV Interleave LTDC pixel format      */
#define LTDC_PIXEL_FORMAT_YVYU                                                 \
   0x0000000FU /*!< YVYU Interleave LTDC pixel format      */
#define LTDC_PIXEL_FORMAT_NV12                                                 \
   0x00000010U /*!< NV12 Semi Planar LTDC pixel format     */
#define LTDC_PIXEL_FORMAT_NV21                                                 \
   0x00000011U /*!< NV21 Semi Planar LTDC pixel format     */
#define LTDC_PIXEL_FORMAT_YUV420                                               \
   0x00000012U /*!< YUV420 Full Planar LTDC pixel format   */
#define LTDC_PIXEL_FORMAT_YVU420                                               \
   0x00000013U /*!< YVU420 Full Planar LTDC pixel format   */
/**
 * @}
 */
...
#define LTDC_STOPPOSITION                                                      \
   (LTDC_LxWHPCR_WHSPPOS >> 16U) /*!< LTDC Layer stop position  */
#define LTDC_STARTPOSITION                                                     \
   LTDC_LxWHPCR_WHSTPOS /*!< LTDC Layer start position */

#define LTDC_COLOR_FRAME_BUFFER                                                \
   LTDC_LxCFBLR_CFBLL                          /*!< LTDC Layer Line length    */
...
#define LTDC_FLAG_UK                                                           \
   LTDC_ISR_FUKIF                   /*!< LTDC FIFO Underrun Killing Interrupt  \
                                     */
 ...
 *                     This parameter can be LTDC_LAYER_1 (0) or LTDC_LAYER_2
 * (1).
 * @retval None.
 */
 ...
 * @retval The state of FLAG (SET or RESET).
 */
#define __HAL_LTDC_GET_SECURE_FLAG(__HANDLE__, __FLAG__)                       \
   ((__HANDLE__)->Instance->ISR2 & (__FLAG__))
 ...
 * @retval None
 */
#define __HAL_LTDC_CLEAR_SECURE_FLAG(__HANDLE__, __FLAG__)                     \
   ((__HANDLE__)->Instance->ICR2 = (__FLAG__))
 ...
 * @retval None
 */
#define __HAL_LTDC_ENABLE_SECURE_IT(__HANDLE__, __INTERRUPT__)                 \
   ((__HANDLE__)->Instance->IER2 |= (__INTERRUPT__))
 ...
 * @retval None
 */
#define __HAL_LTDC_DISABLE_SECURE_IT(__HANDLE__, __INTERRUPT__)                \
   ((__HANDLE__)->Instance->IER2 &= ~(__INTERRUPT__))

/**
 * @brief  Check whether the specified LTDC Secure interrupt has occurred or
 * not.
 * @param  __HANDLE__  LTDC handle
 * @param __INTERRUPT__ Specify the LTDC interrupt source to check.
 *          This parameter can be one of the following values:
 ...
 * @retval The state of INTERRUPT (SET or RESET).
 */
#define __HAL_LTDC_GET_SECURE_IT_SOURCE(__HANDLE__, __INTERRUPT__)             \
   ((__HANDLE__)->Instance->IER2 & (__INTERRUPT__))
/**
 * @}
 */
...
HAL_StatusTypeDef HAL_LTDC_ProgramSecureLineEvent(LTDC_HandleTypeDef *hltdc,
                                                  uint32_t Line);
...
#if (USE_HAL_LTDC_REGISTER_CALLBACKS == 1)
HAL_StatusTypeDef
HAL_LTDC_RegisterCallback(LTDC_HandleTypeDef *hltdc,
                          HAL_LTDC_CallbackIDTypeDef CallbackID,
                          pLTDC_CallbackTypeDef pCallback);
HAL_StatusTypeDef
HAL_LTDC_UnRegisterCallback(LTDC_HandleTypeDef *hltdc,
                            HAL_LTDC_CallbackIDTypeDef CallbackID);
#endif /* USE_HAL_LTDC_REGISTER_CALLBACKS */
...
HAL_StatusTypeDef HAL_LTDC_Reload(LTDC_HandleTypeDef *hltdc,
                                  uint32_t ReloadType);
HAL_StatusTypeDef HAL_LTDC_Layer_Reload(LTDC_HandleTypeDef *hltdc,
                                        uint32_t LayerIdx, uint32_t ReloadType);
...
HAL_StatusTypeDef HAL_LTDC_SetAlpha_NoReload(LTDC_HandleTypeDef *hltdc,
                                             uint32_t Alpha, uint32_t LayerIdx);
...
HAL_StatusTypeDef HAL_LTDC_ConfigGamma(LTDC_HandleTypeDef *hltdc,
                                       LTDC_GammaTypeDef *pGamma,
                                       uint32_t GammaSize);

HAL_StatusTypeDef HAL_LTDC_SetExpectedCRC(LTDC_HandleTypeDef *hltdc,
...
HAL_StatusTypeDef HAL_LTDC_EnableColorBlending(LTDC_HandleTypeDef *hltdc,
                                               uint32_t LayerIdx);
HAL_StatusTypeDef HAL_LTDC_DisableColorBlending(LTDC_HandleTypeDef *hltdc,
                                                uint32_t LayerIdx);
...
#define LTDC_LAYER(__HANDLE__, __LAYER__)                                      \
   ((LTDC_Layer_TypeDef *)((uint32_t)(((uint32_t)((__HANDLE__)->Instance)) +   \
                                      0x100U + (0x100U * (__LAYER__)))))

#define IS_LTDC_LAYER(__LAYER__) ((__LAYER__) < MAX_LAYER)
#define IS_LTDC_HSPOL(__HSPOL__)                                               \
   (((__HSPOL__) == LTDC_HSPOLARITY_AL) || ((__HSPOL__) == LTDC_HSPOLARITY_AH))
#define IS_LTDC_VSPOL(__VSPOL__)                                               \
   (((__VSPOL__) == LTDC_VSPOLARITY_AL) || ((__VSPOL__) == LTDC_VSPOLARITY_AH))
#define IS_LTDC_DEPOL(__DEPOL__)                                               \
   (((__DEPOL__) == LTDC_DEPOLARITY_AL) || ((__DEPOL__) == LTDC_DEPOLARITY_AH))
