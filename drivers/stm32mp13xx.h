...
#define __STM32MP13xx_CMSIS_VERSION_SUB1 (0x02U) /*!< [23:16] sub1 version */
#define __STM32MP13xx_CMSIS_VERSION_SUB2 (0x00U) /*!< [15:8]  sub2 version */
#define __STM32MP13xx_CMSIS_VERSION_RC                                         \
   (0x00U) /*!< [7:0]  release candidate                                       \
            */
#define __STM32MP13xx_CMSIS_VERSION                                            \
 ...
 */
#if defined(CORE_CA7)
#if defined(STM32MP13xx) /* keep for backward compatibility STM32MP13xx =      \
                            STM32MP135Cxx */
...
#else
#error                                                                         \
    "Please select first the target STM32MP13xx device used in your application (in stm32mp1xx.h file)"
#endif
#endif
