...
#define ETH_MACL4CR_MASK                                                       \
   (ETH_MACL3L4C0R_L4PEN0 | ETH_MACL3L4C0R_L4SPM0 | ETH_MACL3L4C0R_L4SPIM0 |   \
    ETH_MACL3L4C0R_L4DPM0 | ETH_MACL3L4C0R_L4DPIM0)

#define ETH_MACL3CR_MASK                                                       \
   (ETH_MACL3L4C0R_L3PEN0 | ETH_MACL3L4C0R_L3SAM0 | ETH_MACL3L4C0R_L3SAIM0 |   \
    ETH_MACL3L4C0R_L3DAM0 | ETH_MACL3L4C0R_L3DAIM0 | ETH_MACL3L4C0R_L3HSBM0 |  \
                            ...
                            ETH_L4FilterConfigTypeDef *pL4FilterConfig)
{
   ...
   if (Filter == ETH_L4_FILTER_0) {
      ...
      pL4FilterConfig->Protocol =
          READ_BIT(heth->Instance->MACL3L4C0R, ETH_MACL3L4C0R_L4PEN0);
      pL4FilterConfig->DestPortFilterMatch =
   ...
   } else /* Filter == ETH_L4_FILTER_1 */
   {
      ...
      pL4FilterConfig->Protocol =
          READ_BIT(heth->Instance->MACL3L4C1R, ETH_MACL3L4C0R_L4PEN0);
      pL4FilterConfig->DestPortFilterMatch =
                          ...
                          ETH_RxVLANConfigTypeDef *pVlanConfig)
{
   ...
   pVlanConfig->StripVLANTag =
       READ_BIT(heth->Instance->MACVTR, ETH_MACVTR_EVLS);
