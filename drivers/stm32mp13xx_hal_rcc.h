...
typedef struct {
   ...
   uint32_t PLLN; /*!< PLLN: Multiplication factor for PLL VCO output clock
                       ...
                       Integer mode:     25 and 100 for PLL1600 (PLL1 and PLL2),
                     25 and 200 for PLL800 Fractional mode:  4 and 512 (PLL1600
                     and PLL800) */
   ...
   uint32_t PLLRGE; /*!< PLLRGE: PLL input frequency range for PLL3 and PLL4
                         This parameter must be a value of @ref
                       RCC_PLL3_IF_Range and RCC_PLL4_IF_Range */

   uint32_t PLLFRACV; /*!< PLLFRACV: Fractional Part Of The Multiplication
                         Factor for PLL1 VCO It should be a value between 0 and
                         8191 ((2^13)-1) */

   uint32_t
       PLLMODE; /*!< PLLMODE: PLL mode used
                       This parameter must be a value of @ref RCC_PLL_Mode */

   uint32_t MOD_PER; /*!< MOD_PER:  Modulation Period Adjustment
                            This parameter must have a value contained on @ref
                        RCC_MOD_PER */

   uint32_t
       RPDFN_DIS; /*!< RPDFN_DIS: Dithering RPDF noise control
                       This parameter must be a value of @ref RCC_RPDFN_DIS*/

   uint32_t
       TPDFN_DIS; /*!< TPDFN_DIS: Dithering TPDF noise control
                       This parameter must be a value of @ref RCC_TPDFN_DIS*/

   uint32_t
       SSCG_MODE; /*!< SSCG_MODE: Spread spectrum clock generator mode
...
/**
 * @brief  RCC PLL2 Clocks structure definition => [FCH] used in UART set_config
 * use case
 */
typedef struct {
...
/**
 * @brief  RCC PLL3 Clocks structure definition => [FCH] used in UART set_config
 * use case
 */
typedef struct {
...
/**
 * @brief  RCC MPU, MLAHB, AXI, AHB and APB busses clock configuration structure
 * definition.
 */
typedef struct {
...
#define RCC_HSE_BYPASS_DIG                                                     \
   (RCC_OCENSETR_HSEBYP | RCC_OCENSETR_HSEON | RCC_OCENSETR_DIGBYP)
...
/* after reset)*/
#define RCC_HSI_DIV2                                                           \
   RCC_HSICFGR_HSIDIV_0 /* Division by 2, ck_hsi(_ker) = 32 MHz*/
#define RCC_HSI_DIV4                                                           \
   RCC_HSICFGR_HSIDIV_1 /* Division by 4, ck_hsi(_ker) = 16 MHz*/
#define RCC_HSI_DIV8                                                           \
   (RCC_HSICFGR_HSIDIV_0 | RCC_HSICFGR_HSIDIV_1) /* Division by 8, */
/* ck_hsi(_ker) =  8 MHz*/

#define IS_RCC_HSIDIV(DIV)                                                     \
   (((DIV) == RCC_HSI_DIV1) || ((DIV) == RCC_HSI_DIV2) ||                      \
 ...
 * @{
 * @note: MCO1 division factors are used for MCODIV values as they are the same
 * for MCO2
 */
...
#define RCC_MCODIV_12                                                          \
   (RCC_MCO1CFGR_MCO1DIV_3 | RCC_MCO1CFGR_MCO1DIV_1 | RCC_MCO1CFGR_MCO1DIV_0)
#define RCC_MCODIV_13 (RCC_MCO1CFGR_MCO1DIV_3 | RCC_MCO1CFGR_MCO1DIV_2)
#define RCC_MCODIV_14                                                          \
   (RCC_MCO1CFGR_MCO1DIV_3 | RCC_MCO1CFGR_MCO1DIV_2 | RCC_MCO1CFGR_MCO1DIV_0)
...
#define RCC_MLAHBSSOURCE_PLL3                                                  \
   (RCC_MSSCKSELR_MLAHBSSRC_1 | RCC_MSSCKSELR_MLAHBSSRC_0)

#define IS_RCC_MLAHBSSOURCE(SOURCE)                                            \
   (((SOURCE) == RCC_MLAHBSSOURCE_HSI) ||                                      \
    ((SOURCE) == RCC_MLAHBSSOURCE_HSE) ||                                      \
    ((SOURCE) == RCC_MLAHBSSOURCE_CSI) || ((SOURCE) == RCC_MLAHBSSOURCE_PLL3))
/**
 * @}
 */
...
#define RCC_MLAHB_DIV128                                                       \
   (RCC_MLAHBDIVR_MLAHBDIV_2 | RCC_MLAHBDIVR_MLAHBDIV_1 |                      \
    RCC_MLAHBDIVR_MLAHBDIV_0)
...
#define IS_RCC_MLAHBDIV(DIVIDER)                                               \
   (((DIVIDER) == RCC_MLAHB_DIV1) || ((DIVIDER) == RCC_MLAHB_DIV2) ||          \
    ((DIVIDER) == RCC_MLAHB_DIV4) || ((DIVIDER) == RCC_MLAHB_DIV8) ||          \
    ((DIVIDER) == RCC_MLAHB_DIV16) || ((DIVIDER) == RCC_MLAHB_DIV32) ||        \
    ((DIVIDER) == RCC_MLAHB_DIV64) || ((DIVIDER) == RCC_MLAHB_DIV128) ||       \
    ((DIVIDER) == RCC_MLAHB_DIV256) || ((DIVIDER) == RCC_MLAHB_DIV512))
/**
 * @}
 */
...
#define IS_RCC_APB6DIV(DIVIDER)                                                \
   (((DIVIDER) == RCC_APB6_DIV1) || ((DIVIDER) == RCC_APB6_DIV2) ||            \
    ((DIVIDER) == RCC_APB6_DIV4) || ((DIVIDER) == RCC_APB6_DIV8) ||            \
...
#define IS_RCC_MOD_PER(ADJ)                                                    \
   ((RCC_MOD_PER_MIN <= (ADJ)) && ((ADJ) <= RCC_MOD_PER_MAX))
/**
 * @}
 */
...
#define IS_RCC_INC_STEP(ADJ)                                                   \
   ((RCC_INC_STEP_MIN <= (ADJ)) && ((ADJ) <= RCC_INC_STEP_MAX))
/**
 * @}
 */
...
#define RCC_PLL4SOURCE_I2S_CKIN                                                \
   (RCC_RCK4SELR_PLL4SRC_1 | RCC_RCK4SELR_PLL4SRC_0)
...
#define IS_RCC_PLL3CLOCKOUT_VALUE(VALUE)                                       \
   (((VALUE) == RCC_PLL3_DIVP) || ((VALUE) == RCC_PLL3_DIVQ) ||                \
    ((VALUE) == RCC_PLL3_DIVR))
/**
 * @}
 */
...
#define IS_RCC_PLL4CLOCKOUT_VALUE(VALUE)                                       \
   (((VALUE) == RCC_PLL4_DIVP) || ((VALUE) == RCC_PLL4_DIVQ) ||                \
    ((VALUE) == RCC_PLL4_DIVR))
...
#define RCC_RTCCLKSOURCE_HSE_DIV                                               \
   (RCC_BDCR_RTCSRC_1 | RCC_BDCR_RTCSRC_0) /* HSE clock divided by RTCDIV*/
/* value is used as RTC clock*/

#define IS_RCC_RTCCLKSOURCE(SOURCE)                                            \
   (((SOURCE) == RCC_RTCCLKSOURCE_OFF) ||                                      \
    ((SOURCE) == RCC_RTCCLKSOURCE_LSE) ||                                      \
    ((SOURCE) == RCC_RTCCLKSOURCE_LSI) ||                                      \
    ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV))
/**
 * @}
 */
...
#define RCC_FLAG_HSIDIVRDY                                                     \
   ((RCC->OCRDYR & RCC_OCRDYR_HSIDIVRDY) == RCC_OCRDYR_HSIDIVRDY)
...
#define RCC_FLAG_MPUCKRDY                                                      \
   ((RCC->OCRDYR & RCC_OCRDYR_MPUCKRDY) == RCC_OCRDYR_MPUCKRDY)
#define RCC_FLAG_AXICKRDY                                                      \
   ((RCC->OCRDYR & RCC_OCRDYR_AXICKRDY) == RCC_OCRDYR_AXICKRDY)

/* Flags in the MPCKSELR register */
#define RCC_FLAG_MPUSRCRDY                                                     \
   ((RCC->MPCKSELR & RCC_MPCKSELR_MPUSRCRDY) == RCC_MPCKSELR_MPUSRCRDY)
...
#define RCC_FLAG_MLAHBSSRCRDY                                                  \
   ((RCC->MSSCKSELR & RCC_MSSCKSELR_MLAHBSSRCRDY) == RCC_MSSCKSELR_MLAHBSSRCRDY)
...
#define RCC_FLAG_PLL3SRCRDY                                                    \
   ((RCC->RCK3SELR & RCC_RCK3SELR_PLL3SRCRDY) == RCC_RCK3SELR_PLL3SRCRDY)

/* Flags in the RCK4SELR register */
#define RCC_FLAG_PLL4SRCRDY                                                    \
   ((RCC->RCK4SELR & RCC_RCK4SELR_PLL4SRCRDY) == RCC_RCK4SELR_PLL4SRCRDY)
...
#define RCC_FLAG_TIMG3PRERDY                                                   \
   ((RCC->TIMG3PRER & RCC_TIMG3PRER_TIMG3PRERDY) == RCC_TIMG3PRER_TIMG3PRERDY)

/* Flags in the MPCKDIVR register */
#define RCC_FLAG_MPUDIVRDY                                                     \
   ((RCC->MPCKDIVR & RCC_MPCKDIVR_MPUDIVRDY) == RCC_MPCKDIVR_MPUDIVRDY)

/* Flags in the AXIDIVR register */
#define RCC_FLAG_AXIDIVRDY                                                     \
   ((RCC->AXIDIVR & RCC_AXIDIVR_AXIDIVRDY) == RCC_AXIDIVR_AXIDIVRDY)

/* Flags in the APB4DIVR register */
#define RCC_FLAG_APB4DIVRDY                                                    \
   ((RCC->APB4DIVR & RCC_APB4DIVR_APB4DIVRDY) == RCC_APB4DIVR_APB4DIVRDY)

/* Flags in the APB5DIVR register */
#define RCC_FLAG_APB5DIVRDY                                                    \
   ((RCC->APB5DIVR & RCC_APB5DIVR_APB5DIVRDY) == RCC_APB5DIVR_APB5DIVRDY)

/* Flags in the MLAHBDIVR register */
#define RCC_FLAG_MLAHBDIVRDY                                                   \
   ((RCC->MLAHBDIVR & RCC_MLAHBDIVR_MLAHBDIVRDY) == RCC_MLAHBDIVR_MLAHBDIVRDY)

/* Flags in the APB1DIVR register */
#define RCC_FLAG_APB1DIVRDY                                                    \
   ((RCC->APB1DIVR & RCC_APB1DIVR_APB1DIVRDY) == RCC_APB1DIVR_APB1DIVRDY)

/* Flags in the APB2DIVR register */
#define RCC_FLAG_APB2DIVRDY                                                    \
   ((RCC->APB2DIVR & RCC_APB2DIVR_APB2DIVRDY) == RCC_APB2DIVR_APB2DIVRDY)

/* Flags in the APB3DIVR register */
#define RCC_FLAG_APB3DIVRDY                                                    \
   ((RCC->APB3DIVR & RCC_APB3DIVR_APB3DIVRDY) == RCC_APB3DIVR_APB3DIVRDY)

#if defined(RCC_APB6DIVR_APB6DIV)
/* Flags in the APB6DIVR register */
#define RCC_FLAG_APB6DIVRDY                                                    \
   ((RCC->APB6DIVR & RCC_APB6DIVR_APB6DIVRDY) == RCC_APB6DIVR_APB6DIVRDY)
#endif /* RCC_APB6DIVR_APB6DIV */

/* Flags in the PLL1CR register */
#define RCC_FLAG_PLL1RDY                                                       \
   ((RCC->PLL1CR & RCC_PLL1CR_PLL1RDY) == RCC_PLL1CR_PLL1RDY)

/* Flags in the PLL2CR register */
#define RCC_FLAG_PLL2RDY                                                       \
   ((RCC->PLL2CR & RCC_PLL2CR_PLL2RDY) == RCC_PLL2CR_PLL2RDY)

/* Flags in the PLL3CR register */
#define RCC_FLAG_PLL3RDY                                                       \
   ((RCC->PLL3CR & RCC_PLL3CR_PLL3RDY) == RCC_PLL3CR_PLL3RDY)

/* Flags in the PLL4CR register */
#define RCC_FLAG_PLL4RDY                                                       \
   ((RCC->PLL4CR & RCC_PLL4CR_PLL4RDY) == RCC_PLL4CR_PLL4RDY)

/* Flags in the DDRCKSELR register */
#define RCC_FLAG_DDRPHYCSRCRDY                                                 \
   ((RCC->DDRCKSELR & RCC_DDRCKSELR_DDRPHYCSRCRDY) ==                          \
    RCC_DDRCKSELR_DDRPHYCSRCRDY)
...
#define RCC_FLAG_LSIRDY                                                        \
   ((RCC->RDLSICR & RCC_RDLSICR_LSIRDY) == RCC_RDLSICR_LSIRDY)

#if defined(CORE_CA7)
/* Flags in the RCC_MP_RSTSSETR */
#define RCC_MASK_ALL_RESET_FLAGS (0x00001F7FU)
#define RCC_FLAG_PORRST                                                        \
   ((RCC->MP_RSTSSETR & RCC_MP_RSTSSETR_PORRSTF) == RCC_MP_RSTSSETR_PORRSTF)
#define RCC_FLAG_BORRST                                                        \
   ((RCC->MP_RSTSSETR & RCC_MP_RSTSSETR_BORRSTF) == RCC_MP_RSTSSETR_BORRSTF)
#define RCC_FLAG_PADRST                                                        \
   ((RCC->MP_RSTSSETR & RCC_MP_RSTSSETR_PADRSTF) == RCC_MP_RSTSSETR_PADRSTF)
#define RCC_FLAG_HCSSRST                                                       \
   ((RCC->MP_RSTSSETR & RCC_MP_RSTSSETR_HCSSRSTF) == RCC_MP_RSTSSETR_HCSSRSTF)
#define RCC_FLAG_VCORERST                                                      \
   ((RCC->MP_RSTSSETR & RCC_MP_RSTSSETR_VCORERSTF) == RCC_MP_RSTSSETR_VCORERSTF)
#define RCC_FLAG_VCPURST                                                       \
   ((RCC->MP_RSTSSETR & RCC_MP_RSTSSETR_VCPURSTF) == RCC_MP_RSTSSETR_VCPURSTF)
#define RCC_FLAG_MPSYSRSTF                                                     \
   ((RCC->MP_RSTSSETR & RCC_MP_RSTSSETR_MPSYSRSTF) == RCC_MP_RSTSSETR_MPSYSRSTF)
#define RCC_FLAG_IWDG1RST                                                      \
   ((RCC->MP_RSTSSETR & RCC_MP_RSTSSETR_IWDG1RSTF) == RCC_MP_RSTSSETR_IWDG1RSTF)
#define RCC_FLAG_IWDG2RST                                                      \
   ((RCC->MP_RSTSSETR & RCC_MP_RSTSSETR_IWDG2RSTF) == RCC_MP_RSTSSETR_IWDG2RSTF)
#define RCC_FLAG_STP2RST                                                       \
   ((RCC->MP_RSTSSETR & RCC_MP_RSTSSETR_STP2RSTF) == RCC_MP_RSTSSETR_STP2RSTF)
#define RCC_FLAG_STDBYRSTF                                                     \
   ((RCC->MP_RSTSSETR & RCC_MP_RSTSSETR_STDBYRSTF) == RCC_MP_RSTSSETR_STDBYRSTF)
#define RCC_FLAG_CSTDBYRSTF                                                    \
   ((RCC->MP_RSTSSETR & RCC_MP_RSTSSETR_CSTDBYRSTF) ==                         \
    RCC_MP_RSTSSETR_CSTDBYRSTF)
#endif /* CORE_CA7 */
...
#define __HAL_RCC_CLEAR_RESET_FLAGS()                                          \
   WRITE_REG(RCC->MP_RSTSCLRR, RCC_MASK_ALL_RESET_FLAGS)
#endif /* CORE_CA7 */
...
#define RCC_LSEDRIVE_HIGH                                                      \
   (RCC_BDCR_LSEDRV_1 | RCC_BDCR_LSEDRV_0) /*!< LSE high drive capability */
...
#define RCC_IT_ALL                                                             \
   (RCC_IT_LSIRDY | RCC_IT_LSERDY | RCC_IT_HSIRDY | RCC_IT_HSERDY |            \
    RCC_IT_CSIRDY | RCC_IT_PLLRDY | RCC_IT_PLL2RDY | RCC_IT_PLL3RDY |          \
    RCC_IT_PLL4RDY | RCC_IT_LSECSS | RCC_IT_WKUP)

#define IS_RCC_IT(VALUE)                                                       \
   (((VALUE) == RCC_IT_LSIRDY) || ((VALUE) == RCC_IT_LSERDY) ||                \
...
#define __HAL_RCC_TIM2_FORCE_RESET()                                           \
   (RCC->APB1RSTSETR = RCC_APB1RSTSETR_TIM2RST)
#define __HAL_RCC_TIM3_FORCE_RESET()                                           \
   (RCC->APB1RSTSETR = RCC_APB1RSTSETR_TIM3RST)
#define __HAL_RCC_TIM4_FORCE_RESET()                                           \
   (RCC->APB1RSTSETR = RCC_APB1RSTSETR_TIM4RST)
#define __HAL_RCC_TIM5_FORCE_RESET()                                           \
   (RCC->APB1RSTSETR = RCC_APB1RSTSETR_TIM5RST)
#define __HAL_RCC_TIM6_FORCE_RESET()                                           \
   (RCC->APB1RSTSETR = RCC_APB1RSTSETR_TIM6RST)
#define __HAL_RCC_TIM7_FORCE_RESET()                                           \
   (RCC->APB1RSTSETR = RCC_APB1RSTSETR_TIM7RST)
#define __HAL_RCC_LPTIM1_FORCE_RESET()                                         \
   (RCC->APB1RSTSETR = RCC_APB1RSTSETR_LPTIM1RST)
#define __HAL_RCC_SPI2_FORCE_RESET()                                           \
   (RCC->APB1RSTSETR = RCC_APB1RSTSETR_SPI2RST)
#define __HAL_RCC_SPI3_FORCE_RESET()                                           \
   (RCC->APB1RSTSETR = RCC_APB1RSTSETR_SPI3RST)
#define __HAL_RCC_USART3_FORCE_RESET()                                         \
   (RCC->APB1RSTSETR = RCC_APB1RSTSETR_USART3RST)
#define __HAL_RCC_UART4_FORCE_RESET()                                          \
   (RCC->APB1RSTSETR = RCC_APB1RSTSETR_UART4RST)
#define __HAL_RCC_UART5_FORCE_RESET()                                          \
   (RCC->APB1RSTSETR = RCC_APB1RSTSETR_UART5RST)
#define __HAL_RCC_UART7_FORCE_RESET()                                          \
   (RCC->APB1RSTSETR = RCC_APB1RSTSETR_UART7RST)
#define __HAL_RCC_UART8_FORCE_RESET()                                          \
   (RCC->APB1RSTSETR = RCC_APB1RSTSETR_UART8RST)
#define __HAL_RCC_I2C1_FORCE_RESET()                                           \
   (RCC->APB1RSTSETR = RCC_APB1RSTSETR_I2C1RST)
#define __HAL_RCC_I2C2_FORCE_RESET()                                           \
   (RCC->APB1RSTSETR = RCC_APB1RSTSETR_I2C2RST)
#define __HAL_RCC_SPDIFRX_FORCE_RESET()                                        \
   (RCC->APB1RSTSETR = RCC_APB1RSTSETR_SPDIFRST)

#define __HAL_RCC_APB1_RELEASE_RESET() (RCC->APB1RSTCLRR = 0x46F9A3FU)
#define __HAL_RCC_TIM2_RELEASE_RESET()                                         \
   (RCC->APB1RSTCLRR = RCC_APB1RSTCLRR_TIM2RST)
#define __HAL_RCC_TIM3_RELEASE_RESET()                                         \
   (RCC->APB1RSTCLRR = RCC_APB1RSTCLRR_TIM3RST)
#define __HAL_RCC_TIM4_RELEASE_RESET()                                         \
   (RCC->APB1RSTCLRR = RCC_APB1RSTCLRR_TIM4RST)
#define __HAL_RCC_TIM5_RELEASE_RESET()                                         \
   (RCC->APB1RSTCLRR = RCC_APB1RSTCLRR_TIM5RST)
#define __HAL_RCC_TIM6_RELEASE_RESET()                                         \
   (RCC->APB1RSTCLRR = RCC_APB1RSTCLRR_TIM6RST)
#define __HAL_RCC_TIM7_RELEASE_RESET()                                         \
   (RCC->APB1RSTCLRR = RCC_APB1RSTCLRR_TIM7RST)
#define __HAL_RCC_LPTIM1_RELEASE_RESET()                                       \
   (RCC->APB1RSTCLRR = RCC_APB1RSTCLRR_LPTIM1RST)
#define __HAL_RCC_SPI2_RELEASE_RESET()                                         \
   (RCC->APB1RSTCLRR = RCC_APB1RSTCLRR_SPI2RST)
#define __HAL_RCC_SPI3_RELEASE_RESET()                                         \
   (RCC->APB1RSTCLRR = RCC_APB1RSTCLRR_SPI3RST)
#define __HAL_RCC_USART3_RELEASE_RESET()                                       \
   (RCC->APB1RSTCLRR = RCC_APB1RSTCLRR_USART3RST)
#define __HAL_RCC_UART4_RELEASE_RESET()                                        \
   (RCC->APB1RSTCLRR = RCC_APB1RSTCLRR_UART4RST)
#define __HAL_RCC_UART5_RELEASE_RESET()                                        \
   (RCC->APB1RSTCLRR = RCC_APB1RSTCLRR_UART5RST)
#define __HAL_RCC_UART7_RELEASE_RESET()                                        \
   (RCC->APB1RSTCLRR = RCC_APB1RSTCLRR_UART7RST)
#define __HAL_RCC_UART8_RELEASE_RESET()                                        \
   (RCC->APB1RSTCLRR = RCC_APB1RSTCLRR_UART8RST)
#define __HAL_RCC_I2C1_RELEASE_RESET()                                         \
   (RCC->APB1RSTCLRR = RCC_APB1RSTCLRR_I2C1RST)
#define __HAL_RCC_I2C2_RELEASE_RESET()                                         \
   (RCC->APB1RSTCLRR = RCC_APB1RSTCLRR_I2C2RST)
#define __HAL_RCC_SPDIFRX_RELEASE_RESET()                                      \
   (RCC->APB1RSTCLRR = RCC_APB1RSTCLRR_SPDIFRST)
...
#define __HAL_RCC_TIM1_FORCE_RESET()                                           \
   (RCC->APB2RSTSETR = RCC_APB2RSTSETR_TIM1RST)
#define __HAL_RCC_TIM8_FORCE_RESET()                                           \
   (RCC->APB2RSTSETR = RCC_APB2RSTSETR_TIM8RST)
#define __HAL_RCC_SPI1_FORCE_RESET()                                           \
   (RCC->APB2RSTSETR = RCC_APB2RSTSETR_SPI1RST)
#define __HAL_RCC_USART6_FORCE_RESET()                                         \
   (RCC->APB2RSTSETR = RCC_APB2RSTSETR_USART6RST)
#define __HAL_RCC_SAI1_FORCE_RESET()                                           \
   (RCC->APB2RSTSETR = RCC_APB2RSTSETR_SAI1RST)
#define __HAL_RCC_SAI2_FORCE_RESET()                                           \
   (RCC->APB2RSTSETR = RCC_APB2RSTSETR_SAI2RST)
#define __HAL_RCC_DFSDM1_FORCE_RESET()                                         \
   (RCC->APB2RSTSETR = RCC_APB2RSTSETR_DFSDMRST)
#define __HAL_RCC_FDCAN_FORCE_RESET()                                          \
   (RCC->APB2RSTSETR = RCC_APB2RSTSETR_FDCANRST)
...
#define __HAL_RCC_LPTIM3_FORCE_RESET()                                         \
   (RCC->APB3RSTSETR = RCC_APB3RSTSETR_LPTIM3RST)
#define __HAL_RCC_LPTIM4_FORCE_RESET()                                         \
   (RCC->APB3RSTSETR = RCC_APB3RSTSETR_LPTIM4RST)
#define __HAL_RCC_LPTIM5_FORCE_RESET()                                         \
   (RCC->APB3RSTSETR = RCC_APB3RSTSETR_LPTIM5RST)
#define __HAL_RCC_SYSCFG_FORCE_RESET()                                         \
   (RCC->APB3RSTSETR = RCC_APB3RSTSETR_SYSCFGRST)
#define __HAL_RCC_VREF_FORCE_RESET()                                           \
   (RCC->APB3RSTSETR = RCC_APB3RSTSETR_VREFRST)
...
#define __HAL_RCC_LPTIM2_RELEASE_RESET()                                       \
   (RCC->APB3RSTCLRR = RCC_APB3RSTCLRR_LPTIM2RST)
#define __HAL_RCC_LPTIM3_RELEASE_RESET()                                       \
   (RCC->APB3RSTCLRR = RCC_APB3RSTCLRR_LPTIM3RST)
#define __HAL_RCC_LPTIM4_RELEASE_RESET()                                       \
   (RCC->APB3RSTCLRR = RCC_APB3RSTCLRR_LPTIM4RST)
#define __HAL_RCC_LPTIM5_RELEASE_RESET()                                       \
   (RCC->APB3RSTCLRR = RCC_APB3RSTCLRR_LPTIM5RST)
#define __HAL_RCC_SYSCFG_RELEASE_RESET()                                       \
   (RCC->APB3RSTCLRR = RCC_APB3RSTCLRR_SYSCFGRST)
#define __HAL_RCC_VREF_RELEASE_RESET()                                         \
   (RCC->APB3RSTCLRR = RCC_APB3RSTCLRR_VREFRST)
#define __HAL_RCC_DTS_RELEASE_RESET()                                          \
   (RCC->APB3RSTCLRR = RCC_APB3RSTCLRR_DTSRST)
...
#define __HAL_RCC_DMA1_FORCE_RESET()                                           \
   (RCC->AHB2RSTSETR = RCC_AHB2RSTSETR_DMA1RST)
#define __HAL_RCC_DMA2_FORCE_RESET()                                           \
   (RCC->AHB2RSTSETR = RCC_AHB2RSTSETR_DMA2RST)
#if defined(RCC_AHB2RSTSETR_DMAMUX1RST)
#define __HAL_RCC_DMAMUX1_FORCE_RESET()                                        \
   (RCC->AHB2RSTSETR = RCC_AHB2RSTSETR_DMAMUX1RST)
#endif /* RCC_AHB2RSTSETR_DMAMUX1RST */
#if defined(RCC_AHB2RSTSETR_DMA3RST)
#define __HAL_RCC_DMA3_FORCE_RESET()                                           \
   (RCC->AHB2RSTSETR = RCC_AHB2RSTSETR_DMA3RST)
#endif /* RCC_AHB2RSTSETR_DMA3RST */
#if defined(RCC_AHB2RSTSETR_DMAMUX2RST)
#define __HAL_RCC_DMAMUX2_FORCE_RESET()                                        \
   (RCC->AHB2RSTSETR = RCC_AHB2RSTSETR_DMAMUX2RST)
#endif /* RCC_AHB2RSTSETR_DMAMUX2RST */
#if defined(RCC_AHB2RSTSETR_ADC1RST)
#define __HAL_RCC_ADC1_FORCE_RESET()                                           \
   (RCC->AHB2RSTSETR = RCC_AHB2RSTSETR_ADC1RST)
#endif /* RCC_AHB2RSTSETR_ADC1RST */
#if defined(RCC_AHB2RSTSETR_ADC2RST)
#define __HAL_RCC_ADC2_FORCE_RESET()                                           \
   (RCC->AHB2RSTSETR = RCC_AHB2RSTSETR_ADC2RST)
#endif /* RCC_AHB2RSTSETR_ADC2RST */
#define __HAL_RCC_USBO_FORCE_RESET()                                           \
...
#define __HAL_RCC_LTDC_FORCE_RESET()                                           \
   (RCC->APB4RSTSETR = RCC_APB4RSTSETR_LTDCRST)
#define __HAL_RCC_DCMIPP_FORCE_RESET()                                         \
   (RCC->APB4RSTSETR = RCC_APB4RSTSETR_DCMIPPRST)
#define __HAL_RCC_DDRPERFM_FORCE_RESET()                                       \
   (RCC->APB4RSTSETR = RCC_APB4RSTSETR_DDRPERFMRST)
#define __HAL_RCC_USBPHY_FORCE_RESET()                                         \
...
#define __HAL_RCC_DCMIPP_RELEASE_RESET()                                       \
   (RCC->APB4RSTCLRR = RCC_APB4RSTCLRR_DCMIPPRST)
#define __HAL_RCC_DDRPERFM_RELEASE_RESET()                                     \
   (RCC->APB4RSTCLRR = RCC_APB4RSTCLRR_DDRPERFMRST)
#define __HAL_RCC_USBPHY_RELEASE_RESET()                                       \
...
#define __HAL_RCC_STGEN_FORCE_RESET()                                          \
   (RCC->APB5RSTSETR = RCC_APB5RSTSETR_STGENRST)

#define __HAL_RCC_APB5_RELEASE_RESET() (RCC->APB5RSTCLRR = 0x00100000U)
#define __HAL_RCC_STGEN_RELEASE_RESET()                                        \
   (RCC->APB5RSTCLRR = RCC_APB5RSTCLRR_STGENRST)
...
#define __HAL_RCC_SDMMC1_FORCE_RESET()                                         \
   (RCC->AHB6RSTSETR = RCC_AHB6RSTSETR_SDMMC1RST)
#define __HAL_RCC_SDMMC2_FORCE_RESET()                                         \
   (RCC->AHB6RSTSETR = RCC_AHB6RSTSETR_SDMMC2RST)
#define __HAL_RCC_CRC1_FORCE_RESET()                                           \
   (RCC->AHB6RSTSETR = RCC_AHB6RSTSETR_CRC1RST)
#define __HAL_RCC_USBH_FORCE_RESET()                                           \
...
#define __HAL_RCC_MDMA_RELEASE_RESET()                                         \
   (RCC->AHB6RSTCLRR = RCC_AHB6RSTCLRR_MDMARST)
#define __HAL_RCC_MCE_RELEASE_RESET()                                          \
   (RCC->AHB6RSTCLRR = RCC_AHB6RSTCLRR_MCERST)
#if defined(RCC_AHB6RSTCLRR_ETH1MACRST)
#define __HAL_RCC_ETH1MAC_RELEASE_RESET()                                      \
   (RCC->AHB6RSTCLRR = RCC_AHB6RSTCLRR_ETH1MACRST)
#endif /* RCC_AHB6RSTCLRR_ETH1MACRST */
#if defined(RCC_AHB6RSTCLRR_ETH2MACRST)
#define __HAL_RCC_ETH2MAC_RELEASE_RESET()                                      \
   (RCC->AHB6RSTCLRR = RCC_AHB6RSTCLRR_ETH2MACRST)
#endif /* RCC_AHB6RSTCLRR_ETH2MACRST */
#define __HAL_RCC_FMC_RELEASE_RESET()                                          \
   (RCC->AHB6RSTCLRR = RCC_AHB6RSTCLRR_FMCRST)
#define __HAL_RCC_QSPI_RELEASE_RESET()                                         \
   (RCC->AHB6RSTCLRR = RCC_AHB6RSTCLRR_QSPIRST)
#define __HAL_RCC_SDMMC1_RELEASE_RESET()                                       \
   (RCC->AHB6RSTCLRR = RCC_AHB6RSTCLRR_SDMMC1RST)
#define __HAL_RCC_SDMMC2_RELEASE_RESET()                                       \
   (RCC->AHB6RSTCLRR = RCC_AHB6RSTCLRR_SDMMC2RST)
#define __HAL_RCC_CRC1_RELEASE_RESET()                                         \
   (RCC->AHB6RSTCLRR = RCC_AHB6RSTCLRR_CRC1RST)
#define __HAL_RCC_USBH_RELEASE_RESET()                                         \
 ...
 * before using it. It shall be used to allocate a peripheral to the MPU.
 */
#define __HAL_RCC_TIM2_CLK_ENABLE()                                            \
   (RCC->MP_APB1ENSETR = RCC_MP_APB1ENSETR_TIM2EN)
#define __HAL_RCC_TIM3_CLK_ENABLE()                                            \
   (RCC->MP_APB1ENSETR = RCC_MP_APB1ENSETR_TIM3EN)
#define __HAL_RCC_TIM4_CLK_ENABLE()                                            \
   (RCC->MP_APB1ENSETR = RCC_MP_APB1ENSETR_TIM4EN)
#define __HAL_RCC_TIM5_CLK_ENABLE()                                            \
   (RCC->MP_APB1ENSETR = RCC_MP_APB1ENSETR_TIM5EN)
#define __HAL_RCC_TIM6_CLK_ENABLE()                                            \
   (RCC->MP_APB1ENSETR = RCC_MP_APB1ENSETR_TIM6EN)
#define __HAL_RCC_TIM7_CLK_ENABLE()                                            \
   (RCC->MP_APB1ENSETR = RCC_MP_APB1ENSETR_TIM7EN)
#define __HAL_RCC_LPTIM1_CLK_ENABLE()                                          \
   (RCC->MP_APB1ENSETR = RCC_MP_APB1ENSETR_LPTIM1EN)
#define __HAL_RCC_SPI2_CLK_ENABLE()                                            \
   (RCC->MP_APB1ENSETR = RCC_MP_APB1ENSETR_SPI2EN)
#define __HAL_RCC_SPI3_CLK_ENABLE()                                            \
   (RCC->MP_APB1ENSETR = RCC_MP_APB1ENSETR_SPI3EN)
#define __HAL_RCC_USART3_CLK_ENABLE()                                          \
   (RCC->MP_APB1ENSETR = RCC_MP_APB1ENSETR_USART3EN)
#define __HAL_RCC_UART4_CLK_ENABLE()                                           \
   (RCC->MP_APB1ENSETR = RCC_MP_APB1ENSETR_UART4EN)
#define __HAL_RCC_UART5_CLK_ENABLE()                                           \
   (RCC->MP_APB1ENSETR = RCC_MP_APB1ENSETR_UART5EN)
#define __HAL_RCC_UART7_CLK_ENABLE()                                           \
   (RCC->MP_APB1ENSETR = RCC_MP_APB1ENSETR_UART7EN)
#define __HAL_RCC_UART8_CLK_ENABLE()                                           \
   (RCC->MP_APB1ENSETR = RCC_MP_APB1ENSETR_UART8EN)
#define __HAL_RCC_I2C1_CLK_ENABLE()                                            \
   (RCC->MP_APB1ENSETR = RCC_MP_APB1ENSETR_I2C1EN)
#define __HAL_RCC_I2C2_CLK_ENABLE()                                            \
   (RCC->MP_APB1ENSETR = RCC_MP_APB1ENSETR_I2C2EN)
#define __HAL_RCC_SPDIFRX_CLK_ENABLE()                                         \
   (RCC->MP_APB1ENSETR = RCC_MP_APB1ENSETR_SPDIFEN)

#define __HAL_RCC_TIM2_CLK_DISABLE()                                           \
   (RCC->MP_APB1ENCLRR = RCC_MP_APB1ENCLRR_TIM2EN)
#define __HAL_RCC_TIM3_CLK_DISABLE()                                           \
   (RCC->MP_APB1ENCLRR = RCC_MP_APB1ENCLRR_TIM3EN)
#define __HAL_RCC_TIM4_CLK_DISABLE()                                           \
   (RCC->MP_APB1ENCLRR = RCC_MP_APB1ENCLRR_TIM4EN)
#define __HAL_RCC_TIM5_CLK_DISABLE()                                           \
   (RCC->MP_APB1ENCLRR = RCC_MP_APB1ENCLRR_TIM5EN)
#define __HAL_RCC_TIM6_CLK_DISABLE()                                           \
   (RCC->MP_APB1ENCLRR = RCC_MP_APB1ENCLRR_TIM6EN)
#define __HAL_RCC_TIM7_CLK_DISABLE()                                           \
   (RCC->MP_APB1ENCLRR = RCC_MP_APB1ENCLRR_TIM7EN)
#define __HAL_RCC_LPTIM1_CLK_DISABLE()                                         \
   (RCC->MP_APB1ENCLRR = RCC_MP_APB1ENCLRR_LPTIM1EN)
#define __HAL_RCC_SPI2_CLK_DISABLE()                                           \
   (RCC->MP_APB1ENCLRR = RCC_MP_APB1ENCLRR_SPI2EN)
#define __HAL_RCC_SPI3_CLK_DISABLE()                                           \
   (RCC->MP_APB1ENCLRR = RCC_MP_APB1ENCLRR_SPI3EN)
#define __HAL_RCC_USART3_CLK_DISABLE()                                         \
   (RCC->MP_APB1ENCLRR = RCC_MP_APB1ENCLRR_USART3EN)
#define __HAL_RCC_UART4_CLK_DISABLE()                                          \
   (RCC->MP_APB1ENCLRR = RCC_MP_APB1ENCLRR_UART4EN)
#define __HAL_RCC_UART5_CLK_DISABLE()                                          \
   (RCC->MP_APB1ENCLRR = RCC_MP_APB1ENCLRR_UART5EN)
#define __HAL_RCC_UART7_CLK_DISABLE()                                          \
   (RCC->MP_APB1ENCLRR = RCC_MP_APB1ENCLRR_UART7EN)
#define __HAL_RCC_UART8_CLK_DISABLE()                                          \
   (RCC->MP_APB1ENCLRR = RCC_MP_APB1ENCLRR_UART8EN)
#define __HAL_RCC_I2C1_CLK_DISABLE()                                           \
   (RCC->MP_APB1ENCLRR = RCC_MP_APB1ENCLRR_I2C1EN)
#define __HAL_RCC_I2C2_CLK_DISABLE()                                           \
   (RCC->MP_APB1ENCLRR = RCC_MP_APB1ENCLRR_I2C2EN)
#define __HAL_RCC_SPDIFRX_CLK_DISABLE()                                        \
   (RCC->MP_APB1ENCLRR = RCC_MP_APB1ENCLRR_SPDIFEN)
...
#define __HAL_RCC_TIM1_CLK_ENABLE()                                            \
   (RCC->MP_APB2ENSETR = RCC_MP_APB2ENSETR_TIM1EN)
#define __HAL_RCC_TIM8_CLK_ENABLE()                                            \
   (RCC->MP_APB2ENSETR = RCC_MP_APB2ENSETR_TIM8EN)
#define __HAL_RCC_SPI1_CLK_ENABLE()                                            \
   (RCC->MP_APB2ENSETR = RCC_MP_APB2ENSETR_SPI1EN)
#define __HAL_RCC_USART6_CLK_ENABLE()                                          \
   (RCC->MP_APB2ENSETR = RCC_MP_APB2ENSETR_USART6EN)
#define __HAL_RCC_SAI1_CLK_ENABLE()                                            \
   (RCC->MP_APB2ENSETR = RCC_MP_APB2ENSETR_SAI1EN)
#define __HAL_RCC_SAI2_CLK_ENABLE()                                            \
   (RCC->MP_APB2ENSETR = RCC_MP_APB2ENSETR_SAI2EN)
#define __HAL_RCC_DFSDM1_CLK_ENABLE()                                          \
   (RCC->MP_APB2ENSETR = RCC_MP_APB2ENSETR_DFSDMEN)
#define __HAL_RCC_ADFSDM1_CLK_ENABLE()                                         \
   (RCC->MP_APB2ENSETR = RCC_MP_APB2ENSETR_ADFSDMEN)
#define __HAL_RCC_FDCAN_CLK_ENABLE()                                           \
   (RCC->MP_APB2ENSETR = RCC_MP_APB2ENSETR_FDCANEN)

#define __HAL_RCC_TIM1_CLK_DISABLE()                                           \
   (RCC->MP_APB2ENCLRR = RCC_MP_APB2ENCLRR_TIM1EN)
#define __HAL_RCC_TIM8_CLK_DISABLE()                                           \
   (RCC->MP_APB2ENCLRR = RCC_MP_APB2ENCLRR_TIM8EN)
#define __HAL_RCC_SPI1_CLK_DISABLE()                                           \
   (RCC->MP_APB2ENCLRR = RCC_MP_APB2ENCLRR_SPI1EN)
#define __HAL_RCC_USART6_CLK_DISABLE()                                         \
   (RCC->MP_APB2ENCLRR = RCC_MP_APB2ENCLRR_USART6EN)
#define __HAL_RCC_SAI1_CLK_DISABLE()                                           \
   (RCC->MP_APB2ENCLRR = RCC_MP_APB2ENCLRR_SAI1EN)
#define __HAL_RCC_SAI2_CLK_DISABLE()                                           \
   (RCC->MP_APB2ENCLRR = RCC_MP_APB2ENCLRR_SAI2EN)
#define __HAL_RCC_DFSDM1_CLK_DISABLE()                                         \
   (RCC->MP_APB2ENCLRR = RCC_MP_APB2ENCLRR_DFSDMEN)
#define __HAL_RCC_ADFSDM1_CLK_DISABLE()                                        \
   (RCC->MP_APB2ENCLRR = RCC_MP_APB2ENCLRR_ADFSDMEN)
#define __HAL_RCC_FDCAN_CLK_DISABLE()                                          \
   (RCC->MP_APB2ENCLRR = RCC_MP_APB2ENCLRR_FDCANEN)
...
#define __HAL_RCC_LPTIM2_CLK_ENABLE()                                          \
   (RCC->MP_APB3ENSETR = RCC_MP_APB3ENSETR_LPTIM2EN)
#define __HAL_RCC_LPTIM3_CLK_ENABLE()                                          \
   (RCC->MP_APB3ENSETR = RCC_MP_APB3ENSETR_LPTIM3EN)
#define __HAL_RCC_LPTIM4_CLK_ENABLE()                                          \
   (RCC->MP_APB3ENSETR = RCC_MP_APB3ENSETR_LPTIM4EN)
#define __HAL_RCC_LPTIM5_CLK_ENABLE()                                          \
   (RCC->MP_APB3ENSETR = RCC_MP_APB3ENSETR_LPTIM5EN)
#define __HAL_RCC_VREF_CLK_ENABLE()                                            \
   (RCC->MP_APB3ENSETR = RCC_MP_APB3ENSETR_VREFEN)
#define __HAL_RCC_DTS_CLK_ENABLE()                                             \
   (RCC->MP_APB3ENSETR = RCC_MP_APB3ENSETR_DTSEN)
#define __HAL_RCC_HDP_CLK_ENABLE()                                             \
   (RCC->MP_APB3ENSETR = RCC_MP_APB3ENSETR_HDPEN)

#define __HAL_RCC_LPTIM2_CLK_DISABLE()                                         \
   (RCC->MP_APB3ENCLRR = RCC_MP_APB3ENCLRR_LPTIM2EN)
#define __HAL_RCC_LPTIM3_CLK_DISABLE()                                         \
   (RCC->MP_APB3ENCLRR = RCC_MP_APB3ENCLRR_LPTIM3EN)
#define __HAL_RCC_LPTIM4_CLK_DISABLE()                                         \
   (RCC->MP_APB3ENCLRR = RCC_MP_APB3ENCLRR_LPTIM4EN)
#define __HAL_RCC_LPTIM5_CLK_DISABLE()                                         \
   (RCC->MP_APB3ENCLRR = RCC_MP_APB3ENCLRR_LPTIM5EN)
#define __HAL_RCC_VREF_CLK_DISABLE()                                           \
   (RCC->MP_APB3ENCLRR = RCC_MP_APB3ENCLRR_VREFEN)
#define __HAL_RCC_DTS_CLK_DISABLE()                                            \
   (RCC->MP_APB3ENCLRR = RCC_MP_APB3ENCLRR_DTSEN)
#define __HAL_RCC_HDP_CLK_DISABLE()                                            \
   (RCC->MP_APB3ENCLRR = RCC_MP_APB3ENCLRR_HDPEN)

/** @brief  Enable or disable the APB3 secure peripheral clock.
 * @note   After reset, the peripheral clock (used for registers read/write
 * access) is disabled and the application software has to enable this clock
 * before using it. It shall be used to allocate a peripheral.
 * @note A write access to this register field must be secure.
 *     A read access may be secure or non-secure
 */
#define __HAL_RCC_S_SYSCFG_CLK_ENABLE()                                        \
   (RCC->MP_S_APB3ENSETR = RCC_MP_S_APB3ENSETR_SYSCFGEN)
#define __HAL_RCC_S_SYSCFG_CLK_DISABLE()                                       \
   (RCC->MP_S_APB3ENCLRR = RCC_MP_S_APB3ENCLRR_SYSCFGEN)
 ...
 */
#if defined(DCMIPP)
#define __HAL_RCC_DCMIPP_CLK_ENABLE()                                          \
   (RCC->MP_APB4ENSETR = RCC_MP_APB4ENSETR_DCMIPPEN)
#endif /* DCMIPP */
#define __HAL_RCC_DDRPERFM_CLK_ENABLE()                                        \
   (RCC->MP_APB4ENSETR = RCC_MP_APB4ENSETR_DDRPERFMEN)
#define __HAL_RCC_IWDG2APB_CLK_ENABLE()                                        \
   (RCC->MP_APB4ENSETR = RCC_MP_APB4ENSETR_IWDG2APBEN)
#define __HAL_RCC_USBPHY_CLK_ENABLE()                                          \
   (RCC->MP_APB4ENSETR = RCC_MP_APB4ENSETR_USBPHYEN)
#define __HAL_RCC_STGENRO_CLK_ENABLE()                                         \
   (RCC->MP_APB4ENSETR = RCC_MP_APB4ENSETR_STGENROEN)

#if defined(DCMIPP)
#define __HAL_RCC_DCMIPP_CLK_DISABLE()                                         \
   (RCC->MP_APB4ENCLRR = RCC_MP_APB4ENCLRR_DCMIPPEN)
#endif /* DCMIPP */
#define __HAL_RCC_DDRPERFM_CLK_DISABLE()                                       \
   (RCC->MP_APB4ENCLRR = RCC_MP_APB4ENCLRR_DDRPERFMEN)
#define __HAL_RCC_IWDG2APB_CLK_DISABLE()                                       \
   (RCC->MP_APB4ENCLRR = RCC_MP_APB4ENCLRR_IWDG2APBEN)
#define __HAL_RCC_USBPHY_CLK_DISABLE()                                         \
   (RCC->MP_APB4ENCLRR = RCC_MP_APB4ENCLRR_USBPHYEN)
#define __HAL_RCC_STGENRO_CLK_DISABLE()                                        \
   (RCC->MP_APB4ENCLRR = RCC_MP_APB4ENCLRR_STGENROEN)
 ...
 */
#define __HAL_RCC_S_LTDC_CLK_ENABLE()                                          \
   (RCC->MP_S_APB4ENSETR = RCC_MP_S_APB4ENSETR_LTDCEN)
#define __HAL_RCC_S_LTDC_CLK_DISABLE()                                         \
   (RCC->MP_S_APB4ENCLRR = RCC_MP_S_APB4ENCLRR_LTDCEN)
...
#define __HAL_RCC_TZC_CLK_ENABLE()                                             \
   (RCC->MP_APB5ENSETR = RCC_MP_APB5ENSETR_TZCEN)
#endif /* RCC_MP_APB5ENSETR_TZCEN */
#if defined(RCC_MP_APB5ENSETR_ETZPCEN)
#define __HAL_RCC_ETZPC_CLK_ENABLE()                                           \
   (RCC->MP_APB5ENSETR = RCC_MP_APB5ENSETR_ETZPCEN)
#endif /* RCC_MP_APB5ENSETR_ETZPCEN */
#define __HAL_RCC_IWDG1APB_CLK_ENABLE()                                        \
   (RCC->MP_APB5ENSETR = RCC_MP_APB5ENSETR_IWDG1APBEN)
#define __HAL_RCC_BSEC_CLK_ENABLE()                                            \
   (RCC->MP_APB5ENSETR = RCC_MP_APB5ENSETR_BSECEN)
#if defined(RCC_MP_APB5ENSETR_STGENCEN)
#define __HAL_RCC_STGEN_CLK_ENABLE()                                           \
   (RCC->MP_APB5ENSETR = RCC_MP_APB5ENSETR_STGENCEN)
#endif /* RCC_MP_APB5ENSETR_STGENCEN */

#define __HAL_RCC_RTCAPB_CLK_DISABLE()                                         \
   (RCC->MP_APB5ENCLRR = RCC_MP_APB5ENCLRR_RTCAPBEN)
#if defined(RCC_MP_APB5ENCLRR_TZCEN)
#define __HAL_RCC_TZC_CLK_DISABLE()                                            \
   (RCC->MP_APB5ENCLRR = RCC_MP_APB5ENCLRR_TZCEN)
#endif /* RCC_MP_APB5ENCLRR_TZCEN */
#if defined(RCC_MP_APB5ENCLRR_ETZPCEN)
#define __HAL_RCC_ETZPC_CLK_DISABLE()                                          \
   (RCC->MP_APB5ENCLRR = RCC_MP_APB5ENCLRR_ETZPCEN)
#endif /* RCC_MP_APB5ENCLRR_ETZPCEN */
#define __HAL_RCC_IWDG1APB_CLK_DISABLE()                                       \
   (RCC->MP_APB5ENCLRR = RCC_MP_APB5ENCLRR_IWDG1APBEN)
#define __HAL_RCC_BSEC_CLK_DISABLE()                                           \
   (RCC->MP_APB5ENCLRR = RCC_MP_APB5ENCLRR_BSECEN)
#if defined(RCC_MP_APB5ENCLRR_STGENCEN)
#define __HAL_RCC_STGEN_CLK_DISABLE()                                          \
   (RCC->MP_APB5ENCLRR = RCC_MP_APB5ENCLRR_STGENCEN)
...
#define __HAL_RCC_PKA_CLK_ENABLE()                                             \
   (RCC->MP_AHB5ENSETR = RCC_MP_AHB5ENSETR_PKAEN)
#endif /* PKA */
#if defined(SAES)
#define __HAL_RCC_SAES_CLK_ENABLE()                                            \
   (RCC->MP_AHB5ENSETR = RCC_MP_AHB5ENSETR_SAESEN)
#endif /* SAES */
#if defined(CRYP1)
...
#define __HAL_RCC_HASH1_CLK_ENABLE()                                           \
   (RCC->MP_AHB5ENSETR = RCC_MP_AHB5ENSETR_HASH1EN)
#define __HAL_RCC_RNG1_CLK_ENABLE()                                            \
   (RCC->MP_AHB5ENSETR = RCC_MP_AHB5ENSETR_RNG1EN)
#define __HAL_RCC_BKPSRAM_CLK_ENABLE()                                         \
   (RCC->MP_AHB5ENSETR = RCC_MP_AHB5ENSETR_BKPSRAMEN)
#define __HAL_RCC_AXIMC_CLK_ENABLE()                                           \
   (RCC->MP_AHB5ENSETR = RCC_MP_AHB5ENSETR_AXIMCEN)

#if defined(PKA)
#define __HAL_RCC_PKA_CLK_DISABLE()                                            \
   (RCC->MP_AHB5ENCLRR = RCC_MP_AHB5ENCLRR_PKAEN)
#endif /* PKA */
#if defined(SAES)
#define __HAL_RCC_SAES_CLK_DISABLE()                                           \
   (RCC->MP_AHB5ENCLRR = RCC_MP_AHB5ENCLRR_SAESEN)
#endif /* SAES */
#if defined(CRYP1)
#define __HAL_RCC_CRYP1_CLK_DISABLE()                                          \
   (RCC->MP_AHB5ENCLRR = RCC_MP_AHB5ENCLRR_CRYP1EN)
#endif /* CRYP1 */
#define __HAL_RCC_HASH1_CLK_DISABLE()                                          \
   (RCC->MP_AHB5ENCLRR = RCC_MP_AHB5ENCLRR_HASH1EN)
#define __HAL_RCC_RNG1_CLK_DISABLE()                                           \
   (RCC->MP_AHB5ENCLRR = RCC_MP_AHB5ENCLRR_RNG1EN)
#define __HAL_RCC_BKPSRAM_CLK_DISABLE()                                        \
   (RCC->MP_AHB5ENCLRR = RCC_MP_AHB5ENCLRR_BKPSRAMEN)
#define __HAL_RCC_AXIMC_CLK_DISABLE()                                          \
   (RCC->MP_AHB5ENCLRR = RCC_MP_AHB5ENCLRR_AXIMCEN)
...
#define __HAL_RCC_ETH2MAC_CLK_ENABLE()                                         \
   (RCC->MP_AHB6ENSETR = RCC_MP_AHB6ENSETR_ETH2MACEN)
#endif /* RCC_MP_AHB6ENSETR_ETH2MACEN */
#define __HAL_RCC_FMC_CLK_ENABLE()                                             \
   (RCC->MP_AHB6ENSETR = RCC_MP_AHB6ENSETR_FMCEN)
#define __HAL_RCC_QSPI_CLK_ENABLE()                                            \
   (RCC->MP_AHB6ENSETR = RCC_MP_AHB6ENSETR_QSPIEN)
#define __HAL_RCC_SDMMC1_CLK_ENABLE()                                          \
   (RCC->MP_AHB6ENSETR = RCC_MP_AHB6ENSETR_SDMMC1EN)
#define __HAL_RCC_SDMMC2_CLK_ENABLE()                                          \
   (RCC->MP_AHB6ENSETR = RCC_MP_AHB6ENSETR_SDMMC2EN)
#define __HAL_RCC_CRC1_CLK_ENABLE()                                            \
   (RCC->MP_AHB6ENSETR = RCC_MP_AHB6ENSETR_CRC1EN)
#define __HAL_RCC_USBH_CLK_ENABLE()                                            \
   (RCC->MP_AHB6ENSETR = RCC_MP_AHB6ENSETR_USBHEN)

#if defined(RCC_MP_AHB6ENCLRR_MCEEN)
#define __HAL_RCC_MCE_CLK_DISABLE()                                            \
   (RCC->MP_AHB6ENCLRR = RCC_MP_AHB6ENCLRR_MCEEN)
#endif /* RCC_MP_AHB6ENCLRR_MCEEN */
#if defined(RCC_MP_AHB6ENCLRR_ETH1CKEN)
#define __HAL_RCC_ETH1CK_CLK_DISABLE()                                         \
   (RCC->MP_AHB6ENCLRR = RCC_MP_AHB6ENCLRR_ETH1CKEN)
#endif /* RCC_MP_AHB6ENCLRR_ETH1CKEN */
#if defined(RCC_MP_AHB6ENCLRR_ETH2CKEN)
#define __HAL_RCC_ETH2CK_CLK_DISABLE()                                         \
   (RCC->MP_AHB6ENCLRR = RCC_MP_AHB6ENCLRR_ETH2CKEN)
#endif /* RCC_MP_AHB6ENCLRR_ETH2CKEN */
#if defined(RCC_MP_AHB6ENCLRR_ETH1TXEN)
#define __HAL_RCC_ETH1TX_CLK_DISABLE()                                         \
   (RCC->MP_AHB6ENCLRR = RCC_MP_AHB6ENCLRR_ETH1TXEN)
#endif /* RCC_MP_AHB6ENCLRR_ETH1TXEN */
#if defined(RCC_MP_AHB6ENCLRR_ETH2TXEN)
#define __HAL_RCC_ETH2TX_CLK_DISABLE()                                         \
   (RCC->MP_AHB6ENCLRR = RCC_MP_AHB6ENCLRR_ETH2TXEN)
#endif /* RCC_MP_AHB6ENCLRR_ETH2TXEN */
#if defined(RCC_MP_AHB6ENCLRR_ETH1RXEN)
#define __HAL_RCC_ETH1RX_CLK_DISABLE()                                         \
   (RCC->MP_AHB6ENCLRR = RCC_MP_AHB6ENCLRR_ETH1RXEN)
#endif /* RCC_MP_AHB6ENCLRR_ETH1RXEN */
#if defined(RCC_MP_AHB6ENCLRR_ETH2RXEN)
#define __HAL_RCC_ETH2RX_CLK_DISABLE()                                         \
   (RCC->MP_AHB6ENCLRR = RCC_MP_AHB6ENCLRR_ETH2RXEN)
#endif /* RCC_MP_AHB6ENCLRR_ETH2RXEN */
#if defined(RCC_MP_AHB6ENCLRR_ETH1MACEN)
#define __HAL_RCC_ETH1MAC_CLK_DISABLE()                                        \
   (RCC->MP_AHB6ENCLRR = RCC_MP_AHB6ENCLRR_ETH1MACEN)
#endif /* RCC_MP_AHB6ENCLRR_ETH1MACEN */
#if defined(RCC_MP_AHB6ENCLRR_ETH2MACEN)
#define __HAL_RCC_ETH2MAC_CLK_DISABLE()                                        \
   (RCC->MP_AHB6ENCLRR = RCC_MP_AHB6ENCLRR_ETH2MACEN)
#endif /* RCC_MP_AHB6ENCLRR_ETH2MACEN */
#define __HAL_RCC_FMC_CLK_DISABLE()                                            \
   (RCC->MP_AHB6ENCLRR = RCC_MP_AHB6ENCLRR_FMCEN)
#define __HAL_RCC_QSPI_CLK_DISABLE()                                           \
   (RCC->MP_AHB6ENCLRR = RCC_MP_AHB6ENCLRR_QSPIEN)
#define __HAL_RCC_SDMMC1_CLK_DISABLE()                                         \
   (RCC->MP_AHB6ENCLRR = RCC_MP_AHB6ENCLRR_SDMMC1EN)
#define __HAL_RCC_SDMMC2_CLK_DISABLE()                                         \
   (RCC->MP_AHB6ENCLRR = RCC_MP_AHB6ENCLRR_SDMMC2EN)
#define __HAL_RCC_CRC1_CLK_DISABLE()                                           \
   (RCC->MP_AHB6ENCLRR = RCC_MP_AHB6ENCLRR_CRC1EN)
#define __HAL_RCC_USBH_CLK_DISABLE()                                           \
 ...
 * may be secure or non-secure.
 */
#define __HAL_RCC_S_MDMA_CLK_ENABLE()                                          \
   (RCC->MP_S_AHB6ENSETR = RCC_MP_S_AHB6ENSETR_MDMAEN)
#define __HAL_RCC_S_MDMA_CLK_DISABLE()                                         \
   (RCC->MP_S_AHB6ENCLRR = RCC_MP_S_AHB6ENCLRR_MDMAEN)
...
#define __HAL_RCC_MDMA_CLK_DISABLE()                                           \
   (RCC->MP_NS_AHB6ENCLRR = RCC_MP_NS_AHB6ENCLRR_MDMAEN)
...
#define __HAL_RCC_GPIOI_CLK_DISABLE()                                          \
   (RCC->MP_AHB4ENCLRR = RCC_MP_AHB4ENCLRR_GPIOIEN)
 ...
 * may be secure or non-secure.
 */
#define __HAL_RCC_S_GPIOA_CLK_ENABLE()                                         \
   (RCC->MP_S_AHB4ENSETR = RCC_MP_S_AHB4ENSETR_GPIOAEN)
#define __HAL_RCC_S_GPIOB_CLK_ENABLE()                                         \
   (RCC->MP_S_AHB4ENSETR = RCC_MP_S_AHB4ENSETR_GPIOBEN)
#define __HAL_RCC_S_GPIOC_CLK_ENABLE()                                         \
   (RCC->MP_S_AHB4ENSETR = RCC_MP_S_AHB4ENSETR_GPIOCEN)
#define __HAL_RCC_S_GPIOD_CLK_ENABLE()                                         \
   (RCC->MP_S_AHB4ENSETR = RCC_MP_S_AHB4ENSETR_GPIODEN)
#define __HAL_RCC_S_GPIOE_CLK_ENABLE()                                         \
   (RCC->MP_S_AHB4ENSETR = RCC_MP_S_AHB4ENSETR_GPIOEEN)
#define __HAL_RCC_S_GPIOF_CLK_ENABLE()                                         \
   (RCC->MP_S_AHB4ENSETR = RCC_MP_S_AHB4ENSETR_GPIOFEN)
#define __HAL_RCC_S_GPIOG_CLK_ENABLE()                                         \
   (RCC->MP_S_AHB4ENSETR = RCC_MP_S_AHB4ENSETR_GPIOGEN)
#define __HAL_RCC_S_GPIOH_CLK_ENABLE()                                         \
   (RCC->MP_S_AHB4ENSETR = RCC_MP_S_AHB4ENSETR_GPIOHEN)
#define __HAL_RCC_S_GPIOI_CLK_ENABLE()                                         \
   (RCC->MP_S_AHB4ENSETR = RCC_MP_S_AHB4ENSETR_GPIOIEN)

#define __HAL_RCC_S_GPIOA_CLK_DISABLE()                                        \
   (RCC->MP_S_AHB4ENCLRR = RCC_MP_S_AHB4ENCLRR_GPIOAEN)
#define __HAL_RCC_S_GPIOB_CLK_DISABLE()                                        \
   (RCC->MP_S_AHB4ENCLRR = RCC_MP_S_AHB4ENCLRR_GPIOBEN)
#define __HAL_RCC_S_GPIOC_CLK_DISABLE()                                        \
   (RCC->MP_S_AHB4ENCLRR = RCC_MP_S_AHB4ENCLRR_GPIOCEN)
#define __HAL_RCC_S_GPIOD_CLK_DISABLE()                                        \
   (RCC->MP_S_AHB4ENCLRR = RCC_MP_S_AHB4ENCLRR_GPIODEN)
#define __HAL_RCC_S_GPIOE_CLK_DISABLE()                                        \
   (RCC->MP_S_AHB4ENCLRR = RCC_MP_S_AHB4ENCLRR_GPIOEEN)
#define __HAL_RCC_S_GPIOF_CLK_DISABLE()                                        \
   (RCC->MP_S_AHB4ENCLRR = RCC_MP_S_AHB4ENCLRR_GPIOFEN)
#define __HAL_RCC_S_GPIOG_CLK_DISABLE()                                        \
   (RCC->MP_S_AHB4ENCLRR = RCC_MP_S_AHB4ENCLRR_GPIOGEN)
#define __HAL_RCC_S_GPIOH_CLK_DISABLE()                                        \
   (RCC->MP_S_AHB4ENCLRR = RCC_MP_S_AHB4ENCLRR_GPIOHEN)
#define __HAL_RCC_S_GPIOI_CLK_DISABLE()                                        \
   (RCC->MP_S_AHB4ENCLRR = RCC_MP_S_AHB4ENCLRR_GPIOIEN)
...
/** @brief  Enable or disable the APB3 secure peripheral clock during  CSLEEP
 * mode.
 * @note   Peripheral clock gating in SLEEP mode can be used to further reduce
 *         power consumption.
 * @note   After wakeup from SLEEP mode, the peripheral clock is enabled again.
 ...
 *         may be secure or non-secure.
 */
#define __HAL_RCC_S_SYSCFG_CLK_SLEEP_ENABLE()                                  \
   (RCC->MP_S_APB3LPENSETR = RCC_MP_S_APB3LPENSETR_SYSCFGLPEN)
#define __HAL_RCC_S_SYSCFG_CLK_SLEEP_DISABLE()                                 \
   (RCC->MP_S_APB3LPENCLRR = RCC_MP_S_APB3LPENCLRR_SYSCFGLPEN)

/** @brief  Enable or disable the APB3 non-secure peripheral clock during CSLEEP
 * mode.
 * @note   Peripheral clock gating in SLEEP mode can be used to further reduce
 *         power consumption.
 * @note   After wakeup from SLEEP mode, the peripheral clock is enabled again.
...
#define __HAL_RCC_SYSCFG_CLK_SLEEP_ENABLE()                                    \
   (RCC->MP_NS_APB3LPENSETR = RCC_MP_NS_APB3LPENSETR_SYSCFGLPEN)
...
#define __HAL_RCC_SYSCFG_CLK_SLEEP_DISABLE()                                   \
   (RCC->MP_NS_APB3LPENCLRR = RCC_MP_NS_APB3LPENCLRR_SYSCFGLPEN)
...
#define __HAL_RCC_DCMIPP_CLK_SLEEP_ENABLE()                                    \
   (RCC->MP_APB4LPENSETR = RCC_MP_APB4LPENSETR_DCMIPPLPEN)
#endif /* DCMIPP */
...
#if defined(DCMIPP)
#define __HAL_RCC_DCMIPP_CLK_SLEEP_DISABLE()                                   \
   (RCC->MP_APB4LPENCLRR = RCC_MP_APB4LPENCLRR_DCMIPPLPEN)
#endif /* DCMIPP */
...
/** @brief  Enable or disable the APB4 secure peripheral clock during  CSLEEP
 * mode.
 * @note   Peripheral clock gating in SLEEP mode can be used to further reduce
 *         power consumption.
 * @note   After wakeup from SLEEP mode, the peripheral clock is enabled again.
 ...
 *         may be secure or non-secure.
 */
#define __HAL_RCC_S_LTDC_CLK_SLEEP_ENABLE()                                    \
   (RCC->MP_S_APB4LPENSETR = RCC_MP_S_APB4LPENSETR_LTDCLPEN)
#define __HAL_RCC_S_LTDC_CLK_SLEEP_DISABLE()                                   \
   (RCC->MP_S_APB4LPENCLRR = RCC_MP_S_APB4LPENCLRR_LTDCLPEN)

/** @brief  Enable or disable the APB4 non-secure peripheral clock during CSLEEP
 * mode.
 * @note   Peripheral clock gating in SLEEP mode can be used to further reduce
 *         power consumption.
 * @note   After wakeup from SLEEP mode, the peripheral clock is enabled again.
...
#define __HAL_RCC_TZC_CLK_SLEEP_ENABLE()                                       \
   (RCC->MP_APB5LPENSETR = RCC_MP_APB5LPENSETR_TZCLPEN)
#endif /* RCC_MP_APB5LPENSETR_TZCLPEN */
#if defined(RCC_MP_APB5LPENSETR_ETZPCLPEN)
#define __HAL_RCC_ETZPC_CLK_SLEEP_ENABLE()                                     \
   (RCC->MP_APB5LPENSETR = RCC_MP_APB5LPENSETR_ETZPCLPEN)
#endif /* RCC_MP_APB5LPENSETR_ETZPCLPEN */
#define __HAL_RCC_IWDG1APB_CLK_SLEEP_ENABLE()                                  \
   (RCC->MP_APB5LPENSETR = RCC_MP_APB5LPENSETR_IWDG1APBLPEN)
...
#define __HAL_RCC_STGEN_CLK_SLEEP_ENABLE()                                     \
   (RCC->MP_APB5LPENSETR = RCC_MP_APB5LPENSETR_STGENCLPEN)
#endif /* RCC_MP_APB5LPENSETR_STGENCLPEN */
#if defined(RCC_MP_APB5LPENSETR_STGENCSTPEN)
#define __HAL_RCC_STGENCSTP_CLK_SLEEP_ENABLE()                                 \
   (RCC->MP_APB5LPENSETR = RCC_MP_APB5LPENSETR_STGENCSTPPEN)
...
#if defined(RCC_MP_APB5LPENSETR_TZCLPEN)
#define __HAL_RCC_TZC_CLK_SLEEP_DISABLE()                                      \
   (RCC->MP_APB5LPENCLRR = RCC_MP_APB5LPENCLRR_TZCLPEN)
#endif /* RCC_MP_APB5LPENSETR_TZCLPEN */
#if defined(RCC_MP_APB5LPENCLRR_ETZPCLPEN)
#define __HAL_RCC_ETZPC_CLK_SLEEP_DISABLE()                                    \
   (RCC->MP_APB5LPENCLRR = RCC_MP_APB5LPENCLRR_ETZPCLPEN)
#endif /* RCC_MP_APB5LPENCLRR_ETZPCLPEN */
#define __HAL_RCC_IWDG1APB_CLK_SLEEP_DISABLE()                                 \
   (RCC->MP_APB5LPENCLRR = RCC_MP_APB5LPENCLRR_IWDG1APBLPEN)
#define __HAL_RCC_BSEC_CLK_SLEEP_DISABLE()                                     \
   (RCC->MP_APB5LPENCLRR = RCC_MP_APB5LPENCLRR_BSECLPEN)
#if defined(RCC_MP_APB5LPENCLRR_STGENLPEN)
#define __HAL_RCC_STGEN_CLK_SLEEP_DISABLE()                                    \
   (RCC->MP_APB5LPENCLRR = RCC_MP_APB5LPENCLRR_STGENLPEN)
#endif /* RCC_MP_APB5LPENCLRR_STGENLPEN */
#if defined(RCC_MP_APB5LPENSETR_STGENCLPEN)
#define __HAL_RCC_STGEN_CLK_SLEEP_DISABLE()                                    \
   (RCC->MP_APB5LPENCLRR = RCC_MP_APB5LPENCLRR_STGENCLPEN)
#endif /* RCC_MP_APB5LPENSETR_STGENCLPEN */
...
#define __HAL_RCC_TIM17_SLEEP_ENABLE()                                         \
   (RCC->MP_APB6LPENSETR = RCC_MP_APB6LPENSETR_TIM17LPEN)
#endif /* RCC_MP_APB6LPENSETR_TIM17LPEN */
#if defined(RCC_MP_APB6LPENSETR_TIM16LPEN)
#define __HAL_RCC_TIM16_SLEEP_ENABLE()                                         \
   (RCC->MP_APB6LPENSETR = RCC_MP_APB6LPENSETR_TIM16LPEN)
#endif /* RCC_MP_APB6LPENSETR_TIM16LPEN */
#if defined(RCC_MP_APB6LPENSETR_TIM15LPEN)
#define __HAL_RCC_TIM15_SLEEP_ENABLE()                                         \
   (RCC->MP_APB6LPENSETR = RCC_MP_APB6LPENSETR_TIM15LPEN)
#endif /* RCC_MP_APB6LPENSETR_TIM15LPEN */
#if defined(RCC_MP_APB6LPENSETR_TIM14LPEN)
#define __HAL_RCC_TIM14_SLEEP_ENABLE()                                         \
   (RCC->MP_APB6LPENSETR = RCC_MP_APB6LPENSETR_TIM14LPEN)
#endif /* RCC_MP_APB6LPENSETR_TIM14LPEN */
#if defined(RCC_MP_APB6LPENSETR_TIM13LPEN)
#define __HAL_RCC_TIM13_SLEEP_ENABLE()                                         \
   (RCC->MP_APB6LPENSETR = RCC_MP_APB6LPENSETR_TIM13LPEN)
#endif /* RCC_MP_APB6LPENSETR_TIM13LPEN */
#if defined(RCC_MP_APB6LPENSETR_TIM12LPEN)
#define __HAL_RCC_TIM12_SLEEP_ENABLE()                                         \
   (RCC->MP_APB6LPENSETR = RCC_MP_APB6LPENSETR_TIM12LPEN)
#endif /* RCC_MP_APB6LPENSETR_TIM12LPEN */
#if defined(RCC_MP_APB6LPENSETR_I2C5LPEN)
#define __HAL_RCC_I2C5_SLEEP_ENABLE()                                          \
   (RCC->MP_APB6LPENSETR = RCC_MP_APB6LPENSETR_I2C5LPEN)
#endif /* RCC_MP_APB6LPENSETR_I2C5LPEN */
#if defined(RCC_MP_APB6LPENSETR_I2C4LPEN)
#define __HAL_RCC_I2C4_SLEEP_ENABLE()                                          \
   (RCC->MP_APB6LPENSETR = RCC_MP_APB6LPENSETR_I2C4LPEN)
#endif /* RCC_MP_APB6LPENSETR_I2C4LPEN */
#if defined(RCC_MP_APB6LPENSETR_I2C3LPEN)
#define __HAL_RCC_I2C3_SLEEP_ENABLE()                                          \
   (RCC->MP_APB6LPENSETR = RCC_MP_APB6LPENSETR_I2C3LPEN)
#endif /* RCC_MP_APB6LPENSETR_I2C3LPEN */
#if defined(RCC_MP_APB6LPENSETR_SPI5LPEN)
#define __HAL_RCC_SPI5_SLEEP_ENABLE()                                          \
   (RCC->MP_APB6LPENSETR = RCC_MP_APB6LPENSETR_SPI5LPEN)
#endif /* RCC_MP_APB6LPENSETR_SPI5LPEN */
#if defined(RCC_MP_APB6LPENSETR_SPI4LPEN)
#define __HAL_RCC_SPI4_SLEEP_ENABLE()                                          \
   (RCC->MP_APB6LPENSETR = RCC_MP_APB6LPENSETR_SPI4LPEN)
#endif /* RCC_MP_APB6LPENSETR_SPI4LPEN */
#if defined(RCC_MP_APB6LPENSETR_USART2LPEN)
#define __HAL_RCC_USART2_SLEEP_ENABLE()                                        \
   (RCC->MP_APB6LPENSETR = RCC_MP_APB6LPENSETR_USART2LPEN)
#endif /* RCC_MP_APB6LPENSETR_USART2LPEN */
#if defined(RCC_MP_APB6LPENSETR_USART1LPEN)
#define __HAL_RCC_USART1_SLEEP_ENABLE()                                        \
   (RCC->MP_APB6LPENSETR = RCC_MP_APB6LPENSETR_USART1LPEN)
#endif /* RCC_MP_APB6LPENSETR_USART1LPEN */

#if defined(RCC_MP_APB6LPENCLRR_TIM17LPEN)
#define __HAL_RCC_TIM17_SLEEP_DISABLE()                                        \
   (RCC->MP_APB6LPENCLRR = RCC_MP_APB6LPENCLRR_TIM17LPEN)
#endif /* RCC_MP_APB6LPENCLRR_TIM17LPEN */
#if defined(RCC_MP_APB6LPENCLRR_TIM16LPEN)
#define __HAL_RCC_TIM16_SLEEP_DISABLE()                                        \
   (RCC->MP_APB6LPENCLRR = RCC_MP_APB6LPENCLRR_TIM16LPEN)
#endif /* RCC_MP_APB6LPENCLRR_TIM16LPEN */
#if defined(RCC_MP_APB6LPENCLRR_TIM15LPEN)
#define __HAL_RCC_TIM15_SLEEP_DISABLE()                                        \
   (RCC->MP_APB6LPENCLRR = RCC_MP_APB6LPENCLRR_TIM15LPEN)
#endif /* RCC_MP_APB6LPENCLRR_TIM15LPEN */
#if defined(RCC_MP_APB6LPENCLRR_TIM14LPEN)
#define __HAL_RCC_TIM14_SLEEP_DISABLE()                                        \
   (RCC->MP_APB6LPENCLRR = RCC_MP_APB6LPENCLRR_TIM14LPEN)
#endif /* RCC_MP_APB6LPENCLRR_TIM14LPEN */
#if defined(RCC_MP_APB6LPENCLRR_TIM13LPEN)
#define __HAL_RCC_TIM13_SLEEP_DISABLE()                                        \
   (RCC->MP_APB6LPENCLRR = RCC_MP_APB6LPENCLRR_TIM13LPEN)
#endif /* RCC_MP_APB6LPENCLRR_TIM13LPEN */
#if defined(RCC_MP_APB6LPENCLRR_TIM12LPEN)
#define __HAL_RCC_TIM12_SLEEP_DISABLE()                                        \
   (RCC->MP_APB6LPENCLRR = RCC_MP_APB6LPENCLRR_TIM12LPEN)
#endif /* RCC_MP_APB6LPENCLRR_TIM12LPEN */
#if defined(RCC_MP_APB6LPENCLRR_I2C5LPEN)
#define __HAL_RCC_I2C5_SLEEP_DISABLE()                                         \
   (RCC->MP_APB6LPENCLRR = RCC_MP_APB6LPENCLRR_I2C5LPEN)
#endif /* RCC_MP_APB6LPENCLRR_I2C5LPEN */
#if defined(RCC_MP_APB6LPENCLRR_I2C4LPEN)
#define __HAL_RCC_I2C4_SLEEP_DISABLE()                                         \
   (RCC->MP_APB6LPENCLRR = RCC_MP_APB6LPENCLRR_I2C4LPEN)
#endif /* RCC_MP_APB6LPENCLRR_I2C4LPEN */
#if defined(RCC_MP_APB6LPENCLRR_I2C3LPEN)
#define __HAL_RCC_I2C3_SLEEP_DISABLE()                                         \
   (RCC->MP_APB6LPENCLRR = RCC_MP_APB6LPENCLRR_I2C3LPEN)
#endif /* RCC_MP_APB6LPENCLRR_I2C3LPEN */
#if defined(RCC_MP_APB6LPENCLRR_SPI5LPEN)
#define __HAL_RCC_SPI5_SLEEP_DISABLE()                                         \
   (RCC->MP_APB6LPENCLRR = RCC_MP_APB6LPENCLRR_SPI5LPEN)
#endif /* RCC_MP_APB6LPENCLRR_SPI5LPEN */
#if defined(RCC_MP_APB6LPENCLRR_SPI4LPEN)
#define __HAL_RCC_SPI4_SLEEP_DISABLE()                                         \
   (RCC->MP_APB6LPENCLRR = RCC_MP_APB6LPENCLRR_SPI4LPEN)
#endif /* RCC_MP_APB6LPENCLRR_SPI4LPEN */
#if defined(RCC_MP_APB6LPENCLRR_USART2LPEN)
#define __HAL_RCC_USART2_SLEEP_DISABLE()                                       \
   (RCC->MP_APB6LPENCLRR = RCC_MP_APB6LPENCLRR_USART2LPEN)
#endif /* RCC_MP_APB6LPENCLRR_USART2LPEN */
#if defined(RCC_MP_APB6LPENCLRR_USART1LPEN)
#define __HAL_RCC_USART1_SLEEP_DISABLE()                                       \
   (RCC->MP_APB6LPENCLRR = RCC_MP_APB6LPENCLRR_USART1LPEN)
...
#define __HAL_RCC_PKA_CLK_SLEEP_ENABLE()                                       \
   (RCC->MP_AHB5LPENSETR = RCC_MP_AHB5LPENSETR_PKALPEN)
#endif /* PKA */
#if defined(SAES)
#define __HAL_RCC_SAES_CLK_SLEEP_ENABLE()                                      \
   (RCC->MP_AHB5LPENSETR = RCC_MP_AHB5LPENSETR_SAESLPEN)
#endif /* SAES */
#if defined(CRYP1)
...
#define __HAL_RCC_PKA_CLK_SLEEP_DISABLE()                                      \
   (RCC->MP_AHB5LPENCLRR = RCC_MP_AHB5LPENCLRR_PKALPEN)
#endif /* PKA */
#if defined(SAES)
#define __HAL_RCC_SAES_CLK_SLEEP_DISABLE()                                     \
   (RCC->MP_AHB5LPENCLRR = RCC_MP_AHB5LPENCLRR_SAESLPEN)
#endif /* SAES */
#if defined(CRYP1)
...
/** @brief  Enable or disable the AHB6 secure peripheral clock during  CSLEEP
 * mode.
 * @note   Peripheral clock gating in SLEEP mode can be used to further reduce
 *         power consumption.
 * @note   After wakeup from SLEEP mode, the peripheral clock is enabled again.
 ...
 *         may be secure or non-secure.
 */
#define __HAL_RCC_S_MDMA_CLK_SLEEP_ENABLE()                                    \
   (RCC->MP_S_AHB6LPENSETR = RCC_MP_S_AHB6LPENSETR_MDMALPEN)
#define __HAL_RCC_S_MDMA_CLK_SLEEP_DISABLE()                                   \
   (RCC->MP_S_AHB6LPENCLRR = RCC_MP_S_AHB6LPENCLRR_MDMALPEN)

/** @brief  Enable or disable the AHB6 non-secure peripheral clock during CSLEEP
 * mode.
 * @note   Peripheral clock gating in SLEEP mode can be used to further reduce
 *         power consumption.
 * @note   After wakeup from SLEEP mode, the peripheral clock is enabled again.
...
/** @brief  Enable or disable the AHB4 secure peripheral clock during  CSLEEP
 * mode.
 * @note   Peripheral clock gating in SLEEP mode can be used to further reduce
 *         power consumption.
 * @note   After wakeup from SLEEP mode, the peripheral clock is enabled again.
 ...
 *         may be secure or non-secure.
 */
#define __HAL_RCC_S_GPIOA_CLK_SLEEP_ENABLE()                                   \
   (RCC->MP_S_AHB4LPENSETR = RCC_MP_S_AHB4LPENSETR_GPIOALPEN)
#define __HAL_RCC_S_GPIOB_CLK_SLEEP_ENABLE()                                   \
   (RCC->MP_S_AHB4LPENSETR = RCC_MP_S_AHB4LPENSETR_GPIOBLPEN)
#define __HAL_RCC_S_GPIOC_CLK_SLEEP_ENABLE()                                   \
   (RCC->MP_S_AHB4LPENSETR = RCC_MP_S_AHB4LPENSETR_GPIOCLPEN)
#define __HAL_RCC_S_GPIOD_CLK_SLEEP_ENABLE()                                   \
   (RCC->MP_S_AHB4LPENSETR = RCC_MP_S_AHB4LPENSETR_GPIODLPEN)
#define __HAL_RCC_S_GPIOE_CLK_SLEEP_ENABLE()                                   \
   (RCC->MP_S_AHB4LPENSETR = RCC_MP_S_AHB4LPENSETR_GPIOELPEN)
#define __HAL_RCC_S_GPIOF_CLK_SLEEP_ENABLE()                                   \
   (RCC->MP_S_AHB4LPENSETR = RCC_MP_S_AHB4LPENSETR_GPIOFLPEN)
#define __HAL_RCC_S_GPIOG_CLK_SLEEP_ENABLE()                                   \
   (RCC->MP_S_AHB4LPENSETR = RCC_MP_S_AHB4LPENSETR_GPIOGLPEN)
#define __HAL_RCC_S_GPIOH_CLK_SLEEP_ENABLE()                                   \
   (RCC->MP_S_AHB4LPENSETR = RCC_MP_S_AHB4LPENSETR_GPIOHLPEN)
#define __HAL_RCC_S_GPIOI_CLK_SLEEP_ENABLE()                                   \
   (RCC->MP_S_AHB4LPENSETR = RCC_MP_S_AHB4LPENSETR_GPIOILPEN)

#define __HAL_RCC_S_GPIOA_CLK_SLEEP_DISABLE()                                  \
   (RCC->MP_S_AHB4LPENCLRR = RCC_MP_S_AHB4LPENCLRR_GPIOALPEN)
#define __HAL_RCC_S_GPIOB_CLK_SLEEP_DISABLE()                                  \
   (RCC->MP_S_AHB4LPENCLRR = RCC_MP_S_AHB4LPENCLRR_GPIOBLPEN)
#define __HAL_RCC_S_GPIOC_CLK_SLEEP_DISABLE()                                  \
   (RCC->MP_S_AHB4LPENCLRR = RCC_MP_S_AHB4LPENCLRR_GPIOCLPEN)
#define __HAL_RCC_S_GPIOD_CLK_SLEEP_DISABLE()                                  \
   (RCC->MP_S_AHB4LPENCLRR = RCC_MP_S_AHB4LPENCLRR_GPIODLPEN)
#define __HAL_RCC_S_GPIOE_CLK_SLEEP_DISABLE()                                  \
   (RCC->MP_S_AHB4LPENCLRR = RCC_MP_S_AHB4LPENCLRR_GPIOELPEN)
#define __HAL_RCC_S_GPIOF_CLK_SLEEP_DISABLE()                                  \
   (RCC->MP_S_AHB4LPENCLRR = RCC_MP_S_AHB4LPENCLRR_GPIOFLPEN)
#define __HAL_RCC_S_GPIOG_CLK_SLEEP_DISABLE()                                  \
   (RCC->MP_S_AHB4LPENCLRR = RCC_MP_S_AHB4LPENCLRR_GPIOGLPEN)
#define __HAL_RCC_S_GPIOH_CLK_SLEEP_DISABLE()                                  \
   (RCC->MP_S_AHB4LPENCLRR = RCC_MP_S_AHB4LPENCLRR_GPIOHLPEN)
#define __HAL_RCC_S_GPIOI_CLK_SLEEP_DISABLE()                                  \
   (RCC->MP_S_AHB4LPENCLRR = RCC_MP_S_AHB4LPENCLRR_GPIOILPEN)

/** @brief  Enable or disable the AHB4 non-secure peripheral clock during CSLEEP
 * mode.
 * @note   Peripheral clock gating in SLEEP mode can be used to further reduce
 *         power consumption.
 * @note   After wakeup from SLEEP mode, the peripheral clock is enabled again.
 ...
 *         may be secure or non-secure.
 */
#define __HAL_RCC_S_SYSRAM_CLK_SLEEP_ENABLE()                                  \
   (RCC->MP_S_AXIMLPENSETR = RCC_MP_S_AXIMLPENSETR_SYSRAMLPEN)

#define __HAL_RCC_S_SYSRAM_CLK_SLEEP_DISABLE()                                 \
   (RCC->MP_S_AXIMLPENCLRR = RCC_MP_S_AXIMLPENCLRR_SYSRAMLPEN)

/** @brief  Enable or disable the AXI non-secure peripheral clock during  CSLEEP
 * mode.
 * @note   Peripheral clock gating in SLEEP mode can be used to further reduce
 *         power consumption.
 * @note   After wakeup from SLEEP mode, the peripheral clock is enabled again.
...
#define __HAL_RCC_SYSRAM_CLK_SLEEP_ENABLE()                                    \
   (RCC->MP_NS_AXIMLPENSETR = RCC_MP_NS_AXIMLPENSETR_SYSRAMLPEN)
...
#define __HAL_RCC_SYSRAM_CLK_SLEEP_DISABLE()                                   \
   (RCC->MP_NS_AXIMLPENCLRR = RCC_MP_NS_AXIMLPENCLRR_SYSRAMLPEN)
...
#define __HAL_RCC_SRAM1_CLK_SLEEP_ENABLE()                                     \
   (RCC->MP_MLAHBLPENSETR = RCC_MP_MLAHBLPENSETR_SRAM1LPEN)
#define __HAL_RCC_SRAM2_CLK_SLEEP_ENABLE()                                     \
   (RCC->MP_MLAHBLPENSETR = RCC_MP_MLAHBLPENSETR_SRAM2LPEN)
#define __HAL_RCC_SRAM3_CLK_SLEEP_ENABLE()                                     \
   (RCC->MP_MLAHBLPENSETR = RCC_MP_MLAHBLPENSETR_SRAM3LPEN)

#define __HAL_RCC_SRAM1_CLK_SLEEP_DISABLE()                                    \
   (RCC->MP_MLAHBLPENCLRR = RCC_MP_MLAHBLPENCLRR_SRAM1LPEN)
#define __HAL_RCC_SRAM2_CLK_SLEEP_DISABLE()                                    \
   (RCC->MP_MLAHBLPENCLRR = RCC_MP_MLAHBLPENCLRR_SRAM2LPEN)
#define __HAL_RCC_SRAM3_CLK_SLEEP_DISABLE()                                    \
   (RCC->MP_MLAHBLPENCLRR = RCC_MP_MLAHBLPENCLRR_SRAM3LPEN)
...
#define IS_HSE_IN_USE()                                                        \
   ((((__HAL_RCC_GET_MPU_SOURCE() == RCC_MPUSOURCE_HSE) &&                     \
      (__HAL_RCC_GET_FLAG(RCC_FLAG_MPUSRCRDY) == 1U)) ||                       \
     ((__HAL_RCC_GET_AXIS_SOURCE() == RCC_AXISSOURCE_HSE) &&                   \
      (__HAL_RCC_GET_FLAG(RCC_FLAG_AXISSRCRDY) == 1U)) ||                      \
     ((__HAL_RCC_GET_MLAHB_SOURCE() == RCC_MLAHBSSOURCE_HSE) &&                \
      (__HAL_RCC_GET_FLAG(RCC_FLAG_MLAHBSSRCRDY) == 1U)) ||                    \
                                                                               \
     ((__HAL_RCC_GET_PLL12_SOURCE() == RCC_PLL12SOURCE_HSE) &&                 \
      ((__HAL_RCC_GET_FLAG(RCC_FLAG_PLL1RDY) == 1U) ||                         \
       (__HAL_RCC_GET_FLAG(RCC_FLAG_PLL2RDY) == 1U))) ||                       \
                                                                               \
     ((__HAL_RCC_GET_PLL3_SOURCE() == RCC_PLL3SOURCE_HSE) &&                   \
      (__HAL_RCC_GET_FLAG(RCC_FLAG_PLL3RDY) == 1U)) ||                         \
                                                                               \
     ((__HAL_RCC_GET_PLL4_SOURCE() == RCC_PLL4SOURCE_HSE) &&                   \
      (__HAL_RCC_GET_FLAG(RCC_FLAG_PLL4RDY) == 1U)))                           \
        ? 1U                                                                   \
        : 0U)
...
#define IS_HSI_IN_USE()                                                        \
   ((((__HAL_RCC_GET_MPU_SOURCE() == RCC_MPUSOURCE_HSI) &&                     \
     ...
     ((__HAL_RCC_GET_AXIS_SOURCE() == RCC_AXISSOURCE_HSI) &&                   \
      (__HAL_RCC_GET_FLAG(RCC_FLAG_AXISSRCRDY) == 1U)) ||                      \
     ((__HAL_RCC_GET_MLAHB_SOURCE() == RCC_MLAHBSSOURCE_HSI) &&                \
      (__HAL_RCC_GET_FLAG(RCC_FLAG_MLAHBSSRCRDY) == 1U)) ||                    \
                                                                               \
...
#define IS_CSI_IN_USE()                                                        \
   ((((__HAL_RCC_GET_PLL3_SOURCE() == RCC_PLL3SOURCE_CSI) &&                   \
      (__HAL_RCC_GET_FLAG(RCC_FLAG_PLL3RDY) == 1U)) ||                         \
     ((__HAL_RCC_GET_MLAHB_SOURCE() == RCC_MLAHBSSOURCE_CSI) &&                \
      (__HAL_RCC_GET_FLAG(RCC_FLAG_MLAHBSSRCRDY) == 1U)) ||                    \
                                                                               \
...
/** @brief Macros to test if PLLx are used on the Core and buses clock
 * generation system (MPU, MLAHB or AXIS blocks)
 * @note  HAL driver does not ensure these clocks are used by peripherals, it's
 * up to user code  */
...
#define __IS_PLL3_IN_USE()                                                     \
   (((__HAL_RCC_GET_MLAHB_SOURCE() == RCC_MLAHBSSOURCE_PLL3) &&                \
     (__HAL_RCC_GET_FLAG(RCC_FLAG_MLAHBSSRCRDY) == 1U))                        \
        ? 1U                                                                   \
        : 0U)
 ...
 * @note   Write access to this register is not allowed during the clock restore
 * sequence
 ...
 *          This parameter can be one of the following values:
 *              @arg RCC_HSI_DIV1:  Division by 1, ck_hsi(_ker) = 64 MHz
 * (default after reset)
 ...
 *         of the following:
 *              - RCC_HSI_DIV1:  Division by 1, ck_hsi(_ker) = 64 MHz (default
 * after reset)
 ...
 * oscillator (HSI) in STOP mode to be quickly available as kernel clock.
...
#define __HAL_RCC_HSISTOP_DISABLE()                                            \
 ...
 *         Please refer to the datasheet of the product for for more details on
 * how to calibrate the CSI.
...
/**
 * @brief    Macros to enable or disable the force of the Internal High Speed
 * oscillator (CSI) in STOP mode to be quickly available as kernel clock.
 * @note     Keeping the CSI ON in STOP mode allows to avoid slowing down the
 * communication speed because of the CSI startup time.
...
#define __HAL_RCC_CSISTOP_DISABLE()                                            \
 ...
 *         00010: The guaranteed NRST low pulse duration is about 2 ms (2 x 32
 * ck_lsi cycles),
 *         ...
 *         11111: The guaranteed NRST low pulse duration is about 31 ms (31 x 32
 * ck_lsi cycles).
 */
...
/**
 * @brief  Macro (deprecated) to configure the External High Speed oscillator
 * (HSE).
...
/**
 * @brief    Macros to enable or disable the force of the External High Speed
 * oscillator (HSE) in STOP mode to be quickly available as kernel clock.
 * @note     Keeping the HSE ON in STOP mode allows to avoid slowing down the
 * communication speed because of the HSE startup time.
 * @note     The enable of this function has not effect on the HSION bit.
 *           This parameter can be: ENABLE or DISABLE.
 * @retval None
 */
...
#define __HAL_RCC_HSESTOP_DISABLE()                                            \
   WRITE_REG(RCC->OCENCLRR, RCC_OCENCLRR_HSEKERON)

/**
 * @brief  Macro (deprecated) to configure the External Low Speed oscillator
 * (LSE).
 * @note   Macro name is kept to maintain compatibility and it is mapped on
...
/**
 * @brief  Macro to configures the External Low Speed oscillator (LSE) drive
 * capability.
 * @note   As the LSE is in the Backup domain and write access is denied to
 *         this domain after reset, you have to enable write access using
 *         HAL_PWR_EnableBkUpAccess() function before to configure the LSE
 ...
 * (default after backup domain reset)
 *            @arg RCC_LSEDRIVE_MEDIUMLOW: LSE oscillator medium low drive
 * capability.
 *            @arg RCC_LSEDRIVE_MEDIUMHIGH: LSE oscillator medium high drive
 * capability.
 ...
 *         of the following:
 *             - RCC_LSEDRIVE_LOW: LSE oscillator low drive capability (default
 * after backup domain reset)
 *             - RCC_LSEDRIVE_MEDIUMLOW: LSE oscillator medium low drive
 * capability.
 *             - RCC_LSEDRIVE_MEDIUMHIGH: LSE oscillator medium high drive
 * capability.
 *             - RCC_LSEDRIVE_HIGH: LSE oscillator high drive capability.
 */
#define __HAL_RCC_GET_LSEDRIVE()                                               \
   ((uint32_t)(READ_BIT(RCC->BDCR, RCC_BDCR_LSEDRV)))
 ...
 * write access is protected to this domain after reset, you have to enable
 * write access using the Power Backup Access macro ( DBP bit in the PWR control
 ...
 *         This parameter can be one of the following values:
 *            @arg RCC_RTCCLKSOURCE_OFF: No clock (default after backup domain
 * reset)
 *            @arg RCC_RTCCLKSOURCE_LSE: LSE selected as RTC clock.
 *            @arg RCC_RTCCLKSOURCE_LSI: LSI selected as RTC clock.
 *            @arg RCC_RTCCLKSOURCE_HSE_DIV: HSE clock divided by RTCDIV value
 * is used as RTC clock
 *
 ...
 *         of the following:
 *             - RCC_RTCCLKSOURCE_OFF:  No clock (default after backup domain
 * reset)
 *             - RCC_RTCCLKSOURCE_LSE:  LSE used as RTC clock.
 *             - RCC_RTCCLKSOURCE_LSI:  LSI used as RTC clock.
 *             - RCC_RTCCLKSOURCE_HSE_DIV: HSE clock divided by RTCDIV value is
 * used as RTC clock
 */
#define __HAL_RCC_GET_RTC_SOURCE()                                             \
   ((uint32_t)(READ_BIT(RCC->BDCR, RCC_BDCR_RTCSRC)))
 ...
 * @note   The PLL1 is disabled by hardware when entering STOP and STANDBY
 * modes.
 */
 ...
 * @note   Enabling/disabling  Those Clocks outputs can be disabled anytime
 * without the need to stop the PLL, with the exception of ck_pll_p  cannot be
 * stopped if used as MPU Clock
 ...
 * PLL1 VCO
 * @note   Enabling/disabling  Fractional Part can be done anytime  without the
 * need to stop the PLL1
 * @retval None
 */

#define __HAL_RCC_PLL1FRACV_ENABLE()                                           \
   SET_BIT(RCC->PLL1FRACR, RCC_PLL1FRACR_FRACLE)

#define __HAL_RCC_PLL1FRACV_DISABLE()                                          \
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_PLL12SOURCE_HSI: HSI oscillator clock selected as PLL1
 * and PLL2 clock entry
 *            @arg RCC_PLL12SOURCE_HSE: HSE oscillator clock selected as PLL1
 * and PLL2 clock entry
 *            @arg RCC_PLL12SOURCE_OFF: No clock send to DIVMx divider and PLLs
 * @note   This clock source (__RCC_PLL12Source__) is common for the PLL1 and
 * PLL2 .
 * @retval None
 */
 ...
 * @retval The clock source used as PLL1 and PLL1 clocks. The returned value can
 ...
 */
#define __HAL_RCC_GET_PLL12_SOURCE()                                           \
   ((uint32_t)(RCC->RCK12SELR & RCC_RCK12SELR_PLL12SRC))
 ...
 *          This parameter must be a number between 1 and 64
 * @note   You have to set the PLLM1 parameter correctly to ensure that the VCO
 * input frequency ranges from 8 to 16 MHz
 * @param  __PLLN1__: specifies the multiplication factor for PLL VCO output
 * clock This parameter must be a number between 25 and 100
 ...
 * @retval None
 */
#define __HAL_RCC_PLL1_CONFIG(__PLLM1__, __PLLN1__, __PLLP1__, __PLLQ1__,      \
                              __PLLR1__)                                       \
   do {                                                                        \
...
/**
 * @brief  Macro to configure the PLL1 clock Fractional Part Of The
 * Multiplication Factor
 *
 * @note   These bits can be written at any time, allowing dynamic fine-tuning
 * of the PLL1 VCO
 *
 * @param  __RCC_PLL1FRACV__: specifies Fractional Part Of The Multiplication
 * Factorfor PLL1 VCO It should be a value between 0 and 8191 ((2^13)-1)
 * @note   Warning: the software has to set correctly these bits to insure that
 * the VCO output frequency is between its valid frequency range, which is: 800
 * to 1600 MHz
 * @retval None
 */
...
/** @brief  Macros to enable or disable the Spread Spectrum Clock Generator of
 * PLL1
 */
#define __HAL_RCC_PLL1_SSMODE_ENABLE()                                         \
   SET_BIT(RCC->PLL1CR, RCC_PLL1CR_SSCG_CTRL)

#define __HAL_RCC_PLL1_SSMODE_DISABLE()                                        \
...
/** @brief  Macro to config the PLL1 Clock Spreading Generator
  ...
  *          This parameter can be one of the following values:
  *            @arg RCC_TPDFN_DIS_ENABLED: Dithering noise injection enabled
  (default after reset)
  *            @arg RCC_TPDFN_DIS_DISABLED:  Dithering noise injection disabled

  * @param  __RCC_PLL1_RPDFN_DIS__:      Dithering TPDF noise control
  *          This parameter can be one of the following values:
  *            @arg RCC_RPDFN_DIS_ENABLED: Dithering noise injection enabled
  (default after reset)
  ...
  *          This parameter can be one of the following values:
  *            @arg RCC_SSCG_CENTER_SPREAD:  Center-spread modulation selected
  (default after reset)
 ...
 * @brief  Enables or disables each clock output
 * @note   Enabling/disabling  Those Clocks outputs can be disabled anytime
 * without the need to stop the PLL
 ...
 * PLL2 VCO
 * @note   Enabling/disabling  Fractional Part can be done anytime  without the
 * need to stop the PLL2
 * @retval None
 */

#define __HAL_RCC_PLL2FRACV_ENABLE()                                           \
   SET_BIT(RCC->PLL2FRACR, RCC_PLL2FRACR_FRACLE)

#define __HAL_RCC_PLL2FRACV_DISABLE()                                          \
 ...
 *          This parameter must be a number between 1 and 64
 * @note   You have to set the PLLM2 parameter correctly to ensure that the VCO
 * input frequency ranges from 8 to 16 MHz
 * @param  __PLLN2__: specifies the multiplication factor for PLL VCO output
 * clock This parameter must be a number between 25 and 100
 * @note   You have to set the PLLN parameter correctly to ensure that the VCO
 *         output frequency is between 800 to 1600 MHz
 ...
 * @retval None
 */
#define __HAL_RCC_PLL2_CONFIG(__PLLM2__, __PLLN2__, __PLLP2__, __PLLQ2__,      \
                              __PLLR2__)                                       \
   do {                                                                        \
...
/**
 * @brief  Macro to configure the PLL2 clock Fractional Part Of The
 * Multiplication Factor
 *
 * @note   These bits can be written at any time, allowing dynamic fine-tuning
 * of the PLL2 VCO
 *
 * @param  __RCC_PLL2FRACV__: specifies Fractional Part Of The Multiplication
 * Factorfor PLL2 VCO It should be a value between 0 and 8191 ((2^13)-1)
 * @note   Warning: the software has to set correctly these bits to insure that
 * the VCO output frequency is between its valid frequency range, which is: 800
 * to 1600 MHz
 * @retval None
 ...
 * PLL2
 */
#define __HAL_RCC_PLL2_SSMODE_ENABLE()                                         \
   SET_BIT(RCC->PLL2CR, RCC_PLL2CR_SSCG_CTRL)

#define __HAL_RCC_PLL2_SSMODE_DISABLE()                                        \
 ...
 * PLL3 VCO
 * @note   Enabling/disabling  Fractional Part can be done anytime  without the
 * need to stop the PLL3
 * @retval None
 */

#define __HAL_RCC_PLL3FRACV_ENABLE()                                           \
   SET_BIT(RCC->PLL3FRACR, RCC_PLL3FRACR_FRACLE)

#define __HAL_RCC_PLL3FRACV_DISABLE()                                          \
   CLEAR_BIT(RCC->PLL3FRACR, RCC_PLL3FRACR_FRACLE)

/** @brief  Macros to enable or disable the Spread Spectrum Clock Generator of
 * PLL3
 */
#define __HAL_RCC_PLL3_SSMODE_ENABLE()                                         \
   SET_BIT(RCC->PLL3CR, RCC_PLL3CR_SSCG_CTRL)

#define __HAL_RCC_PLL3_SSMODE_DISABLE()                                        \
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_PLL3SOURCE_HSI: HSI oscillator clock selected as PLL3
 * clock entry
 *            @arg RCC_PLL3SOURCE_HSE: HSE oscillator clock selected as PLL3
 * clock entry
 *            @arg RCC_PLL3SOURCE_CSI: HSE oscillator clock selected as PLL3
 * clock entry
 ...
 */
#define __HAL_RCC_GET_PLL3_SOURCE()                                            \
   ((uint32_t)(RCC->RCK3SELR & RCC_RCK3SELR_PLL3SRC))
 ...
 *          This parameter must be a number between 1 and 64
 * @note   You have to set the PLLM1 parameter correctly to ensure that the VCO
 * input frequency ranges from 4 to 16 MHz
 * @param  __PLLN3__: specifies the multiplication factor for PLL VCO output
 * clock This parameter must be a number between 25 and 200
 * @note   You have to set the PLLN parameter correctly to ensure that the VCO
 ...
 * @retval None
 */
#define __HAL_RCC_PLL3_CONFIG(__PLLM3__, __PLLN3__, __PLLP3__, __PLLQ3__,      \
                              __PLLR3__)                                       \
   do {                                                                        \
...
/**
 * @brief  Macro to configure the PLL3 clock Fractional Part Of The
 * Multiplication Factor
 *
 * @note   These bits can be written at any time, allowing dynamic fine-tuning
 * of the PLL3 VCO
 *
 * @param  __RCC_PLL3FRACV__: specifies Fractional Part Of The Multiplication
 * Factorfor PLL3 VCO It should be a value between 0 and 8191 ((2^13)-1)
 * @note   Warning: the software has to set correctly these bits to insure that
 * the VCO output frequency is between its valid frequency range, which is: 400
 * to 800 MHz
 * @retval None
 */
 ...
 *         This parameter can be one of the following values:
 *            @arg RCC_PLL3IFRANGE_0: Range frequency is between 4 and 8 MHz
 * (default after reset)
 ...
 * @note   The PLL4 is disabled by hardware when entering STOP and STANDBY
 * modes.
 */
 ...
 * PLL4 VCO
 * @note   Enabling/disabling  Fractional Part can be done anytime  without the
 * need to stop the PLL4
 * @retval None
 */

#define __HAL_RCC_PLL4FRACV_ENABLE()                                           \
   SET_BIT(RCC->PLL4FRACR, RCC_PLL4FRACR_FRACLE)

#define __HAL_RCC_PLL4FRACV_DISABLE()                                          \
   CLEAR_BIT(RCC->PLL4FRACR, RCC_PLL4FRACR_FRACLE)

/** @brief  Macros to enable or disable the Spread Spectrum Clock Generator of
 * PLL4
 */
#define __HAL_RCC_PLL4_SSMODE_ENABLE()                                         \
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_PLL4SOURCE_HSI: HSI oscillator clock selected as PLL4
 * clock entry
 *            @arg RCC_PLL4SOURCE_HSE: HSE oscillator clock selected as PLL4
 * clock entry
 *            @arg RCC_PLL4SOURCE_CSI: HSE oscillator clock selected as PLL4
 * clock entry
 *            @arg RCC_PLL4SOURCE_I2S_CKIN: Signal I2S_CKIN used as reference
 * clock
 * @retval None
 */
 ...
 */
#define __HAL_RCC_GET_PLL4_SOURCE()                                            \
   ((uint32_t)(RCC->RCK4SELR & RCC_RCK4SELR_PLL4SRC))
 ...
 * @note   You have to set the PLLM1 parameter correctly to ensure that the VCO
 * input frequency ranges from 4 to 16 MHz
 * @param  __PLLN4__: specifies the multiplication factor for PLL VCO output
 * clock This parameter must be a number between 25 and 200
 * @note   You have to set the PLLN parameter correctly to ensure that the VCO
 *         output frequency is between 400 to 800 MHz
 ...
 * @retval None
 */
#define __HAL_RCC_PLL4_CONFIG(__PLLM4__, __PLLN4__, __PLLP4__, __PLLQ4__,      \
                              __PLLR4__)                                       \
   do {                                                                        \
...
/**
 * @brief  Macro to configure the PLL4 clock Fractional Part Of The
 * Multiplication Factor
 *
 * @note   These bits can be written at any time, allowing dynamic fine-tuning
 * of the PLL4 VCO
 *
 * @param  __RCC_PLL4FRACV__: specifies Fractional Part Of The Multiplication
 * Factorfor PLL4 VCO It should be a value between 0 and 8191 ((2^13)-1)
 * @note   Warning: the software has to set correctly these bits to insure that
 * the VCO output frequency is between its valid frequency range, which is: 400
 * to 800 MHz
 * @retval None
 ...
 *         This parameter can be one of the following values:
 *            @arg RCC_PLL4IFRANGE_0: Range frequency is between 4 and 8 MHz
 * (default after reset)
 ...
 *         of the following:
 *              - RCC_MCO1SOURCE_HSI:  HSI used as MCO1 clock (default after
 * reset).
 ...
 */
#define __HAL_RCC_GET_MCO1_SOURCE()                                            \
   ((uint32_t)(RCC->MCO1CFGR & RCC_MCO1CFGR_MCO1SEL))
 ...
 */
#define __HAL_RCC_GET_MCO1_DIV()                                               \
   ((uint32_t)(RCC->MCO1CFGR & RCC_MCO1CFGR_MCO1DIV))
 ...
 *            @arg RCC_MCO2SOURCE_MLAHB: MLAHB clock selected as MCO2 clock
 * entry
 ...
 *         of the following:
 *              - RCC_MCO2SOURCE_MPU:  MPU used as MCO2 clock (default after
 * reset).
 ...
 */
#define __HAL_RCC_GET_MCO2_SOURCE()                                            \
   ((uint32_t)(RCC->MCO2CFGR & RCC_MCO2CFGR_MCO2SEL))
 ...
 *            - RCC_MCODIV_16: division by 16
 */
#define __HAL_RCC_GET_MCO2_DIV()                                               \
   ((uint32_t)(RCC->MCO2CFGR & RCC_MCO2CFGR_MCO2DIV))

/**
 * @brief  Macro to configure MPU sub-system clock source
 * @note   Set and reset by software to select the MPU sub-system clock source
 * (ck_mpuss)
 * @note   If TZEN = 1, it is only possible to modify this parameter in secure
 * mode
 ...
 *          This parameter can be one of the following values:
 *              @arg RCC_MPUSOURCE_HSI:   HSI used as MPU clock (default after
 * reset).
 ...
 *         of the following:
 *              - RCC_MPUSOURCE_HSI:   HSI used as MPU clock (default after
 * reset).
 ...
 */
#define __HAL_RCC_GET_MPU_SOURCE()                                             \
   ((uint32_t)(RCC->MPCKSELR & RCC_MPCKSELR_MPUSRC))

/**
 * @brief  Macro to configure AXISS clock source
 * @note   Set and reset by software to select the AXI sub-system clock source
 * (ck_axiss)
 * @note   If TZEN = 1, it is only possible to modify this parameter in secure
 * mode
 * @note   Write access is not allowed during the clock restore sequence
 ...
 *          This parameter can be one of the following values:
 *              @arg RCC_AXISSOURCE_HSI:   HSI used as AXISS clock (default
 * after reset).
 ...
 *         of the following:
 *              - RCC_AXISSOURCE_HSI:  HSI used as AXIS clock (default after
 * reset).
 ...
 */
#define __HAL_RCC_GET_AXIS_SOURCE()                                            \
   ((uint32_t)(RCC->ASSCKSELR & RCC_ASSCKSELR_AXISSRC))

/**
 * @brief  Macro to configure MLAHB sub-system clock source
 * @note   Set and reset by software to select the MLAHB sub-system clock source
 * (ck_MLAHBss)
 * @note   If TZEN = 1, it is only possible to modify this parameter in secure
 * mode
 * @note   Write access is not allowed during the clock restore sequence
 ...
 *          This parameter can be one of the following values:
 *              @arg RCC_MLAHBSSOURCE_HSI:   HSI used as MLAHB clock (default
 * after reset).
...
#define __HAL_RCC_MLAHB_SOURCE(__RCC_MLAHBSSOURCE__)                           \
   do {                                                                        \
      MODIFY_REG(RCC->MSSCKSELR, RCC_MSSCKSELR_MLAHBSSRC,                      \
                 __RCC_MLAHBSSOURCE__);                                        \
   } while (0)
 ...
 *         of the following:
 *             - RCC_MLAHBSSOURCE_HSI:  HSI used as MLAHB clock (default after
 * reset).
 ...
 */
#define __HAL_RCC_GET_MLAHB_SOURCE()                                           \
   ((uint32_t)(RCC->MSSCKSELR & RCC_MSSCKSELR_MLAHBSSRC))

/**
 * @brief  Macro to set the HSE division factor for RTC clock
 * @note   Set and cleared by software to divide the HSE to generate a clock for
 * RTC.
 * @note   If TZEN = 1, this parameter can only be modified in secure mode
 * @note   Caution: The software has to set these bits correctly to ensure that
 * the clock supplied to the RTC is lower than 4 MHz.
 * @note   These bits must be configured if needed before selecting the RTC
 * clock source
 *
 ...
 * @retval The HSE division factor for RTC clock. The returned value can be a
 * number between 1 and 64 Eg.: 1:  HSE (default after reset) 2:  HSE/2 64:
 * HSE/64
 */
#define __HAL_RCC_GET_RTC_HSEDIV()                                             \
   ((uint32_t)((RCC->RTCDIVR & RCC_RTCDIVR_RTCDIV) + 1U))

/**
 * @brief  Macro to configure MPU Core clock divider
 * @note   Set and reset by software to control the MPU clock division factor.
 * @note   If TZEN = 1, this parameter can only be modified in secure mode.
 * @note   It is possible to change this division ratio on-the-fly. It impacts
 * only the frequency of MPU clock.
 * @note   The clocks are divided with the new prescaler factor, from 1 to 16
 * ck_mpuss cycles after MPUDIV update.
 * @note   The application can check if the new division factor is taken into
 * account by reading back the MPUDIVRDY flag
 *
 * @param  __RCC_MPUDIV__: specifies the MPU division factor
 *          This parameter can be one of the following values:
 *              @arg RCC_MPU_DIV_OFF:  The MPUDIV is disabled (default after
 * reset)
 ...
 *
 * @note   Warning: Do not set RCC_MPU_DIV_OFF if the MPUSRC =
 * RCC_MPUSOURCE_MPUDIV, otherwise the processor will no longer be clocked
 */
 ...
 */
#define __HAL_RCC_GET_MPU_DIV()                                                \
   ((uint32_t)(RCC->MPCKDIVR & RCC_MPCKDIVR_MPUDIV))

/**
 * @brief  Macro to configure AXI Core clock divider
 * @note   Set and reset by software to control the  AXI, AHB5 and AHB6 clock
 * division factor.
 * @note   If TZEN = 1, this parameter can only be modified in secure mode.
 * @note   It is possible to change this division ratio on-the-fly. It impacts
 * the frequency of AXI, APB4, APB5 AHB5 and AHB6 clocks.
 * @note   The clocks are divided with the new prescaler factor, from 1 to 16
 * ck_axiss cycles after AXIDIV update.
 * @note   The application can check if the new division factor is taken into
 * account by reading back the AXIDIVRDY flag
 *
 ...
 * only the APB4 clock.
 * @note   The clocks are divided with the new prescaler factor, from 1 to 16
 * ck_aclk cycles after APB4DIV update.
 * @note   The application can check if the new division factor is taken into
 * account by reading back the APB4DIVRDY flag
 *
 ...
 */
#define __HAL_RCC_GET_APB4_DIV()                                               \
   ((uint32_t)(RCC->APB4DIVR & RCC_APB4DIVR_APB4DIV))
 ...
 * only the APB5 clock.
 * @note   The clocks are divided with the new prescaler factor, from 1 to 16
 * ck_aclk cycles after APB5DIV update.
 * @note   The application can check if the new division factor is taken into
 * account by reading back the APB5DIVRDY flag
 *
 ...
 */
#define __HAL_RCC_GET_APB5_DIV()                                               \
   ((uint32_t)(RCC->APB5DIVR & RCC_APB5DIVR_APB5DIV))

/**
 * @brief  Macro to configure MLAHB clock divider
 * @note   Set and reset by software to control the  MLAHB clock division
 * factor.
 * @note   If TZEN = 1, this parameter can only be modified in secure mode.
 * @note   Changing this division ratio has an impact on the frequency of MLAHB
 * clock, and all bus matrix clocks.
 * @note   The clocks are divided with the new prescaler factor, from 1 to 16
 * ck_mlahbss cycles after MLAHBDIV update.
 * @note   The application can check if the new division factor is taken into
 * account by reading back the MLAHBDIVRDY flag
 *
 * @param  __RCC_MLAHBDIV__: specifies the MLAHB division factor
 *          This parameter can be one of the following values:
 *              @arg RCC_MLAHB_DIV1:  ck_mlahbss not divided (default after
 * reset)
...
#define __HAL_RCC_MLAHB_DIV(__RCC_MLAHBDIV__)                                  \
   do {                                                                        \
      MODIFY_REG(RCC->MLAHBDIVR, RCC_MLAHBDIVR_MLAHBDIV, __RCC_MLAHBDIV__);    \
   } while (0)
 ...
 */
#define __HAL_RCC_GET_MLAHB_DIV()                                              \
   ((uint32_t)(RCC->MLAHBDIVR & RCC_MLAHBDIVR_MLAHBDIV))
 ...
 * only the APB1 clock.
 * @note   The clocks are divided with the new prescaler factor, from 1 to 16
 * ck_hclk cycles after APB1DIV update.
 * @note   The application can check if the new division factor is taken into
 * account by reading back the APB1DIVRDY flag
 *
 ...
 */
#define __HAL_RCC_GET_APB1_DIV()                                               \
   ((uint32_t)(RCC->APB1DIVR & RCC_APB1DIVR_APB1DIV))

/**
  * @brief  Macro to configure APB2 clock divider
  * @note   Set and reset by software to control the  APB2 clock division
  factor.
  * @note   It is possible to change this division ratio on-the-fly. It impacts
  only the APB2 clock.

  * @note   The clocks are divided with the new prescaler factor, from 1 to 16
  ck_hclk cycles after APB2DIV update.
  * @note   The application can check if the new division factor is taken into
  account by
 ...
 */
#define __HAL_RCC_GET_APB2_DIV()                                               \
   ((uint32_t)(RCC->APB2DIVR & RCC_APB2DIVR_APB2DIV))

/**
  * @brief  Macro to configure APB3 clock divider
  * @note   Set and reset by software to control the  APB3 clock division
  factor.
  * @note   It is possible to change this division ratio on-the-fly. It impacts
  only the APB3 clock.

  * @note   The clocks are divided with the new prescaler factor, from 1 to 16
  ck_hclk cycles after APB3DIV update.
  * @note   The application can check if the new division factor is taken into
  account by
 ...
 */
#define __HAL_RCC_GET_APB3_DIV()                                               \
   ((uint32_t)(RCC->APB3DIVR & RCC_APB3DIVR_APB3DIV))
 ...
 * only the APB6 clock.
 * @note   The clocks are divided with the new prescaler factor, from 1 to 16
 * ck_aclk cycles after APB6DIV update.
 * @note   The application can check if the new division factor is taken into
 * account by reading back the APB6DIVRDY flag
 *
...
#define __HAL_RCC_APB6_DIV(__RCC_APB6DIV__)                                    \
   do {                                                                        \
      MODIFY_REG(RCC->APB6DIVR, RCC_APB6DIVR_APB6DIV, __RCC_APB6DIV__);        \
   } while (0)
 ...
 */
#define __HAL_RCC_GET_APB6_DIV()                                               \
   ((uint32_t)(RCC->APB6DIVR & RCC_APB6DIVR_APB6DIV))
#endif /* RCC_APB6DIVR_APB6DIV */
...
#define __HAL_RCC_ENABLE_IT(__INTERRUPT__)                                     \
   SET_BIT(RCC->MP_CIER, (__INTERRUPT__))
#endif /* CORE_CA7 */
...
#define __HAL_RCC_DISABLE_IT(__INTERRUPT__)                                    \
   CLEAR_BIT(RCC->MP_CIER, (__INTERRUPT__))
#endif /* CORE_CA7 */
...
/** @addtogroup RCC_Exported_Functions_Group1 Initialization and
