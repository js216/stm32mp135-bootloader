...
typedef struct {
   ...
   uint32_t RepetitionCounter; /*!< Specifies the repetition counter value. Each
                                  ...
                                  update event is generated and counting
                                  restarts from the RCR value (N). This means in
...
typedef struct {
   ...
   uint32_t
       CompareValue; /*!< Specifies the Compare value to be loaded into the
...
#define LL_TIM_TIM1_ETRSOURCE_GPIO                                             \
   0x00000000UL /*!< TIM1_ETR is connected to I/O */
...
#define LL_TIM_TIM1_ETRSOURCE_ADC2_AWD1                                        \
   (TIM1_AF1_ETRSEL_2 |                                                        \
    TIM1_AF1_ETRSEL_1) /*!< TIM1_ETR is connected to ADC2 AWD1 */
#define LL_TIM_TIM1_ETRSOURCE_ADC2_AWD2                                        \
   (TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_1 |                                    \
    TIM1_AF1_ETRSEL_0) /*!< TIM1_ETR is connected to ADC2 AWD2 */
#define LL_TIM_TIM1_ETRSOURCE_ADC2_AWD3                                        \
   TIM1_AF1_ETRSEL_3 /*!< TIM1_ETR is connected to ADC2 AWD3 */
/**
 * @}
 */
...
#define LL_TIM_TIM2_ETRSOURCE_GPIO                                             \
   0x00000000UL /*!< TIM2_ETR is connected to I/O */
#define LL_TIM_TIM2_ETRSOURCE_RCC_LSE                                          \
   (TIM1_AF1_ETRSEL_1 |                                                        \
    TIM1_AF1_ETRSEL_0) /*!< TIM2_ETR is connected to LSE      */
...
#define LL_TIM_TIM2_ETRSOURCE_SAI1_FSB                                         \
   (TIM1_AF1_ETRSEL_2 |                                                        \
    TIM1_AF1_ETRSEL_0) /*!< TIM2_ETR is connected to SAI1 FS_B */
#define LL_TIM_TIM2_ETRSOURCE_ETH1_PPS                                         \
   (TIM1_AF1_ETRSEL_2 |                                                        \
    TIM1_AF1_ETRSEL_1) /*!< TIM2_ETR is connected to ETH1 PPS */
#define LL_TIM_TIM2_ETRSOURCE_ETH2_PPS                                         \
   (TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_1 |                                    \
    TIM1_AF1_ETRSEL_0) /*!< TIM2_ETR is connected to ETH2 PPS */
/**
 * @}
 */
...
#define LL_TIM_TIM3_ETRSOURCE_GPIO                                             \
   0x00000000UL /*!< TIM3_ETR is connected to I/O */
#define LL_TIM_TIM3_ETRSOURCE_ETH1_PPS                                         \
   (TIM1_AF1_ETRSEL_2 |                                                        \
    TIM1_AF1_ETRSEL_1) /*!< TIM3_ETR is connected to ETH1 PPS */
#define LL_TIM_TIM3_ETRSOURCE_ETH2_PPS                                         \
   (TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_1 |                                    \
    TIM1_AF1_ETRSEL_0) /*!< TIM3_ETR is connected to ETH2 PPS */
/**
 * @}
 */
...
#define LL_TIM_TIM4_ETRSOURCE_GPIO                                             \
   0x00000000UL /*!< TIM4_ETR is connected to I/O */
/**
 * @}
 */
...
#define LL_TIM_TIM5_ETRSOURCE_GPIO                                             \
   0x00000000UL /*!< TIM5_ETR is connected to I/O */
#define LL_TIM_TIM5_ETRSOURCE_SAI2_FSA                                         \
   TIM1_AF1_ETRSEL_0 /*!< TIM5_ETR is connected to SAI2 FS_A */
#define LL_TIM_TIM5_ETRSOURCE_SAI2_FSB                                         \
   TIM1_AF1_ETRSEL_1 /*!< TIM5_ETR is connected to SAI2 FS_B */
#define LL_TIM_TIM5_ETRSOURCE_OTG_SOF                                          \
   (TIM1_AF1_ETRSEL_1 |                                                        \
    TIM1_AF1_ETRSEL_0) /*!< TIM5_ETR is connected to OTG SOF */
/**
 * @}
 */
...
#define LL_TIM_TIM8_ETRSOURCE_GPIO                                             \
   0x00000000UL /*!< TIM8_ETR is connected to I/O */
#define LL_TIM_TIM8_ETRSOURCE_ADC1_AWD1                                        \
   (TIM1_AF1_ETRSEL_1 |                                                        \
    TIM1_AF1_ETRSEL_0) /*!< TIM8_ETR is connected to ADC1 AWD1 */
#define LL_TIM_TIM8_ETRSOURCE_ADC1_AWD2                                        \
   TIM1_AF1_ETRSEL_2 /*!< TIM8_ETR is connected to ADC1 AWD2 */
#define LL_TIM_TIM8_ETRSOURCE_ADC1_AWD3                                        \
   (TIM1_AF1_ETRSEL_2 |                                                        \
    TIM1_AF1_ETRSEL_0) /*!< TIM8_ETR is connected to ADC1 AWD3 */
#define LL_TIM_TIM8_ETRSOURCE_ADC2_AWD1                                        \
   (TIM1_AF1_ETRSEL_2 |                                                        \
    TIM1_AF1_ETRSEL_1) /*!< TIM8_ETR is connected to ADC2 AWD1 */
#define LL_TIM_TIM8_ETRSOURCE_ADC2_AWD2                                        \
   (TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_1 |                                    \
    TIM1_AF1_ETRSEL_0) /*!< TIM8_ETR is connected to ADC2 AWD2 */
#define LL_TIM_TIM8_ETRSOURCE_ADC2_AWD3                                        \
   TIM1_AF1_ETRSEL_3 /*!< TIM8_ETR is connected to ADC2 AWD3 */
/**
 * @}
 */
...
#define LL_TIM_DMABURST_BASEADDR_ARR                                           \
   (TIM_DCR_DBA_3 | TIM_DCR_DBA_1 |                                            \
    TIM_DCR_DBA_0) /*!< TIMx_ARR register is the DMA base address for DMA      \
                      burst */
...
#define LL_TIM_DMABURST_BASEADDR_CCMR3                                         \
   (TIM_DCR_DBA_4 | TIM_DCR_DBA_2 |                                            \
    TIM_DCR_DBA_0) /*!< TIMx_CCMR3 register is the DMA base address for DMA    \
                      burst */
#define LL_TIM_DMABURST_BASEADDR_CCR5                                          \
   (TIM_DCR_DBA_4 | TIM_DCR_DBA_2 |                                            \
    TIM_DCR_DBA_1) /*!< TIMx_CCR5 register is the DMA base address for DMA     \
                      burst */
...
#define LL_TIM_DMABURST_BASEADDR_AF2                                           \
   (TIM_DCR_DBA_4 | TIM_DCR_DBA_3 |                                            \
    TIM_DCR_DBA_0) /*!< TIMx_AF2 register is the DMA base address for DMA      \
                      burst */
#define LL_TIM_DMABURST_BASEADDR_TISEL                                         \
   (TIM_DCR_DBA_4 | TIM_DCR_DBA_3 |                                            \
    TIM_DCR_DBA_1) /*!< TIMx_TISEL register is the DMA base address for DMA    \
                      burst */
/**
 * @}
 */
