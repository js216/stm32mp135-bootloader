                                        ...
                                        uint32_t OutputChannel)
{
   ...
   be used as input and if TIM_CHANNEL_1 is used as input, the TIM_CHANNEL_2
   will be used as output whatever the combination, the TIM_CHANNEL_1 and
                         ...
                         uint32_t Channel)
{
   ...
   switch (sClearInputConfig->ClearInputSource) {
      case TIM_CLEARINPUTSOURCE_NONE: {
         ...
         CLEAR_BIT(htim->Instance->SMCR, (TIM_SMCR_ETF | TIM_SMCR_ETPS |
                                           ...
                                           pTIM_CallbackTypeDef pCallback)
{
   ...
   if (htim->State == HAL_TIM_STATE_READY) {
      switch (CallbackID) {
         ...
         case HAL_TIM_TRIGGER_CB_ID: htim->TriggerCallback = pCallback; break;
         ...
         case HAL_TIM_ERROR_CB_ID: htim->ErrorCallback = pCallback; break;
         ...
         case HAL_TIM_BREAK_CB_ID: htim->BreakCallback = pCallback; break;

         case HAL_TIM_BREAK2_CB_ID: htim->Break2Callback = pCallback; break;
