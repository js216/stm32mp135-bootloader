...
#define GPIO_AF2_USART2                                                        \
   ((uint8_t)0x02) /* USART2 Alternate Function mapping                        \
                    */
...
#define GPIO_AF3_LPTIM2                                                        \
   ((uint8_t)0x03) /* LPTIM2 Alternate Function mapping                        \
                    */
#define GPIO_AF3_DFSDM1                                                        \
   ((uint8_t)0x03) /* DFSDM1 Alternate Function mapping                        \
                    */
#define GPIO_AF3_LPTIM3                                                        \
   ((uint8_t)0x03) /* LPTIM3 Alternate Function mapping                        \
                    */
#define GPIO_AF3_LPTIM4                                                        \
   ((uint8_t)0x03) /* LPTIM4 Alternate Function mapping                        \
                    */
#define GPIO_AF3_LPTIM5                                                        \
   ((uint8_t)0x03)                    /* LPTIM5 Alternate Function mapping     \
                                       */
...
#define GPIO_AF4_DFSDM1                                                        \
   ((uint8_t)0x04) /* DFSDM1  Alternate Function mapping   */
#define GPIO_AF4_LPTIM2                                                        \
   ((uint8_t)0x04) /* LPTIM2 Alternate Function mapping                        \
                    */
...
#define GPIO_AF6_DFSDM1                                                        \
   ((uint8_t)0x06) /* DFSDM1 Alternate Function mapping                        \
                    */
#define GPIO_AF6_DCMIPP                                                        \
   ((uint8_t)0x06)                    /* DCMIPP Alternate Function mapping     \
                                       */
...
#define GPIO_AF7_UART7                                                         \
   ((uint8_t)0x07) /* UART7 Alternate Function mapping     */
#define GPIO_AF7_UART4                                                         \
   ((uint8_t)0x07)                   /* UART4 Alternate Function mapping     */
 ...
 */
#define GPIO_AF9_QUADSPI                                                       \
   ((uint8_t)0x09) /* QUADSPI Alternate Function mapping */
#if defined(FDCAN1)
...
#define GPIO_AF10_QUADSPI                                                      \
   ((uint8_t)0xA)                     /* QUADSPI Alternate Function mapping */
...
#endif                                 /* SDMMC2 */
#define GPIO_AF10_OTG2_HS                                                      \
   ((uint8_t)0xA)                      /* OTG2_HS Alternate Function mapping */
 ...
 */
#define GPIO_AF11_QUADSPI                                                      \
   ((uint8_t)0x0B) /* QUADSPI Alternate Function mapping */
#if defined(ETH)
...
#endif                                 /*ETH2*/
#define GPIO_AF13_QUADSPI                                                      \
   ((uint8_t)0x0D) /* QUADSPI Alternate Function mapping */
...
/** @addtogroup GPIOEx_Exported_Functions_Group1 Extended Peripheral Control
 * functions
 * @{
 */
