...
/** @defgroup RCCEx_Private_Function_Prototypes RCCEx Private Functions
 * Prototypes
 * @{
 */
...
HAL_StatusTypeDef RCCEx_PLL4_Config(const RCC_PLLInitTypeDef *pll4)
{
   ...
   if ((pll4->PLLState) != RCC_PLL_NONE) {
      ...
      if ((pll4->PLLState) == RCC_PLL_ON) {
         ...
         /*Disable the post-dividers*/
         __HAL_RCC_PLL4CLKOUT_DISABLE(RCC_PLL4_DIVP | RCC_PLL4_DIVQ |
                                      RCC_PLL4_DIVR);
         /* Disable the main PLL. */
         ...
         Once the PLL is enabled, these parameters can not be changed.
         If the User wants to change the PLL parameters he must disable the
         concerned PLL (PLLxON=0) and wait for the PLLxRDY flag to be at 0. The
         PLL configuration below can be done at any time: -Enable/Disable of
         output clock dividers (DIVPxEN, DIVQxEN & DIVRxEN) -Fractional Division
         Enable (PLLxFRACNEN) -Fractional Division factor (FRACNx)*/
         ...
         /* In integer or clock spreading mode the application shall ensure that
          * a 0 is loaded into the SDM */
         ...
         __HAL_RCC_PLL4CLKOUT_ENABLE(RCC_PLL4_DIVP | RCC_PLL4_DIVQ |
                                     RCC_PLL4_DIVR);
      } else {
         /*Disable the post-dividers*/
         __HAL_RCC_PLL4CLKOUT_DISABLE(RCC_PLL4_DIVP | RCC_PLL4_DIVQ |
...
HAL_RCCEx_PeriphCLKConfig(const RCC_PeriphCLKInitTypeDef *PeriphClkInit)
{
   ...
   if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAI1) ==
      ...
      switch (PeriphClkInit->Sai1ClockSelection) {
         ...
         case RCC_SAI1CLKSOURCE_PLL3_Q: /* PLL3_Q is used as clock source for
                                           SAI1*/
         ...
         case RCC_SAI1CLKSOURCE_PLL3_R: /* PLL3_R is used as clock source for
                                           SAI1*/
   ...
   if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAI2) ==
      ...
      switch (PeriphClkInit->Sai2ClockSelection) {
         ...
         case RCC_SAI2CLKSOURCE_PLL3_Q: /* PLL3_Q is used as clock source for
                                           SAI2 */
         ...
         case RCC_SAI2CLKSOURCE_PLL3_R: /* PLL3_R is used as clock source for
                                           SAI2 */
   ...
   if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SPI1) ==
      ...
      switch (PeriphClkInit->Spi1ClockSelection) {
         ...
         case RCC_SPI1CLKSOURCE_PLL3_Q: /* PLL3_Q is used as clock source for
                                           SPI1*/
         ...
         case RCC_SPI1CLKSOURCE_PLL3_R: /* PLL3_R is used as clock source for
                                           SPI1 */
   ...
   if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SPI23) ==
      ...
      switch (PeriphClkInit->Spi23ClockSelection) {
         ...
         case RCC_SPI23CLKSOURCE_PLL3_Q: /* PLL3_Q is used as clock source for
                                            SPI23 */
         ...
         case RCC_SPI23CLKSOURCE_PLL3_R: /* PLL3_R is used as clock source for
                                            SPI23 */
   ...
   if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_USART2) ==
      ...
      switch (PeriphClkInit->Usart2ClockSelection) {
         case RCC_USART2CLKSOURCE_PLL3: /* PLL3 is used as clock source for
                                           USART2 */
         ...
         case RCC_USART2CLKSOURCE_PLL4: /* PLL4 is used as clock source for
                                           USART2 */
   ...
   if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_USART1) ==
      ...
      switch (PeriphClkInit->Usart1ClockSelection) {
         case RCC_USART1CLKSOURCE_PLL3: /* PLL3 is used as clock source for
                                           USART1 */
         ...
         case RCC_USART1CLKSOURCE_PLL4: /* PLL4 is used as clock source for
                                           USART1 */
   ...
   if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SDMMC1) ==
      ...
      switch (PeriphClkInit->Sdmmc1ClockSelection) {
         case RCC_SDMMC1CLKSOURCE_PLL3: /* PLL3 is used as clock source for
                                           SDMMC1 */
         ...
         case RCC_SDMMC1CLKSOURCE_PLL4: /* PLL4 is used as clock source for
                                           SDMMC1 */
   ...
   if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SDMMC2) ==
      ...
      switch (PeriphClkInit->Sdmmc2ClockSelection) {
         case RCC_SDMMC2CLKSOURCE_PLL3: /* PLL3 is used as clock source for
                                           SDMMC2 */
         ...
         case RCC_SDMMC2CLKSOURCE_PLL4: /* PLL4 is used as clock source for
                                           SDMMC2 */
   ...
   if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_FDCAN) ==
      ...
      switch (PeriphClkInit->FdcanClockSelection) {
         ...
         case RCC_FDCANCLKSOURCE_PLL4_Q: /* PLL4_Q is used as clock source for
                                            FDCAN */
         ...
         case RCC_FDCANCLKSOURCE_PLL4_R: /* PLL4_R is used as clock source for
                                            FDCAN */
   ...
   if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SPDIFRX) ==
      ...
      switch (PeriphClkInit->SpdifrxClockSelection) {
         case RCC_SPDIFRXCLKSOURCE_PLL4: /* PLL4 is used as clock source for
                                            SPDIF */
         ...
         case RCC_SPDIFRXCLKSOURCE_PLL3: /* PLL3 is used as clock source for
                                            SPDIF */
   ...
   if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_DCMIPP) ==
      ...
      switch (PeriphClkInit->DcmippClockSelection) {
         case RCC_DCMIPPCLKSOURCE_PLL2: /* PLL2 is used as clock source for
                                           DCMIPP */
         ...
         case RCC_DCMIPPCLKSOURCE_PLL4: /* PLL4 is used as clock source for
                                           DCMIPP */
   ...
   if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_LPTIM45) ==
      ...
      switch (PeriphClkInit->Lptim45ClockSelection) {
         case RCC_LPTIM45CLKSOURCE_PLL3: /* PLL3 is used as clock source for
                                            LPTIM45 */
         ...
         case RCC_LPTIM45CLKSOURCE_PLL4: /* PLL4 is used as clock source for
                                            LPTIM45 */
   ...
   if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_LPTIM1) ==
      ...
      switch (PeriphClkInit->Lptim1ClockSelection) {
         case RCC_LPTIM1CLKSOURCE_PLL3: /* PLL3 is used as clock source for
                                           LPTIM1 */
         ...
         case RCC_LPTIM1CLKSOURCE_PLL4: /* PLL4 is used as clock source for
                                           LPTIM1 */
 ...
 *         USART1, USART2, UART35, UART4, USART6, UART78, LPTIM1, LPTIM2,
 * LPTIM3, LPTIM45, SAI1, SAI2, FDCAN, SPDIFRX, ADC1, ADC2, SDMMC1, SDMMC2,
 * ETH1, ETH2, USBPHY, USBO, QSPI, FMC, RNG1, STGEN, DCMIPP, SAES, TIMG1, TIMG2,
 * TIMG3, RTC and CKPER
 * @retval None
 */
 ...
 *         PWR control register 1 (PWR_CR1) has to be set before it can be
 * written.
...
uint32_t HAL_RCCEx_GetPeriphCLKFreq(uint64_t PeriphClk)
{
   ...
   assert_param(IS_RCC_PERIPHCLOCK(PeriphClk) ||
                IS_RCC_PERIPHONECLOCK(PeriphClk));
   ...
   switch (PeriphClk) {
      ...
      case RCC_PERIPHCLK_I2C12: {
         ...
         switch (clksource) {
            ...
            case RCC_I2C12CLKSOURCE_CSI: frequency = CSI_VALUE; break;
      ...
      case RCC_PERIPHCLK_I2C3: {
         ...
         switch (clksource) {
            ...
            case RCC_I2C3CLKSOURCE_CSI: frequency = CSI_VALUE; break;

            default: frequency = 0U; break;
         }
      ...
      case RCC_PERIPHCLK_I2C4: {
         ...
         switch (clksource) {
            ...
            case RCC_I2C4CLKSOURCE_CSI: frequency = CSI_VALUE; break;
      ...
      case RCC_PERIPHCLK_I2C5: {
         ...
         switch (clksource) {
            ...
            case RCC_I2C5CLKSOURCE_CSI: frequency = CSI_VALUE; break;
      ...
      case RCC_PERIPHCLK_LPTIM1: {
         ...
         switch (clksource) {
            ...
            case RCC_LPTIM1CLKSOURCE_LSE: frequency = LSE_VALUE; break;

            case RCC_LPTIM1CLKSOURCE_LSI: frequency = LSI_VALUE; break;

            case RCC_LPTIM1CLKSOURCE_PER: frequency = RCC_GetCKPERFreq(); break;
      ...
      case RCC_PERIPHCLK_SPI23: {
         ...
         switch (clksource) {
            ...
            case RCC_SPI23CLKSOURCE_PER: frequency = RCC_GetCKPERFreq(); break;
      ...
      case RCC_PERIPHCLK_USART2: {
         ...
         switch (clksource) {
            ...
            case RCC_USART2CLKSOURCE_CSI: frequency = CSI_VALUE; break;
            ...
            case RCC_USART2CLKSOURCE_HSE: frequency = HSE_VALUE; break;
      ...
      case RCC_PERIPHCLK_UART4: {
         ...
         switch (clksource) {
            ...
            case RCC_UART4CLKSOURCE_CSI: frequency = CSI_VALUE; break;

            case RCC_UART4CLKSOURCE_HSE: frequency = HSE_VALUE; break;
      ...
      case RCC_PERIPHCLK_UART35: {
         ...
         switch (clksource) {
            ...
            case RCC_UART35CLKSOURCE_CSI: frequency = CSI_VALUE; break;

            case RCC_UART35CLKSOURCE_HSE: frequency = HSE_VALUE; break;
      ...
      case RCC_PERIPHCLK_UART78: {
         ...
         switch (clksource) {
            ...
            case RCC_UART78CLKSOURCE_CSI: frequency = CSI_VALUE; break;

            case RCC_UART78CLKSOURCE_HSE: frequency = HSE_VALUE; break;
      ...
      case RCC_PERIPHCLK_FDCAN: {
         ...
         switch (clksource) {
            case RCC_FDCANCLKSOURCE_HSE: frequency = HSE_VALUE; break;
      ...
      case RCC_PERIPHCLK_SAI1: {
         ...
         switch (clksource) {
            ...
            case RCC_SAI1CLKSOURCE_PER: frequency = RCC_GetCKPERFreq(); break;
      ...
      case RCC_PERIPHCLK_SAI2: {
         ...
         switch (clksource) {
            ...
            case RCC_SAI2CLKSOURCE_PER: frequency = RCC_GetCKPERFreq(); break;
      ...
      case RCC_PERIPHCLK_SPI1: {
         ...
         switch (clksource) {
            ...
            case RCC_SPI1CLKSOURCE_PER: frequency = RCC_GetCKPERFreq(); break;
      ...
      case RCC_PERIPHCLK_SPI4: {
         ...
         switch (clksource) {
            ...
            case RCC_SPI4CLKSOURCE_CSI: frequency = CSI_VALUE; break;

            case RCC_SPI4CLKSOURCE_HSE: frequency = HSE_VALUE; break;
      ...
      case RCC_PERIPHCLK_SPI5: {
         ...
         switch (clksource) {
            ...
            case RCC_SPI5CLKSOURCE_CSI: frequency = CSI_VALUE; break;

            case RCC_SPI5CLKSOURCE_HSE: frequency = HSE_VALUE; break;
      ...
      case RCC_PERIPHCLK_USART6: {
         ...
         switch (clksource) {
            ...
            case RCC_USART6CLKSOURCE_CSI: frequency = CSI_VALUE; break;

            case RCC_USART6CLKSOURCE_HSE: frequency = HSE_VALUE; break;
      ...
      case RCC_PERIPHCLK_LPTIM2: {
         ...
         switch (clksource) {
            ...
            case RCC_LPTIM2CLKSOURCE_PER: frequency = RCC_GetCKPERFreq(); break;

            case RCC_LPTIM2CLKSOURCE_LSE: frequency = LSE_VALUE; break;

            case RCC_LPTIM2CLKSOURCE_LSI: frequency = LSI_VALUE; break;
      ...
      case RCC_PERIPHCLK_LPTIM3: {
         ...
         switch (clksource) {
            ...
            case RCC_LPTIM3CLKSOURCE_PER: frequency = RCC_GetCKPERFreq(); break;

            case RCC_LPTIM3CLKSOURCE_LSE: frequency = LSE_VALUE; break;

            case RCC_LPTIM3CLKSOURCE_LSI: frequency = LSI_VALUE; break;
      ...
      case RCC_PERIPHCLK_LPTIM45: {
         ...
         switch (clksource) {
            ...
            case RCC_LPTIM45CLKSOURCE_LSE: frequency = LSE_VALUE; break;

            case RCC_LPTIM45CLKSOURCE_LSI: frequency = LSI_VALUE; break;
      ...
      case RCC_PERIPHCLK_USBPHY: {
         ...
         switch (clksource) {
            case RCC_USBPHYCLKSOURCE_HSE: frequency = HSE_VALUE; break;
            ...
            case RCC_USBPHYCLKSOURCE_HSE2: frequency = (HSE_VALUE / 2U); break;
      ...
      case RCC_PERIPHCLK_RTC: {
         ...
         switch (clksource) {
            case RCC_RTCCLKSOURCE_OFF: frequency = 0U; break;

            case RCC_RTCCLKSOURCE_LSE: frequency = LSE_VALUE; break;

            case RCC_RTCCLKSOURCE_LSI: frequency = LSI_VALUE; break;
      ...
      case RCC_PERIPHCLK_USART1: {
         ...
         switch (clksource) {
            ...
            case RCC_USART1CLKSOURCE_CSI: frequency = CSI_VALUE; break;
            ...
            case RCC_USART1CLKSOURCE_HSE: frequency = HSE_VALUE; break;
      ...
      case RCC_PERIPHCLK_STGEN: {
         ...
         switch (clksource) {
            ...
            case RCC_STGENCLKSOURCE_HSE: frequency = HSE_VALUE; break;
      ...
      case RCC_PERIPHCLK_DCMIPP: {
         ...
         switch (clksource) {
            ...
            case RCC_DCMIPPCLKSOURCE_PER: frequency = RCC_GetCKPERFreq(); break;
      ...
      case RCC_PERIPHCLK_SAES: {
         ...
         switch (clksource) {
            ...
            case RCC_SAESCLKSOURCE_PER: frequency = RCC_GetCKPERFreq(); break;
            ...
            case RCC_SAESCLKSOURCE_LSI: frequency = LSI_VALUE; break;
      ...
      case RCC_PERIPHCLK_QSPI: {
         ...
         switch (clksource) {
            ...
            case RCC_QSPICLKSOURCE_PER: frequency = RCC_GetCKPERFreq(); break;
      ...
      case RCC_PERIPHCLK_FMC: {
         ...
         switch (clksource) {
            ...
            case RCC_FMCCLKSOURCE_PER: frequency = RCC_GetCKPERFreq(); break;
      ...
      case RCC_PERIPHCLK_USBO: {
         ...
         switch (clksource) {
            ...
            case RCC_USBOCLKSOURCE_PHY: frequency = USB_PHY_VALUE; break;
      ...
      case RCC_PERIPHCLK_ADC1: {
         ...
         switch (clksource) {
            ...
            case RCC_ADC1CLKSOURCE_PER: frequency = RCC_GetCKPERFreq(); break;
      ...
      case RCC_PERIPHCLK_ADC2: {
         ...
         switch (clksource) {
            ...
            case RCC_ADC2CLKSOURCE_PER: frequency = RCC_GetCKPERFreq(); break;
      ...
      case RCC_PERIPHCLK_RNG1: {
         ...
         switch (clksource) {
            case RCC_RNG1CLKSOURCE_CSI: frequency = CSI_VALUE; break;
            ...
            case RCC_RNG1CLKSOURCE_LSI: frequency = LSI_VALUE; break;
      ...
      case RCC_PERIPHCLK_TIMG1: {
         ...
         if (__HAL_RCC_GET_TIMG1PRES() == RCC_TIMG1PRES_ACTIVATED) {
            switch (__HAL_RCC_GET_APB1_DIV()) {
               case RCC_APB1_DIV1:
               case RCC_APB1_DIV2:
               case RCC_APB1_DIV4: break;
               case RCC_APB1_DIV8: frequency /= 2U; break;
               case RCC_APB1_DIV16: frequency /= 4U; break;
               default: break;
            }
         } else {
            switch (__HAL_RCC_GET_APB1_DIV()) {
               case RCC_APB1_DIV1:
               case RCC_APB1_DIV2: break;
               case RCC_APB1_DIV4: frequency /= 2U; break;
               case RCC_APB1_DIV8: frequency /= 4U; break;
               case RCC_APB1_DIV16: frequency /= 8U; break;
               default: break;
            }
         }
         break;
      ...
      case RCC_PERIPHCLK_TIMG2: {
         ...
         if (__HAL_RCC_GET_TIMG2PRES() == RCC_TIMG2PRES_ACTIVATED) {
            switch (__HAL_RCC_GET_APB2_DIV()) {
               case RCC_APB2_DIV1:
               case RCC_APB2_DIV2:
               case RCC_APB2_DIV4: break;
               case RCC_APB2_DIV8: frequency /= 2U; break;
               case RCC_APB2_DIV16: frequency /= 4U; break;
               default: break;
            }
         } else {
            switch (__HAL_RCC_GET_APB2_DIV()) {
               case RCC_APB2_DIV1:
               case RCC_APB2_DIV2: break;
               case RCC_APB2_DIV4: frequency /= 2U; break;
               case RCC_APB2_DIV8: frequency /= 4U; break;
               case RCC_APB2_DIV16: frequency /= 8U; break;
               default: break;
            }
         }
         break;
      ...
      case RCC_PERIPHCLK_TIMG3: {
         ...
         if (__HAL_RCC_GET_TIMG3PRES() == RCC_TIMG3PRES_ACTIVATED) {
            switch (__HAL_RCC_GET_APB6_DIV()) {
               case RCC_APB6_DIV1:
               case RCC_APB6_DIV2:
               case RCC_APB6_DIV4: break;
               case RCC_APB6_DIV8: frequency /= 2U; break;
               case RCC_APB6_DIV16: frequency /= 4U; break;
               default: break;
            }
         } else {
            switch (__HAL_RCC_GET_APB6_DIV()) {
               case RCC_APB6_DIV1:
               case RCC_APB6_DIV2: break;
               case RCC_APB6_DIV4: frequency /= 2U; break;
               case RCC_APB6_DIV8: frequency /= 4U; break;
               case RCC_APB6_DIV16: frequency /= 8U; break;
               default: break;
            }
         }
         break;
