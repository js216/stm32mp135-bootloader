...
typedef struct {
   uint32_t Request; /*!< Specifies the request selected for the specified
                        stream. This parameter can be a value of @ref
   ...
   uint32_t Direction; /*!< Specifies if the data will be transferred from
                          ...
                          peripheral to memory. This parameter can be a value of
   ...
   uint32_t PeriphBurst; /*!< Specifies the Burst transfer configuration for the
                            peripheral transfers. It specifies the amount of
                            data to be transferred in a single non interruptible
...
#define DMA_PERIPH_TO_MEMORY                                                   \
   ((uint32_t)0x00000000U) /*!< Peripheral to memory direction */
...
#define DMA_PINC_DISABLE                                                       \
   ((uint32_t)0x00000000U) /*!< Peripheral increment mode disable */
/**
 * @}
 */
...
#define DMA_MINC_DISABLE                                                       \
   ((uint32_t)0x00000000U) /*!< Memory increment mode disable */
/**
 * @}
 */
...
#define DMA_PDATAALIGN_BYTE                                                    \
   ((uint32_t)0x00000000U) /*!< Peripheral data alignment: Byte     */
...
#define DMA_MDATAALIGN_BYTE                                                    \
   ((uint32_t)0x00000000U) /*!< Memory data alignment: Byte     */
...
#define DMA_PRIORITY_LOW                                                       \
   ((uint32_t)0x00000000U) /*!< Priority level: Low       */
