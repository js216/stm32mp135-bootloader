...
typedef struct {
   ...
   FunctionalState VLANTagHashTableMatch; /*!< Enable or Disable VLAN Tag Hash
                                             Table Match */
