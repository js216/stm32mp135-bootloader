...
typedef struct {
   uint32_t
       Pin; /*!< Specifies the GPIO pins to be configured.
 ...
 * @{
 */
#define GPIO_PIN_0   ((uint32_t)0x0001U) /* Pin 0 selected    */
#define GPIO_PIN_1   ((uint32_t)0x0002U) /* Pin 1 selected    */
#define GPIO_PIN_2   ((uint32_t)0x0004U) /* Pin 2 selected    */
#define GPIO_PIN_3   ((uint32_t)0x0008U) /* Pin 3 selected    */
#define GPIO_PIN_4   ((uint32_t)0x0010U) /* Pin 4 selected    */
#define GPIO_PIN_5   ((uint32_t)0x0020U) /* Pin 5 selected    */
#define GPIO_PIN_6   ((uint32_t)0x0040U) /* Pin 6 selected    */
#define GPIO_PIN_7   ((uint32_t)0x0080U) /* Pin 7 selected    */
#define GPIO_PIN_8   ((uint32_t)0x0100U) /* Pin 8 selected    */
#define GPIO_PIN_9   ((uint32_t)0x0200U) /* Pin 9 selected    */
#define GPIO_PIN_10  ((uint32_t)0x0400U) /* Pin 10 selected   */
#define GPIO_PIN_11  ((uint32_t)0x0800U) /* Pin 11 selected   */
#define GPIO_PIN_12  ((uint32_t)0x1000U) /* Pin 12 selected   */
#define GPIO_PIN_13  ((uint32_t)0x2000U) /* Pin 13 selected   */
#define GPIO_PIN_14  ((uint32_t)0x4000U) /* Pin 14 selected   */
#define GPIO_PIN_15  ((uint32_t)0x8000U) /* Pin 15 selected   */
#define GPIO_PIN_ALL ((uint32_t)0xFFFFU) /* All pins selected */
...
#define GPIO_MODE_EVT_RISING                                                   \
   (MODE_INPUT | EXTI_EVT |                                                    \
    TRIGGER_RISING) /*!< External Event Mode with Rising edge trigger          \
                       detection             */
...
/**
  * @brief  Checks whether the specified EXTI line is asserted or not for Rising
  edge.
...
/**
  * @brief  Checks whether the specified EXTI line is asserted or not for
  Falling edge.
