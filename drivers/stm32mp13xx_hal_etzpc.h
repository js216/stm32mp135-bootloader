...
#define ETZPC_CHECK_PROTECTION(p)                                              \
   assert(p == LL_ETZPC_PERIPH_PROTECTION_READ_WRITE_SECURE ||                 \
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_SetSecureSysRamSize(ETZPC_TypeDef *ETZPCx,
                                                   uint32_t size)
{
   assert(size <= 0x3FFU);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_All_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                        uint32_t protection)
{
...
HAL_ETZPC_Set_VREFBUF_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                       uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Set_LPTIM2_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                      uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Set_LPTIM3_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                      uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_LTDC_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                         uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Set_DCMIPP_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                      uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Set_USBPHYC_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                       uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Set_DDRCTRL_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                       uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_IWDG1_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                          uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Set_STGENC_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                      uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Set_USART1_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                      uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Set_USART2_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                      uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_SPI4_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                         uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_SPI5_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                         uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_I2C3_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                         uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_I2C4_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                         uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_I2C5_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                         uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_TIM12_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                          uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_TIM13_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                          uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_TIM14_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                          uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_TIM15_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                          uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_TIM16_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                          uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_TIM17_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                          uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_ADC1_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                         uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_ADC2_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                         uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_OTG_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                        uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_RNG_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                        uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_HASH_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                         uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_CRYP_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                         uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_SAES_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                         uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_PKA_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                        uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Set_BKPSRAM_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                       uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_ETH1_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                         uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_ETH2_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                         uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Set_SDMMC1_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                      uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Set_SDMMC2_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                      uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Set_DDRMCE_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                      uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_FMC_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                        uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_QSPI_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                         uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_SRAM1_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                          uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_SRAM2_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                          uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 * @retval None
 */
__STATIC_INLINE void HAL_ETZPC_Set_SRAM3_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                          uint32_t protection)
{
   ETZPC_CHECK_PROTECTION(protection);
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Lock_VREFBUF_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Lock_LPTIM2_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Lock_LPTIM3_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Lock_DCMIPP_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Lock_USBPHYC_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Lock_DDRCTRL_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Lock_IWDG1_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Lock_STGENC_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Lock_USART1_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Lock_USART2_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Lock_TIM12_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Lock_TIM13_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Lock_TIM14_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Lock_TIM15_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Lock_TIM16_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Lock_TIM17_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Lock_BKPSRAM_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Lock_SDMMC1_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Lock_SDMMC2_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Lock_DDRMCE_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Lock_SRAM1_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Lock_SRAM2_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
HAL_ETZPC_Lock_SRAM3_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
