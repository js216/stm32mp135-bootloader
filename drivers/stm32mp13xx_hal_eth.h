...
typedef struct {
   ...
   uint32_t PayloadLen; /*!< Sets Total payload length only when TCP
                           segmentation is enabled. This parameter can be a
                           value from 0x0 to 0x3FFFF */

   uint32_t TCPHeaderLen; /*!< Sets TCP header length only when TCP segmentation
                             is enabled. This parameter can be a value from 0x5
                             to 0xF */

   uint32_t VlanTag; /*!< Sets VLAN Tag only when VLAN is enabled.
                          This parameter can be a value from 0x0 to 0xFFFF*/

   uint32_t VlanCtrl; /*!< Specifies VLAN Tag insertion control only when VLAN
                         is enabled. This parameter can be a value of @ref
   ...
   uint32_t
       InnerVlanCtrl; /*!< Specifies Inner VLAN Tag insertion control only when
...
typedef struct {
   ...
   FunctionalState CRCStripTypePacket; /*!< Enables or disables the CRC
                                          stripping for Type packets.*/
   ...
   FunctionalState PortSelect; /*!< Sets the Port Select
                                           When disabled, the line speed is for
                                  1000Mbps operations When enabled, it is for 10
                                  or 100Mbps operations*/

   uint32_t Speed; /*!< Sets the Ethernet speed: 10/100 Mbps.
                              This parameter can be a value of @ref ETH_Speed */

   uint32_t DuplexMode; /*!< Selects the MAC duplex mode: Half-Duplex or
                           Full-Duplex mode This parameter can be a value of
                           @ref ETH_Duplex_Mode */
   ...
   FunctionalState
       CarrierSenseDuringTransmit; /*!< Enables or disables the Carrier Sense
                                      During Transmission in the Half Duplex
                                      mode */
   ...
   FunctionalState CRCCheckingRxPackets; /*!< Enable or disables the CRC
   ...
   uint32_t ExtendedInterPacketGapVal; /*!< Sets the Extended IPG between Packet
                                          during transmission. This parameter
                                          can be a value from 0x0 to 0xFF */

   FunctionalState ProgrammableWatchdog; /*!< Enable or disables the
   ...
   uint32_t
       PauseTime; /*!< This field holds the value to be used in the Pause Time
                     ...
                     be a number between Min_Data = 0x0 and Max_Data = 0xFFFF.*/
   ...
   FunctionalState
       UnicastPausePacketDetect; /*!< Enables or disables the MAC to detect
                                    Pause packets with unicast address of the
                                    station */
...
typedef struct {
   ...
   uint32_t BurstMode;  /*!< Sets the AHB Master interface burst transfers.
                                  This parameter can be a value of @ref
                           ETH_Burst_Mode */
   uint32_t RxOSRLimit; /*!< Sets the maximum outstanding request on the AXI
                           read interface. */

   uint32_t TxOSRLimit; /*!< Sets the maximum outstanding request on the AXI
                           write interface. */

   FunctionalState
       PBLx8Mode; /*!< Enables or disables the PBL multiplication by eight. */

   uint32_t TxDMABurstLength; /*!< Indicates the maximum number of beats to be
                                 transferred in one Tx DMA transaction. This
                                 parameter can be a value of @ref
                                 ETH_Tx_DMA_Burst_Length */

   FunctionalState SecondPacketOperate; /*!< Enables or disables the Operate on
                                           second Packet mode, which allows the
                                           DMA to process a second Packet of
                                           Transmit data even before obtaining
                                           the status for the first one. */

   uint32_t RxDMABurstLength; /*!< Indicates the maximum number of beats to be
                                 transferred in one Rx DMA transaction. This
                                 parameter can be a value of @ref
                                 ETH_Rx_DMA_Burst_Length */

   FunctionalState
       FlushRxPacket; /*!< Enables or disables the Rx Packet Flush */

   FunctionalState
       TCPSegmentation; /*!< Enables or disables the TCP Segmentation */

   uint32_t
       MaximumSegmentSize; /*!< Sets the maximum segment size that should be
                              used while segmenting the packet This parameter
                              can be a value from 0x40 to 0x3FFF */

   uint32_t AXIBLENMaxSize; /*!< Sets the maximum BLEN max size that should be
                               used on th AXI interface to initiate burst
                               transfers of specified lengths */
 ...
 */
typedef enum {
   HAL_ETH1_REF_CLK_RCC =
       0x00U, /*!<  ETH1 reference clock (RMII mode) comes from the RCC */
   HAL_ETH1_REF_CLK_RX_CLK_PIN =
       0x01U, /*!<  ETH1 reference clock (RMII mode) comes from the
                 ETH2_RX_CLK/ETH2_REF_CLK pin */
   HAL_ETH2_REF_CLK_RCC =
       0x02U, /*!<  ETH2 reference clock (RMII mode) comes from the RCC */
   HAL_ETH2_REF_CLK_RX_CLK_PIN =
       0x03U, /*!<  ETH2 reference clock (RMII mode) comes from the
                 ETH2_RX_CLK/ETH2_REF_CLK pin */
} ETH_ClkSrcTypeDef;
...
typedef struct {
   ...
   ETH_ClkSrcTypeDef
       ClockSelection; /*!< Selects the Clock Source for RMII interface */
...
typedef struct {
   ...
   uint32_t TimestampIPv6;  /*!< Enable Processing of PTP Packets Sent over
                               IPv6-UDP */
   uint32_t TimestampIPv4;  /*!< Enable Processing of PTP Packets Sent over
                               IPv4-UDP */
   uint32_t TimestampEvent; /*!< Enable Timestamp Snapshot for Event Messages */
   uint32_t
       TimestampMaster; /*!< Enable Timestamp Snapshot for Event Messages */
...
typedef struct __ETH_HandleTypeDef {
   ...
   __IO uint32_t
       DMAErrorCode; /*!< Holds the DMA Rx Tx Error code when a DMA AIS
                        interrupt occurs This parameter can be a combination of
                                                     @ref ETH_DMA_Status_Flags
                      */

   __IO uint32_t MACErrorCode; /*!< Holds the MAC Rx Tx Error code when a MAC Rx
                                  or Tx status interrupt occurs This parameter
                                  can be a combination of
                                                               @ref
                                  ETH_MAC_Rx_Tx_Status */
   ...
   void (*rxAllocateCallback)(
       struct __ETH_HandleTypeDef *heth,
       uint8_t **buffer); /*!< ETH Rx Get Buffer Function   */
   void (*rxLinkCallback)(struct __ETH_HandleTypeDef *heth, void **pStart,
                          void **pEnd, uint8_t *buff,
                          uint16_t Length); /*!< ETH Rx Set App Data Function */
   void (*txFreeCallback)(struct __ETH_HandleTypeDef *heth,
                          uint32_t *buffer); /*!< ETH Tx Free Function */
   void (*txPtpCallback)(
       struct __ETH_HandleTypeDef *heth, uint32_t *buffer,
       ETH_TimeStampTypeDef *timestamp); /*!< ETH Tx Handle Ptp Function */
...
typedef void (*pETH_rxLinkCallbackTypeDef)(
    struct __ETH_HandleTypeDef *heth, void **pStart, void **pEnd, uint8_t *buff,
...
typedef struct {
   ...
   FunctionalState SrcAddrInverseFiltering; /*!< Enable or Disable source
...
#define ETH_SOURCEADDRESS_REPLACE_ADDR1                                        \
   (ETH_MACCR_SARC_2 | ETH_MACCR_SARC_1 | ETH_MACCR_SARC_0)
/**
 * @}
 */
...
#define HAL_ETH_STATE_BUSY                                                     \
   0x00000023U /*!< an internal process is ongoing             */
#define HAL_ETH_STATE_STARTED                                                  \
   0x00000023U /*!< an internal process is started             */
...
#define __HAL_ETH_DMA_ENABLE_IT(__HANDLE__, __INTERRUPT__)                     \
   ((__HANDLE__)->Instance->DMAC0IER |= (__INTERRUPT__))
...
#define __HAL_ETH_DMA_CLEAR_IT(__HANDLE__, __INTERRUPT__)                      \
   ((__HANDLE__)->Instance->DMAC0SR = (__INTERRUPT__))
...
#define __HAL_ETH_DMA_GET_FLAG(__HANDLE__, __FLAG__)                           \
   (((__HANDLE__)->Instance->DMAC0SR & (__FLAG__)) == (__FLAG__))
...
#define __HAL_ETH_DMA_CLEAR_FLAG(__HANDLE__, __FLAG__)                         \
   ((__HANDLE__)->Instance->DMAC0SR = (__FLAG__))
...
#define ETH_WAKEUP_EXTI_LINE                                                   \
   0x00000040U /* !<  IM70 in EXTI IMR3 register is bit 6 */
...
void HAL_ETH_TxPtpCallback(ETH_HandleTypeDef *heth, uint32_t *buff,
                           ETH_TimeStampTypeDef *timestamp);
/**
 * @}
 */
