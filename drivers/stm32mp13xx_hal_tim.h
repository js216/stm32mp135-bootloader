...
typedef struct {
   ...
   uint32_t
       OffStateIDLEMode; /*!< TIM off state in IDLE mode, This parameter can be
                            a value of @ref
   ...
   uint32_t
       BreakFilter; /*!< Specifies the break input filter.This parameter can be
...
#define TIM_TRGO2_OC5REF_RISING_OC6REF_RISING                                  \
   (TIM_CR2_MMS2_3 | TIM_CR2_MMS2_2 |                                          \
    TIM_CR2_MMS2_1) /*!< OC5REF or OC6REF rising edges generate pulses on      \
                       TRGO2         */
...
#define TIM_BREAK_SYSTEM_PVD                                                   \
   SYSCFG_CBR_PVDL /*!< Enables and locks the PVD connection with              \
                      TIM1/8/15/16/17 Break Input and also the PVDE and PLS    \
                      bits of the Power Control Interface */
#define TIM_BREAK_SYSTEM_LOCKUP                                                \
   SYSCFG_CBR_CLL /*!< Enables and locks the LOCKUP output of CortexM4 with    \
