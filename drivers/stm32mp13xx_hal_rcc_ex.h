...
#define RCC_SPI4CLKSOURCE_CSI                                                  \
   (RCC_SPI45CKSELR_SPI4SRC_1 | RCC_SPI45CKSELR_SPI4SRC_0)
#define RCC_SPI4CLKSOURCE_HSE RCC_SPI45CKSELR_SPI4SRC_2
#define RCC_SPI4CLKSOURCE_I2SCKIN                                              \
   (RCC_SPI45CKSELR_SPI4SRC_2 | RCC_SPI45CKSELR_SPI4SRC_0)
...
#define RCC_USART1CLKSOURCE_CSI                                                \
...
#define RCC_UART35CLKSOURCE_CSI                                                \
...
#define RCC_USART6CLKSOURCE_CSI                                                \
...
#define RCC_UART78CLKSOURCE_CSI                                                \
...
#define RCC_SDMMC1CLKSOURCE_HSI                                                \
   (RCC_SDMMC12CKSELR_SDMMC1SRC_1 | RCC_SDMMC12CKSELR_SDMMC1SRC_0)
...
#define RCC_SDMMC2CLKSOURCE_HSI                                                \
   (RCC_SDMMC12CKSELR_SDMMC2SRC_1 | RCC_SDMMC12CKSELR_SDMMC2SRC_0)
...
#define IS_RCC_ETH1CLKSOURCE(SOURCE)                                           \
   (((SOURCE) == RCC_ETH1CLKSOURCE_PLL4) ||                                    \
...
#define IS_RCC_ETH2CLKSOURCE(SOURCE)                                           \
   (((SOURCE) == RCC_ETH2CLKSOURCE_PLL4) ||                                    \
...
/** @defgroup RCCEx_ETH1_PrecisionTimeProtocol_Divider ETH1
 * PrecisionTimeProtocol Divider
 * @{
 */
...
#define RCC_ETH1PTPDIV_4                                                       \
   (RCC_ETH12CKSELR_ETH1PTPDIV_1 |                                             \
    RCC_ETH12CKSELR_ETH1PTPDIV_0)                     /*Division by 4*/
#define RCC_ETH1PTPDIV_5 RCC_ETH12CKSELR_ETH1PTPDIV_2 /*Division by 5*/
#define RCC_ETH1PTPDIV_6                                                       \
   (RCC_ETH12CKSELR_ETH1PTPDIV_2 |                                             \
    RCC_ETH12CKSELR_ETH1PTPDIV_0) /*Division by 6*/
#define RCC_ETH1PTPDIV_7                                                       \
   (RCC_ETH12CKSELR_ETH1PTPDIV_2 |                                             \
    RCC_ETH12CKSELR_ETH1PTPDIV_1) /*Division by 7*/
#define RCC_ETH1PTPDIV_8                                                       \
   (RCC_ETH12CKSELR_ETH1PTPDIV_2 | RCC_ETH12CKSELR_ETH1PTPDIV_1 |              \
    RCC_ETH12CKSELR_ETH1PTPDIV_0)                     /*Division by 8*/
#define RCC_ETH1PTPDIV_9 RCC_ETH12CKSELR_ETH1PTPDIV_3 /*Division by 9*/
#define RCC_ETH1PTPDIV_10                                                      \
   (RCC_ETH12CKSELR_ETH1PTPDIV_3 |                                             \
    RCC_ETH12CKSELR_ETH1PTPDIV_0) /*Division by 10*/
#define RCC_ETH1PTPDIV_11                                                      \
   (RCC_ETH12CKSELR_ETH1PTPDIV_3 |                                             \
    RCC_ETH12CKSELR_ETH1PTPDIV_1) /*Division by 11*/
#define RCC_ETH1PTPDIV_12                                                      \
   (RCC_ETH12CKSELR_ETH1PTPDIV_3 | RCC_ETH12CKSELR_ETH1PTPDIV_1 |              \
    RCC_ETH12CKSELR_ETH1PTPDIV_0) /*Division by 12*/
#define RCC_ETH1PTPDIV_13                                                      \
   (RCC_ETH12CKSELR_ETH1PTPDIV_3 |                                             \
    RCC_ETH12CKSELR_ETH1PTPDIV_2) /*Division by 13*/
#define RCC_ETH1PTPDIV_14                                                      \
   (RCC_ETH12CKSELR_ETH1PTPDIV_3 | RCC_ETH12CKSELR_ETH1PTPDIV_2 |              \
    RCC_ETH12CKSELR_ETH1PTPDIV_0) /*Division by 14*/
#define RCC_ETH1PTPDIV_15                                                      \
   (RCC_ETH12CKSELR_ETH1PTPDIV_3 | RCC_ETH12CKSELR_ETH1PTPDIV_2 |              \
    RCC_ETH12CKSELR_ETH1PTPDIV_1) /*Division by 15*/
#define RCC_ETH1PTPDIV_16                                                      \
   (RCC_ETH12CKSELR_ETH1PTPDIV_3 | RCC_ETH12CKSELR_ETH1PTPDIV_2 |              \
    RCC_ETH12CKSELR_ETH1PTPDIV_1 |                                             \
    RCC_ETH12CKSELR_ETH1PTPDIV_0) /*Division by 16*/

#define IS_RCC_ETH1PTPDIV(SOURCE)                                              \
   (((SOURCE) == RCC_ETH1PTPDIV_1) || ((SOURCE) == RCC_ETH1PTPDIV_2) ||        \
    ((SOURCE) == RCC_ETH1PTPDIV_3) || ((SOURCE) == RCC_ETH1PTPDIV_4) ||        \
    ((SOURCE) == RCC_ETH1PTPDIV_5) || ((SOURCE) == RCC_ETH1PTPDIV_6) ||        \
    ((SOURCE) == RCC_ETH1PTPDIV_7) || ((SOURCE) == RCC_ETH1PTPDIV_8) ||        \
    ((SOURCE) == RCC_ETH1PTPDIV_9) || ((SOURCE) == RCC_ETH1PTPDIV_10) ||       \
    ((SOURCE) == RCC_ETH1PTPDIV_11) || ((SOURCE) == RCC_ETH1PTPDIV_12) ||      \
    ((SOURCE) == RCC_ETH1PTPDIV_13) || ((SOURCE) == RCC_ETH1PTPDIV_14) ||      \
    ((SOURCE) == RCC_ETH1PTPDIV_15) || ((SOURCE) == RCC_ETH1PTPDIV_16))
/**
 * @}
 */

/** @defgroup RCCEx_ETH2_PrecisionTimeProtocol_Divider ETH2
 * PrecisionTimeProtocol Divider
 * @{
 */
...
#define RCC_ETH2PTPDIV_4                                                       \
   (RCC_ETH12CKSELR_ETH2PTPDIV_1 |                                             \
    RCC_ETH12CKSELR_ETH2PTPDIV_0)                     /*Division by 4*/
#define RCC_ETH2PTPDIV_5 RCC_ETH12CKSELR_ETH2PTPDIV_2 /*Division by 5*/
#define RCC_ETH2PTPDIV_6                                                       \
   (RCC_ETH12CKSELR_ETH2PTPDIV_2 |                                             \
    RCC_ETH12CKSELR_ETH2PTPDIV_0) /*Division by 6*/
#define RCC_ETH2PTPDIV_7                                                       \
   (RCC_ETH12CKSELR_ETH2PTPDIV_2 |                                             \
    RCC_ETH12CKSELR_ETH2PTPDIV_1) /*Division by 7*/
#define RCC_ETH2PTPDIV_8                                                       \
   (RCC_ETH12CKSELR_ETH2PTPDIV_2 | RCC_ETH12CKSELR_ETH2PTPDIV_1 |              \
    RCC_ETH12CKSELR_ETH2PTPDIV_0)                     /*Division by 8*/
#define RCC_ETH2PTPDIV_9 RCC_ETH12CKSELR_ETH2PTPDIV_3 /*Division by 9*/
#define RCC_ETH2PTPDIV_10                                                      \
   (RCC_ETH12CKSELR_ETH2PTPDIV_3 |                                             \
    RCC_ETH12CKSELR_ETH2PTPDIV_0) /*Division by 10*/
#define RCC_ETH2PTPDIV_11                                                      \
   (RCC_ETH12CKSELR_ETH2PTPDIV_3 |                                             \
    RCC_ETH12CKSELR_ETH2PTPDIV_1) /*Division by 11*/
#define RCC_ETH2PTPDIV_12                                                      \
   (RCC_ETH12CKSELR_ETH2PTPDIV_3 | RCC_ETH12CKSELR_ETH2PTPDIV_1 |              \
    RCC_ETH12CKSELR_ETH2PTPDIV_0) /*Division by 12*/
#define RCC_ETH2PTPDIV_13                                                      \
   (RCC_ETH12CKSELR_ETH2PTPDIV_3 |                                             \
    RCC_ETH12CKSELR_ETH2PTPDIV_2) /*Division by 13*/
#define RCC_ETH2PTPDIV_14                                                      \
   (RCC_ETH12CKSELR_ETH2PTPDIV_3 | RCC_ETH12CKSELR_ETH2PTPDIV_2 |              \
    RCC_ETH12CKSELR_ETH2PTPDIV_0) /*Division by 14*/
#define RCC_ETH2PTPDIV_15                                                      \
   (RCC_ETH12CKSELR_ETH2PTPDIV_3 | RCC_ETH12CKSELR_ETH2PTPDIV_2 |              \
    RCC_ETH12CKSELR_ETH2PTPDIV_1) /*Division by 15*/
#define RCC_ETH2PTPDIV_16                                                      \
   (RCC_ETH12CKSELR_ETH2PTPDIV_3 | RCC_ETH12CKSELR_ETH2PTPDIV_2 |              \
    RCC_ETH12CKSELR_ETH2PTPDIV_1 |                                             \
    RCC_ETH12CKSELR_ETH2PTPDIV_0) /*Division by 16*/

#define IS_RCC_ETH2PTPDIV(SOURCE)                                              \
   (((SOURCE) == RCC_ETH2PTPDIV_1) || ((SOURCE) == RCC_ETH2PTPDIV_2) ||        \
    ((SOURCE) == RCC_ETH2PTPDIV_3) || ((SOURCE) == RCC_ETH2PTPDIV_4) ||        \
    ((SOURCE) == RCC_ETH2PTPDIV_5) || ((SOURCE) == RCC_ETH2PTPDIV_6) ||        \
    ((SOURCE) == RCC_ETH2PTPDIV_7) || ((SOURCE) == RCC_ETH2PTPDIV_8) ||        \
    ((SOURCE) == RCC_ETH2PTPDIV_9) || ((SOURCE) == RCC_ETH2PTPDIV_10) ||       \
    ((SOURCE) == RCC_ETH2PTPDIV_11) || ((SOURCE) == RCC_ETH2PTPDIV_12) ||      \
    ((SOURCE) == RCC_ETH2PTPDIV_13) || ((SOURCE) == RCC_ETH2PTPDIV_14) ||      \
    ((SOURCE) == RCC_ETH2PTPDIV_15) || ((SOURCE) == RCC_ETH2PTPDIV_16))
/**
 * @}
 */
...
#define RCC_FDCANCLKSOURCE_PLL4_R                                              \
...
#define RCC_DCMIPPCLKSOURCE_PER                                                \
...
#define IS_RCC_ADC1CLKSOURCE(SOURCE)                                           \
   (((SOURCE) == RCC_ADC1CLKSOURCE_PLL4) ||                                    \
...
#define IS_RCC_ADC2CLKSOURCE(SOURCE)                                           \
   (((SOURCE) == RCC_ADC2CLKSOURCE_PLL4) ||                                    \
...
#define RCC_LPTIM1CLKSOURCE_PER                                                \
   (RCC_LPTIM1CKSELR_LPTIM1SRC_2 | RCC_LPTIM1CKSELR_LPTIM1SRC_0)
#define RCC_LPTIM1CLKSOURCE_OFF                                                \
...
#define RCC_LPTIM23CLKSOURCE_OFF                                               \
...
#define RCC_LPTIM2CLKSOURCE_OFF                                                \
...
#define RCC_LPTIM3CLKSOURCE_OFF                                                \
...
#define RCC_LPTIM45CLKSOURCE_LSE                                               \
...
#define RCC_LPTIM45CLKSOURCE_PER                                               \
   (RCC_LPTIM45CKSELR_LPTIM45SRC_2 | RCC_LPTIM45CKSELR_LPTIM45SRC_0)
#define RCC_LPTIM45CLKSOURCE_OFF                                               \
...
#define IS_RCC_TIMG1PRES(PRES)                                                 \
   (((PRES) == RCC_TIMG1PRES_DEACTIVATED) ||                                   \
...
#define IS_RCC_TIMG2PRES(PRES)                                                 \
   (((PRES) == RCC_TIMG2PRES_DEACTIVATED) ||                                   \
...
#define IS_RCC_TIMG3PRES(PRES)                                                 \
   (((PRES) == RCC_TIMG3PRES_DEACTIVATED) ||                                   \
...
#define __HAL_RCC_I2C12_CONFIG(__I2C12CLKSource__)                             \
   MODIFY_REG(RCC->I2C12CKSELR, RCC_I2C12CKSELR_I2C12SRC,                      \
              (uint32_t)(__I2C12CLKSource__))
...
#define __HAL_RCC_I2C35_CONFIG(__I2C35CLKSource__)                             \
   MODIFY_REG(RCC->I2C35CKSELR, RCC_I2C35CKSELR_I2C35SRC,                      \
              (uint32_t)(__I2C35CLKSource__))
...
#define __HAL_RCC_I2C46_CONFIG(__I2C46CLKSource__)                             \
   MODIFY_REG(RCC->I2C46CKSELR, RCC_I2C46CKSELR_I2C46SRC,                      \
              (uint32_t)(__I2C46CLKSource__))
...
#define __HAL_RCC_I2C3_CONFIG(__I2C3CLKSource__)                               \
   MODIFY_REG(RCC->I2C345CKSELR, RCC_I2C345CKSELR_I2C3SRC,                     \
...
#define __HAL_RCC_GET_I2C3_SOURCE()                                            \
   ((uint32_t)(READ_BIT(RCC->I2C345CKSELR, RCC_I2C345CKSELR_I2C3SRC)))
...
#define __HAL_RCC_I2C4_CONFIG(__I2C4CLKSource__)                               \
   MODIFY_REG(RCC->I2C345CKSELR, RCC_I2C345CKSELR_I2C4SRC,                     \
              (uint32_t)(__I2C4CLKSource__))
...
#define __HAL_RCC_GET_I2C4_SOURCE()                                            \
   ((uint32_t)(READ_BIT(RCC->I2C345CKSELR, RCC_I2C345CKSELR_I2C4SRC)))
...
#define __HAL_RCC_I2C5_CONFIG(__I2C5CLKSource__)                               \
   MODIFY_REG(RCC->I2C345CKSELR, RCC_I2C345CKSELR_I2C5SRC,                     \
              (uint32_t)(__I2C5CLKSource__))
 ...
 *            @arg RCC_I2C5CLKSOURCE_CSI:    CSI selected as I2C5 clock
 */
#define __HAL_RCC_GET_I2C5_SOURCE()                                            \
   ((uint32_t)(READ_BIT(RCC->I2C345CKSELR, RCC_I2C345CKSELR_I2C5SRC)))
...
#define __HAL_RCC_SAI1_CONFIG(__RCC_SAI1CLKSource__)                           \
   MODIFY_REG(RCC->SAI1CKSELR, RCC_SAI1CKSELR_SAI1SRC,                         \
              (uint32_t)(__RCC_SAI1CLKSource__))
...
#define __HAL_RCC_GET_SAI1_SOURCE()                                            \
   ((uint32_t)(READ_BIT(RCC->SAI1CKSELR, RCC_SAI1CKSELR_SAI1SRC)))
...
#define __HAL_RCC_SAI2_CONFIG(__RCC_SAI2CLKSource__)                           \
   MODIFY_REG(RCC->SAI2CKSELR, RCC_SAI2CKSELR_SAI2SRC,                         \
              (uint32_t)(__RCC_SAI2CLKSource__))
...
#define __HAL_RCC_GET_SAI2_SOURCE()                                            \
   ((uint32_t)(READ_BIT(RCC->SAI2CKSELR, RCC_SAI2CKSELR_SAI2SRC)))
...
#define __HAL_RCC_SPI1_CONFIG(__RCC_SPI1CLKSource__)                           \
   MODIFY_REG(RCC->SPI2S1CKSELR, RCC_SPI2S1CKSELR_SPI1SRC,                     \
              (uint32_t)(__RCC_SPI1CLKSource__))
...
#define __HAL_RCC_SPI4_CONFIG(__RCC_SPI4CLKSource__)                           \
   MODIFY_REG(RCC->SPI45CKSELR, RCC_SPI45CKSELR_SPI4SRC,                       \
              (uint32_t)(__RCC_SPI4CLKSource__))
...
#define __HAL_RCC_GET_SPI4_SOURCE()                                            \
   ((uint32_t)(READ_BIT(RCC->SPI45CKSELR, RCC_SPI45CKSELR_SPI4SRC)))
...
#define __HAL_RCC_SPI5_CONFIG(__RCC_SPI5CLKSource__)                           \
   MODIFY_REG(RCC->SPI45CKSELR, RCC_SPI45CKSELR_SPI5SRC,                       \
              (uint32_t)(__RCC_SPI5CLKSource__))
...
#define __HAL_RCC_GET_SPI5_SOURCE()                                            \
   ((uint32_t)(READ_BIT(RCC->SPI45CKSELR, RCC_SPI45CKSELR_SPI5SRC)))

/** @brief macro to configure the USART1 clock (USART1CLK).
 *
 * @param  __USART1CLKSource__: specifies the USART1 clock source.
 *          This parameter can be one of the following values:
 *            @arg RCC_USART1CLKSOURCE_PCLK6:  PCLK6 Clock selected as USART1
 * clock (default after reset)
 *            @arg RCC_USART1CLKSOURCE_PLL3:   PLL3_Q Clock selected as USART1
 * clock USART1
 *            @arg RCC_USART1CLKSOURCE_HSI:    HSI Clock selected as USART1
 * clock
 *            @arg RCC_USART1CLKSOURCE_CSI:    CSI Clock selected as USART1
 * clock
 *            @arg RCC_USART1CLKSOURCE_PLL4:   PLL4_Q Clock selected as USART1
 * clock
 *            @arg RCC_USART1CLKSOURCE_HSE:    HSE Clock selected as USART1
 * clock
 * @retval None
 */
#define __HAL_RCC_USART1_CONFIG(__USART1CLKSource__)                           \
   MODIFY_REG(RCC->UART12CKSELR, RCC_UART12CKSELR_UART1SRC,                    \
              (uint32_t)(__USART1CLKSource__))
...
#define __HAL_RCC_GET_USART1_SOURCE()                                          \
   ((uint32_t)(READ_BIT(RCC->UART12CKSELR, RCC_UART12CKSELR_UART1SRC)))

/** @brief macro to configure the USART2 clock (USART2CLK).
 *
 * @param  __USART2CLKSource__: specifies the USART2 clock source.
 *          This parameter can be one of the following values:
 *            @arg RCC_USART2CLKSOURCE_PCLK6:  PCLK6 Clock selected as USART2
 * clock (default after reset)
 *            @arg RCC_USART2CLKSOURCE_PLL3:   PLL3_Q Clock selected as USART2
 * clock USART2
 *            @arg RCC_USART2CLKSOURCE_HSI:    HSI Clock selected as USART2
 * clock
 *            @arg RCC_USART2CLKSOURCE_CSI:    CSI Clock selected as USART2
 * clock
 *            @arg RCC_USART2CLKSOURCE_PLL4:   PLL4_Q Clock selected as USART2
 * clock
 *            @arg RCC_USART2CLKSOURCE_HSE:    HSE Clock selected as USART2
 * clock
 * @retval None
 */
#define __HAL_RCC_USART2_CONFIG(__USART2CLKSource__)                           \
   MODIFY_REG(RCC->UART12CKSELR, RCC_UART12CKSELR_UART2SRC,                    \
              (uint32_t)(__USART2CLKSource__))
...
#define __HAL_RCC_GET_USART2_SOURCE()                                          \
   ((uint32_t)(READ_BIT(RCC->UART12CKSELR, RCC_UART12CKSELR_UART2SRC)))

/** @brief macro to configure the UART4 clock (UART4CLK).
 *
 * @param  __UART4CLKSource__: specifies the UART4 clock source.
 *          This parameter can be one of the following values:
 *            @arg RCC_UART4CLKSOURCE_PCLK1:  PCLK1 Clock selected as UART4
 * clock (default after reset)
 *            @arg RCC_UART4CLKSOURCE_PLL4:   PLL4_Q Clock selected as UART4
 * clock
...
#define __HAL_RCC_UART4_CONFIG(__UART4CLKSource__)                             \
   MODIFY_REG(RCC->UART4CKSELR, RCC_UART4CKSELR_UART4SRC,                      \
              (uint32_t)(__UART4CLKSource__))
...
#define __HAL_RCC_GET_UART4_SOURCE()                                           \
   ((uint32_t)(READ_BIT(RCC->UART4CKSELR, RCC_UART4CKSELR_UART4SRC)))
 ...
 *                                            clock (default after reset)
 *            @arg RCC_UART35CLKSOURCE_PLL4:  PLL4_Q Clock selected as UART35
 * clock
...
#define __HAL_RCC_UART35_CONFIG(__UART35CLKSource__)                           \
   MODIFY_REG(RCC->UART35CKSELR, RCC_UART35CKSELR_UART35SRC,                   \
              (uint32_t)(__UART35CLKSource__))
 ...
 * clock
 *            @arg RCC_UART35CLKSOURCE_HSI:    HSI selected as UART35 clock
 *            @arg RCC_UART35CLKSOURCE_CSI:    CSI Clock selected as UART35
 * clock
 *            @arg RCC_UART35CLKSOURCE_HSE:    HSE selected as UART35 clock
 */
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_USART6CLKSOURCE_PCLK2: PCLK2 Clock selected as USART6
 * clock (default after reset)
 *            @arg RCC_USART6CLKSOURCE_PLL4:  PLL4_Q Clock selected as USART6
 * clock
...
#define __HAL_RCC_USART6_CONFIG(__USART6CLKSource__)                           \
   MODIFY_REG(RCC->UART6CKSELR, RCC_UART6CKSELR_UART6SRC,                      \
              (uint32_t)(__USART6CLKSource__))
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_UART78CLKSOURCE_PCLK1: PCLK1 Clock selected as UART78
 * clock (default after reset)
 *            @arg RCC_UART78CLKSOURCE_PLL4:  PLL4_Q Clock selected as UART78
 * clock
...
#define __HAL_RCC_UART78_CONFIG(__UART78CLKSource__)                           \
   MODIFY_REG(RCC->UART78CKSELR, RCC_UART78CKSELR_UART78SRC,                   \
              (uint32_t)(__UART78CLKSource__))
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_SDMMC1CLKSOURCE_HCLK6: HCLK6 Clock selected as SDMMC12
 * clock (default after reset)
 *            @arg RCC_SDMMC1CLKSOURCE_PLL3:  PLL3_R Clock selected as SDMMC12
 * clock
...
#define __HAL_RCC_SDMMC1_CONFIG(__SDMMC12CLKSource__)                          \
   MODIFY_REG(RCC->SDMMC12CKSELR, RCC_SDMMC12CKSELR_SDMMC1SRC,                 \
...
#define __HAL_RCC_GET_SDMMC1_SOURCE()                                          \
   ((uint32_t)(READ_BIT(RCC->SDMMC12CKSELR, RCC_SDMMC12CKSELR_SDMMC1SRC)))

/** @brief macro to configure the SDMMC2 clock (SDMMC2CLK).
 *
 * @param  __SDMMC2CLKSource__: specifies the SDMMC2 clock source.
 *          This parameter can be one of the following values:
 *            @arg RCC_SDMMC2CLKSOURCE_HCLK6: HCLK6 Clock selected as SDMMC2
 * clock (default after reset)
 *            @arg RCC_SDMMC2CLKSOURCE_PLL3:  PLL3_R Clock selected as SDMMC2
 * clock
...
#define __HAL_RCC_SDMMC2_CONFIG(__SDMMC2CLKSource__)                           \
   MODIFY_REG(RCC->SDMMC12CKSELR, RCC_SDMMC12CKSELR_SDMMC2SRC,                 \
              (uint32_t)(__SDMMC2CLKSource__))
...
#define __HAL_RCC_GET_SDMMC2_SOURCE()                                          \
   ((uint32_t)(READ_BIT(RCC->SDMMC12CKSELR, RCC_SDMMC12CKSELR_SDMMC2SRC)))

/** @brief macro to configure the ETH1 clock (ETH1CLK).
 *
 * @param  __ETH1CLKSource__: specifies the ETH1 clock source.
 *          This parameter can be one of the following values:
 *            @arg RCC_ETH1CLKSOURCE_PLL4:  PLL4_P selected as ETH1 clock
 * (default after reset)
...
#define __HAL_RCC_ETH1_CONFIG(__ETH1CLKSource__)                               \
   MODIFY_REG(RCC->ETH12CKSELR, RCC_ETH12CKSELR_ETH1SRC,                       \
              (uint32_t)(__ETH1CLKSource__))
 ...
 *            @arg RCC_ETH1CLKSOURCE_OFF:  the kernel clock is disabled
 */
#define __HAL_RCC_GET_ETH1_SOURCE()                                            \
   ((uint32_t)(READ_BIT(RCC->ETH12CKSELR, RCC_ETH12CKSELR_ETH1SRC)))

/** @brief macro to configure the ETH2 clock (ETH2CLK).
 *
 * @param  __ETH2CLKSource__: specifies the ETH2 clock source.
 *          This parameter can be one of the following values:
 *            @arg RCC_ETH2CLKSOURCE_PLL4:  PLL4_P selected as ETH2 clock
 * (default after reset)
...
#define __HAL_RCC_ETH2_CONFIG(__ETH2CLKSource__)                               \
   MODIFY_REG(RCC->ETH12CKSELR, RCC_ETH12CKSELR_ETH2SRC,                       \
              (uint32_t)(__ETH2CLKSource__))
 ...
 *            @arg RCC_ETH2CLKSOURCE_OFF:  the kernel clock is disabled
 */
#define __HAL_RCC_GET_ETH2_SOURCE()                                            \
   ((uint32_t)(READ_BIT(RCC->ETH12CKSELR, RCC_ETH12CKSELR_ETH2SRC)))

/** @brief macro to configure the QSPI clock (QSPICLK).
 *
 * @param  __QSPICLKSource__: specifies the QSPI clock source.
 *          This parameter can be one of the following values:
 *            @arg RCC_QSPICLKSOURCE_ACLK:  ACLK Clock selected as QSPI clock
 * (default after reset)
...
#define __HAL_RCC_QSPI_CONFIG(__QSPICLKSource__)                               \
   MODIFY_REG(RCC->QSPICKSELR, RCC_QSPICKSELR_QSPISRC,                         \
              (uint32_t)(__QSPICLKSource__))
 ...
 *            @arg RCC_QSPICLKSOURCE_PER:   PER selected as QSPI clock
 */
#define __HAL_RCC_GET_QSPI_SOURCE()                                            \
   ((uint32_t)(READ_BIT(RCC->QSPICKSELR, RCC_QSPICKSELR_QSPISRC)))

/** @brief macro to configure the FMC clock (FMCCLK).
 *
 * @param  __FMCCLKSource__: specifies the FMC clock source.
 *          This parameter can be one of the following values:
 *            @arg RCC_FMCCLKSOURCE_ACLK:  ACLK Clock selected as FMC clock
 * (default after reset)
...
#define __HAL_RCC_FMC_CONFIG(__FMCCLKSource__)                                 \
   MODIFY_REG(RCC->FMCCKSELR, RCC_FMCCKSELR_FMCSRC,                            \
              (uint32_t)(__FMCCLKSource__))
...
#define __HAL_RCC_GET_FMC_SOURCE()                                             \
   ((uint32_t)(READ_BIT(RCC->FMCCKSELR, RCC_FMCCKSELR_FMCSRC)))
 ...
 * (default after reset)
 *            @arg RCC_FDCANCLKSOURCE_PLL3:   PLL3_Q Clock selected as FDCAN
 * clock
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_SPDIFRXCLKSOURCE_PLL4:  PLL4_P Clock selected as SPDIF
 * clock (default after reset)
 *            @arg RCC_SPDIFRXCLKSOURCE_PLL3:  PLL3_Q Clock selected as SPDIF
 * clock
 *            @arg RCC_SPDIFRXCLKSOURCE_HSI:   HSI selected as SPDIF clock
 * @retval None
 */
#define __HAL_RCC_SPDIFRX_CONFIG(__SPDIFCLKSource__)                           \
   MODIFY_REG(RCC->SPDIFCKSELR, RCC_SPDIFCKSELR_SPDIFSRC,                      \
              (uint32_t)(__SPDIFCLKSource__))
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_USBPHYCLKSOURCE_HSE:   HSE_KER   Clock selected as USB
 * PHY clock (default after reset)
 *            @arg RCC_USBPHYCLKSOURCE_PLL4:  PLL4_R    Clock selected as USB
 * PHY clock
 *            @arg RCC_USBPHYCLKSOURCE_HSE2:  HSE_KER/2 Clock selected as USB
 * PHY clock
 * @retval None
 */
#define __HAL_RCC_USBPHY_CONFIG(__USBPHYCLKSource__)                           \
   MODIFY_REG(RCC->USBCKSELR, RCC_USBCKSELR_USBPHYSRC,                         \
              (uint32_t)(__USBPHYCLKSource__))
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_USBOCLKSOURCE_PLL4: PLL4_R Clock selected as USB OTG
 * clock (default after reset)
 *            @arg RCC_USBOCLKSOURCE_PHY:  USB PHY Clock selected as USB OTG
 * clock
 * @retval None
 */
#define __HAL_RCC_USBO_CONFIG(__USBOCLKSource__)                               \
   MODIFY_REG(RCC->USBCKSELR, RCC_USBCKSELR_USBOSRC,                           \
              (uint32_t)(__USBOCLKSource__))
 ...
 * clock
 */
#define __HAL_RCC_GET_USBO_SOURCE()                                            \
   ((uint32_t)(READ_BIT(RCC->USBCKSELR, RCC_USBCKSELR_USBOSRC)))

/** @brief macro to configure the RNG1 clock (RNG1CLK).
 *
 * @param  __RNG1CLKSource__: specifies the RNG1 clock source.
 *          This parameter can be one of the following values:
 *            @arg RCC_RNG1CLKSOURCE_CSI:   CSI Clock selected as RNG1 clock
 * (default after reset)
...
#define __HAL_RCC_RNG1_CONFIG(__RNG1CLKSource__)                               \
   MODIFY_REG(RCC->RNG1CKSELR, RCC_RNG1CKSELR_RNG1SRC,                         \
              (uint32_t)(__RNG1CLKSource__))
 ...
 *            @arg RCC_RNG1CLKSOURCE_LSI:   LSI Clock selected as RNG1 clock
 */
#define __HAL_RCC_GET_RNG1_SOURCE()                                            \
   ((uint32_t)(READ_BIT(RCC->RNG1CKSELR, RCC_RNG1CKSELR_RNG1SRC)))

/** @brief macro to configure the CK_PER clock (CK_PERCLK).
 *
 * @param  __CKPERCLKSource__: specifies the CPER clock source.
 *          This parameter can be one of the following values:
 *            @arg RCC_CKPERCLKSOURCE_HSI:   HSI Clock selected as CK_PER clock
 * (default after reset)
...
#define __HAL_RCC_CKPER_CONFIG(__CKPERCLKSource__)                             \
   MODIFY_REG(RCC->CPERCKSELR, RCC_CPERCKSELR_CKPERSRC,                        \
              (uint32_t)(__CKPERCLKSource__))
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_STGENCLKSOURCE_HSI:   HSI Clock selected as STGEN clock
 * (default after reset)
...
#define __HAL_RCC_STGEN_CONFIG(__STGENCLKSource__)                             \
   MODIFY_REG(RCC->STGENCKSELR, RCC_STGENCKSELR_STGENSRC,                      \
              (uint32_t)(__STGENCLKSource__))
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_DCMIPPCLKSOURCE_ACLK:  ACLK Clock selected as DCMIPP
 * clock (default after reset)
 *            @arg RCC_DCMIPPCLKSOURCE_PLL2:  PLL2 Clock selected as DCMIPP
 * clock
 *            @arg RCC_DCMIPPCLKSOURCE_PLL4:  PLL4 Clock selected as DCMIPP
 * clock
...
#define __HAL_RCC_DCMIPP_CONFIG(__DCMIPPCLKSource__)                           \
   MODIFY_REG(RCC->DCMIPPCKSELR, RCC_DCMIPPCKSELR_DCMIPPSRC,                   \
              (uint32_t)(__DCMIPPCLKSource__))
 ...
 *            @arg RCC_DCMIPPCLKSOURCE_PER:   PER Clock selected as DCMIPP clock
 */
#define __HAL_RCC_GET_DCMIPP_SOURCE()                                          \
   ((uint32_t)(READ_BIT(RCC->DCMIPPCKSELR, RCC_DCMIPPCKSELR_DCMIPPSRC)))
#endif /* RCC_PERIPHCLK_DCMIPP */
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_SAESCLKSOURCE_ACLK:  ACLK Clock selected as SAES clock
 * (default after reset)
...
#define __HAL_RCC_SAES_CONFIG(__SAESCLKSource__)                               \
   MODIFY_REG(RCC->SAESCKSELR, RCC_SAESCKSELR_SAESSRC,                         \
              (uint32_t)(__SAESCLKSource__))
 ...
 *            @arg RCC_SAESCLKSOURCE_LSI:   LSI Clock selected as SAES clock
 */
#define __HAL_RCC_GET_SAES_SOURCE()                                            \
   ((uint32_t)(READ_BIT(RCC->SAESCKSELR, RCC_SAESCKSELR_SAESSRC)))
#endif /* RCC_PERIPHCLK_SAES */
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_ADC1CLKSOURCE_PLL4:    PLL4_R Clock selected as ADC1
 * clock (default after reset)
 *            @arg RCC_ADC1CLKSOURCE_PER:     PER Clock selected as ADC1 clock
 *            @arg RCC_ADC1CLKSOURCE_PLL3:    PLL3_Q Clock selected as ADC1
 * clock
 * @retval None
 */
#define __HAL_RCC_ADC1_CONFIG(__ADC1CLKSource__)                               \
   MODIFY_REG(RCC->ADC12CKSELR, RCC_ADC12CKSELR_ADC1SRC,                       \
              (uint32_t)(__ADC1CLKSource__))
 ...
 * clock
 */
#define __HAL_RCC_GET_ADC1_SOURCE()                                            \
   ((uint32_t)(READ_BIT(RCC->ADC12CKSELR, RCC_ADC12CKSELR_ADC1SRC)))

/** @brief macro to configure the ADC2 clock (ADC2CLK).
 *
 * @param  __ADC2CLKSource__: specifies the ADC2 clock source.
 *          This parameter can be one of the following values:
 *            @arg RCC_ADC2CLKSOURCE_PLL4:    PLL4_R Clock selected as ADC2
 * clock (default after reset)
 *            @arg RCC_ADC2CLKSOURCE_PER:     PER Clock selected as ADC2 clock
 *            @arg RCC_ADC2CLKSOURCE_PLL3:    PLL3_Q Clock selected as ADC2
 * clock
 * @retval None
 */
#define __HAL_RCC_ADC2_CONFIG(__ADC2CLKSource__)                               \
   MODIFY_REG(RCC->ADC12CKSELR, RCC_ADC12CKSELR_ADC2SRC,                       \
              (uint32_t)(__ADC2CLKSource__))
 ...
 * clock
 */
#define __HAL_RCC_GET_ADC2_SOURCE()                                            \
   ((uint32_t)(READ_BIT(RCC->ADC12CKSELR, RCC_ADC12CKSELR_ADC2SRC)))

/** @brief macro to configure the LPTIM1 clock (LPTIM1CLK).
 *
 * @param  __LPTIM1CLKSource__: specifies the LPTIM1 clock source.
 *          This parameter can be one of the following values:
 *            @arg RCC_LPTIM1CLKSOURCE_PCLK1:   PCLK1 Clock selected as LPTIM1
 * clock (default after reset)
 *            @arg RCC_LPTIM1CLKSOURCE_PLL4:    PLL4_P Clock selected as LPTIM1
 * clock
 *            @arg RCC_LPTIM1CLKSOURCE_PLL3:    PLL3_Q Clock selected as LPTIM1
 * clock
 *            @arg RCC_LPTIM1CLKSOURCE_LSE:     LSE Clock selected as LPTIM1
 * clock
 *            @arg RCC_LPTIM1CLKSOURCE_LSI:     LSI Clock selected as LPTIM1
 * clock
 *            @arg RCC_LPTIM1CLKSOURCE_PER:     PER Clock selected as LPTIM1
 * clock
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_LPTIM23CLKSOURCE_PCLK3:   PCLK3 Clock selected as LPTIM23
 * clock (default after reset)
 *            @arg RCC_LPTIM23CLKSOURCE_PLL4:    PLL4_Q Clock selected as
 * LPTIM23 clock
 *            @arg RCC_LPTIM23CLKSOURCE_PER:     PER Clock selected as LPTIM23
 * clock
 *            @arg RCC_LPTIM23CLKSOURCE_LSE:     LSE Clock selected as LPTIM23
 * clock
 *            @arg RCC_LPTIM23CLKSOURCE_LSI:     LSI Clock selected as LPTIM23
 * clock
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_LPTIM2CLKSOURCE_PCLK3:   PCLK3 Clock selected as LPTIM2
 * clock (default after reset)
 *            @arg RCC_LPTIM2CLKSOURCE_PLL4:    PLL4_Q Clock selected as LPTIM2
 * clock
 *            @arg RCC_LPTIM2CLKSOURCE_PER:     PER Clock selected as LPTIM2
 * clock
 *            @arg RCC_LPTIM2CLKSOURCE_LSE:     LSE Clock selected as LPTIM2
 * clock
 *            @arg RCC_LPTIM2CLKSOURCE_LSI:     LSI Clock selected as LPTIM2
 * clock
 *            @arg RCC_LPTIM2CLKSOURCE_OFF:     The kernel clock is disabled
 * @retval None
 */
#define __HAL_RCC_LPTIM2_CONFIG(__LPTIM2CLKSource__)                           \
   MODIFY_REG(RCC->LPTIM23CKSELR, RCC_LPTIM23CKSELR_LPTIM2SRC,                 \
              (uint32_t)(__LPTIM2CLKSource__))
...
#define __HAL_RCC_GET_LPTIM2_SOURCE()                                          \
   ((uint32_t)(READ_BIT(RCC->LPTIM23CKSELR, RCC_LPTIM23CKSELR_LPTIM2SRC)))
#endif /* RCC_LPTIM23CKSELR_LPTIM2SRC */
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_LPTIM3CLKSOURCE_PCLK3:   PCLK3 Clock selected as LPTIM3
 * clock (default after reset)
 *            @arg RCC_LPTIM3CLKSOURCE_PLL4:    PLL4_Q Clock selected as LPTIM3
 * clock
 *            @arg RCC_LPTIM3CLKSOURCE_PER:     PER Clock selected as LPTIM3
 * clock
 *            @arg RCC_LPTIM3CLKSOURCE_LSE:     LSE Clock selected as LPTIM3
 * clock
 *            @arg RCC_LPTIM3CLKSOURCE_LSI:     LSI Clock selected as LPTIM3
 * clock
 *            @arg RCC_LPTIM3CLKSOURCE_OFF:     The kernel clock is disabled
 * @retval None
 */
#define __HAL_RCC_LPTIM3_CONFIG(__LPTIM3CLKSource__)                           \
   MODIFY_REG(RCC->LPTIM23CKSELR, RCC_LPTIM23CKSELR_LPTIM3SRC,                 \
              (uint32_t)(__LPTIM3CLKSource__))
...
#define __HAL_RCC_GET_LPTIM3_SOURCE()                                          \
   ((uint32_t)(READ_BIT(RCC->LPTIM23CKSELR, RCC_LPTIM23CKSELR_LPTIM3SRC)))
#endif /* RCC_LPTIM23CKSELR_LPTIM3SRC */
 ...
 *          This parameter can be one of the following values:
 *            @arg RCC_LPTIM45CLKSOURCE_PCLK3:   PCLK3 Clock selected as LPTIM45
 * clock (default after reset)
 *            @arg RCC_LPTIM45CLKSOURCE_PLL4:    PLL4_P Clock selected as
 * LPTIM45 clock
 *            @arg RCC_LPTIM45CLKSOURCE_PLL3:    PLL3_Q Clock selected as
 * LPTIM45 clock
 *            @arg RCC_LPTIM45CLKSOURCE_LSE:     LSE Clock selected as LPTIM45
 * clock
 *            @arg RCC_LPTIM45CLKSOURCE_LSI:     LSI Clock selected as LPTIM45
 * clock
 *            @arg RCC_LPTIM45CLKSOURCE_PER:     PER Clock selected as LPTIM45
 * clock
 ...
 * @note   Set and reset by software to control the clock frequency of all the
 * timers connected to APB1 domain. It concerns TIM2, TIM3, TIM4, TIM5, TIM6,
 * TIM7.
 * @param  __RCC_TIMG1PRES__: specifies the Timers clocks prescaler selection
 *          This parameter can be one of the following values:
 *              @arg RCC_TIMG1PRES_DEACTIVATED:  The Timers kernel clock is
 * equal to ck_hclk if APB1DIV is corresponding to a division by 1 or 2, else it
 * is equal to 2 x Fck_pclk1 (default after reset)
 *              @arg RCC_TIMG1PRES_ACTIVATED:    The Timers kernel clock is
 * equal to ck_hclk if APB1DIV is corresponding to division by 1, 2 or 4, else
 ...
 *         of the following:
 *             - RCC_TIMG1PRES_DEACTIVATED: The Timers kernel clock is equal to
 * ck_hclk if APB1DIV is corresponding to a division by 1 or 2, else it is equal
 * to 2 x Fck_pclk1 (default after reset)
 *             - RCC_TIMG1PRES_ACTIVATED:   The Timers kernel clock is equal to
 * ck_hclk if APB1DIV is corresponding to division by 1, 2 or 4, else it is
 * equal to 4 x Fck_pclk1
 */
#define __HAL_RCC_GET_TIMG1PRES()                                              \
   ((uint32_t)(RCC->TIMG1PRER & RCC_TIMG1PRER_TIMG1PRE))

/**
 * @brief  Macro to set the APB2 timers clocks prescaler
 * @note   Set and reset by software to control the clock frequency of all the
 * timers connected to APB2 domain. It concerns TIM1 and TIM8.
 * @param  __RCC_TIMG2PRES__: specifies the timers clocks prescaler selection
 *          This parameter can be one of the following values:
 *              @arg RCC_TIMG2PRES_DEACTIVATED:  The Timers kernel clock is
 * equal to ck_hclk if APB2DIV is corresponding to a division by 1 or 2, else it
 * is equal to 2 x Fck_pclk2 (default after reset)
 *              @arg RCC_TIMG2PRES_ACTIVATED:    The Timers kernel clock is
 * equal to ck_hclk if APB2DIV is correspondingto division by 1, 2 or 4, else it
 * is equal to 4 x Fck_pclk1
 */
 ...
 *         of the following:
 *             - RCC_TIMG2PRES_DEACTIVATED: The Timers kernel clock is equal to
 * ck_hclk if APB2DIV is corresponding to a division by 1 or 2, else it is equal
 * to 2 x Fck_pclk1 (default after reset)
 *             - RCC_TIMG2PRES_ACTIVATED:   The Timers kernel clock is equal to
 * ck_hclk if APB2DIV is corresponding to division by 1, 2 or 4, else it is
 * equal to 4 x Fck_pclk1
 */
#define __HAL_RCC_GET_TIMG2PRES()                                              \
   ((uint32_t)(RCC->TIMG2PRER & RCC_TIMG2PRER_TIMG2PRE))

/**
 * @brief  Macro to set the APB6 timers clocks prescaler
 * @note   Set and reset by software to control the clock frequency of all the
 * timers connected to APB6 domain. It concerns TIM12, TIM13, TIM14, TIM15,
 * TIM16, and TIM17.
 * @param  __RCC_TIMG3PRES__: specifies the timers clocks prescaler selection
 *          This parameter can be one of the following values:
 *              @arg RCC_TIMG3PRES_DEACTIVATED:  The Timers kernel clock is
 * equal to ck_hclk if APB6DIV is corresponding to a division by 1 or 2, else it
 * is equal to 2 x Fck_pclk2 (default after reset)
 *              @arg RCC_TIMG3PRES_ACTIVATED:    The Timers kernel clock is
 * equal to ck_hclk if APB6DIV is correspondingto division by 1, 2 or 4, else it
 * is equal to 4 x Fck_pclk1
 */
#define __HAL_RCC_TIMG3PRES(__RCC_TIMG3PRES__)                                 \
   do {                                                                        \
      MODIFY_REG(RCC->TIMG3PRER, RCC_TIMG3PRER_TIMG3PRE, __RCC_TIMG3PRES__);   \
   } while (0)

/** @brief  Macro to get the APB6 timer clock prescaler.
 * @retval The APB6 timer clock prescaler. The returned value can be one
 *         of the following:
 *             - RCC_TIMG3PRES_DEACTIVATED: The Timers kernel clock is equal to
 * ck_hclk if APB6DIV is corresponding to a division by 1 or 2, else it is equal
 * to 2 x Fck_pclk1 (default after reset)
 *             - RCC_TIMG3PRES_ACTIVATED:   The Timers kernel clock is equal to
 * ck_hclk if APB6DIV is corresponding to division by 1, 2 or 4, else it is
 * equal to 4 x Fck_pclk1
 */
#define __HAL_RCC_GET_TIMG3PRES()                                              \
   ((uint32_t)(RCC->TIMG3PRER & RCC_TIMG3PRER_TIMG3PRE))

#define USB_PHY_VALUE                                                          \
   ((uint32_t)48000000U) /*!< Value of the USB_PHY_VALUE signal in Hz          \
...
HAL_StatusTypeDef
HAL_RCCEx_PeriphCLKConfig(const RCC_PeriphCLKInitTypeDef *PeriphClkInit);
