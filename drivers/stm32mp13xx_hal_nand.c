...
/**
  ...
  * @retval HAL status
  */
static HAL_StatusTypeDef HAL_NAND_Read_Page(NAND_HandleTypeDef *hnand, NAND_AddressTypeDef *pAddress, void *pBuffer,
...
/**
  ...
  * @retval HAL status
  */
static HAL_StatusTypeDef HAL_NAND_Read_SinglePage(NAND_HandleTypeDef *hnand, NAND_AddressTypeDef *pAddress, void *pBuffer,
...
/**
  ...
  * @retval HAL status
  */
static HAL_StatusTypeDef HAL_NAND_Write_Page(NAND_HandleTypeDef *hnand, NAND_AddressTypeDef *pAddress, void *pBuffer,
...
/**
  ...
  * @retval HAL status
  */
static HAL_StatusTypeDef HAL_NAND_Write_SinglePage(NAND_HandleTypeDef *hnand, NAND_AddressTypeDef *pAddress, void *pBuffer,
                                            uint32_t Offset, uint32_t Length)
{
  HAL_StatusTypeDef status = HAL_OK;
  uint32_t nandAddressMax;
...
/**
  ...
  * @retval HAL status
  */
static HAL_StatusTypeDef HAL_NAND_Read_SpareArea(NAND_HandleTypeDef *hnand, NAND_AddressTypeDef *pAddress, void *pBuffer,
...
/**
  ...
  * @retval HAL status
  */
static HAL_StatusTypeDef HAL_NAND_Read_SingleSpareArea(NAND_HandleTypeDef *hnand, NAND_AddressTypeDef *pAddress, void *pBuffer,
                                                uint32_t Offset, uint32_t Length)
{
  HAL_StatusTypeDef status = HAL_OK;
  uint32_t nandAddressMax;
...
/**
  ...
  * @retval HAL status
  */
static HAL_StatusTypeDef HAL_NAND_Write_SpareArea(NAND_HandleTypeDef *hnand, NAND_AddressTypeDef *pAddress, void *pBuffer,
...
/**
  ...
  * @retval HAL status
  */
static HAL_StatusTypeDef HAL_NAND_Write_SingleSpareArea(NAND_HandleTypeDef *hnand, NAND_AddressTypeDef *pAddress,
...
/**
  ...
  * @retval HAL status
  */
static HAL_StatusTypeDef  HAL_NAND_ECC_Write_Page(NAND_HandleTypeDef *hnand, NAND_AddressTypeDef *pAddress, void *pBuffer,
