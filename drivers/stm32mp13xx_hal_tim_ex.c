 ...
 * AWD3
 *            @arg TIM_TIM1_ETR_ADC2_AWD1       TIM1 ETR is connected to ADC2
 * AWD1
 *            @arg TIM_TIM1_ETR_ADC2_AWD2       TIM1 ETR is connected to ADC2
 * AWD2
 *            @arg TIM_TIM1_ETR_ADC2_AWD3       TIM1 ETR is connected to ADC2
 * AWD3
 *
 ...
 *            @arg TIM_TIM2_ETR_SAI1_FSA        TIM2_ETR is connected to SAI1
 * FS_A
 *            @arg TIM_TIM2_ETR_SAI1_FSB        TIM2_ETR is connected to SAI1
 * FS_B
 *            @arg TIM_TIM2_ETR_ETH1_PPS        TIM2_ETR is connected to ETH1
 * PPS
 *            @arg TIM_TIM2_ETR_ETH2_PPS        TIM2_ETR is connected to ETH2
 * PPS
 *
 *         For TIM3, the parameter can take one of the following values:
 *            @arg TIM_TIM3_ETR_GPIO            TIM3_ETR is not connected to I/O
 *            @arg TIM_TIM3_ETR_ETH1_PPS        TIM3_ETR is connected to ETH1
 * PPS
 *            @arg TIM_TIM3_ETR_ETH2_PPS        TIM3_ETR is connected to ETH2
 * PPS
 *
 ...
 *            @arg TIM_TIM5_ETR_SAI2_FSA        TIM5_ETR is connected to SAI2
 * FS_A
 *            @arg TIM_TIM5_ETR_SAI2_FSB        TIM5_ETR is connected to SAI2
 * FS_B
 ...
 *            @arg TIM_TIM8_ETR_ADC1_AWD1       TIM8_ETR is connected to ADC1
 * AWD1
 *            @arg TIM_TIM8_ETR_ADC1_AWD2       TIM8_ETR is connected to ADC1
 * AWD2
 *            @arg TIM_TIM8_ETR_ADC1_AWD3       TIM8_ETR is connected to ADC1
 * AWD3
 *            @arg TIM_TIM8_ETR_ADC2_AWD1       TIM8_ETR is connected to ADC2
 * AWD1
 *            @arg TIM_TIM8_ETR_ADC2_AWD2       TIM8_ETR is connected to ADC2
 * AWD2
 *            @arg TIM_TIM8_ETR_ADC2_AWD3       TIM8_ETR is connected to ADC2
 * AWD3
 *
 * @retval HAL status
 */
 ...
 * GPIO
 *            @arg TIM_TIM3_TI4_GPIO:                TIM3 TI4 is connected to
 * GPIO
 *
 ...
 * GPIO
 *            @arg TIM_TIM5_TI1_FDCAN_TMP:           TIM5 TI1 is connected to
 * FDCAN TMP
 *            @arg TIM_TIM5_TI1_FDCAN_RTP:           TIM5 TI1 is connected to
 * FDCAN RTP
 ...
 * LSE
 *            @arg TIM_TIM15_TI1_CSI:               TIM15 TI1 is connected to
 * CSI
 *            @arg TIM_TIM15_TI1_MCO2:              TIM15 TI1 is connected to
 * MCO2
 *            @arg TIM_TIM15_TI2_GPIO:              TIM15 TI2 is connected to
 * GPIO
 *            @arg TIM_TIM15_TI2_TIM2:              TIM15 TI2 is connected to
 * TIM2 CH2
 *            @arg TIM_TIM15_TI2_TIM3:              TIM15 TI2 is connected to
 * TIM3 CH2
 *            @arg TIM_TIM15_TI2_TIM4:              TIM15 TI2 is connected to
 * TIM4 CH2
 *
 ...
 * LSE
 *            @arg TIM_TIM16_TI1_WKUP_IT:           TIM16 TI1 is connected to
 * RTC wakeup interrupt
 *
 *         For TIM17, the parameter can have the following values:
 *            @arg TIM_TIM17_TI1_GPIO:              TIM17 TI1 is connected to
 * GPIO
 *            @arg TIM_TIM17_TI1_SPDIF_FS:          TIM17 TI1 is connected to
 * SPDIF FS (**)
 *            @arg TIM_TIM17_TI1_HSE_RTC:          TIM17 TI1 is connected to
 * HSE_RTC
