...
#define ETZPC_MODIFY_REG(REG, FIELD, VALUE)                                    \
   MODIFY_REG(ETZPCx->REG, ETZPC_##REG##_##FIELD##_Msk,                        \
              (((VALUE) &                                                      \
                (ETZPC_##REG##_##FIELD##_Msk >> ETZPC_##REG##_##FIELD##_Pos))  \
               << ETZPC_##REG##_##FIELD##_Pos))

#define ETZPC_SET_BIT(REG, FIELD)                                              \
   SET_BIT(ETZPCx->REG, ETZPC_##REG##_##FIELD##_Msk)
...
#define LL_ETZPC_PERIPH_PROTECTION_READ_WRITE_SECURE                           \
   0x0 /*!< read and write secure */
#define LL_ETZPC_PERIPH_PROTECTION_READ_NONSECURE_WRITE_SECURE                 \
   0x1 /*!< read non-secure and write secure */
#define LL_ETZPC_PERIPH_PROTECTION_READ_WRITE_NONSECURE                        \
   0x3 /*!< read and write non-secure */
 ...
 * @retval None
 */
#define LL_ETZPC_WriteReg(__INSTANCE__, __REG__, __VALUE__)                    \
 ...
 *         Define the size of the secure SYSRAM at low address and non-secure at
 * high
 *
 *         This function can be called from startup, and as such respect
 * following rules:
 ...
 *               ....
 *               0x040 to 0x3FF: 256K Byte SYSRAM secure (e.g all SYSRAM secure)
 * <-- reset value in ETZPC/TZMA1
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_SetSecureSysRamSize(ETZPC_TypeDef *ETZPCx,
                                                  uint32_t size)
{
 ...
 *
 * @param  ETZPCx ETZPC Instance
 * @param  protection  : protection level of the peripheral : possible values
 * are
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_All_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                       uint32_t protection)
{
   /* Broadcast the protection, if it is a constant the following operations
      will be optimized out and the result will be a constant too */
...
LL_ETZPC_Set_VREFBUF_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                      uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_LPTIM2_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                          uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_LPTIM3_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                          uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_LTDC_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                        uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_DCMIPP_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                          uint32_t protection)
{
 ...
 */
__STATIC_INLINE void
LL_ETZPC_Set_USBPHYC_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                      uint32_t protection)
{
...
/**
 * @brief  Set DDRCTRL and DDRPHYC peripheral (ETZPC Securable peripheral)
 * protection.
 *
 * @param  ETZPCx ETZPC Instance
 * @param  protection  : protection level of the peripheral : possible values
 ...
 */
__STATIC_INLINE void
LL_ETZPC_Set_DDRCTRL_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                      uint32_t protection)
{
...
/**
 * @brief  Set Independent Watchdog 1 (IWDG1) peripheral (ETZPC Securable
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_IWDG1_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                         uint32_t protection)
{
...
/**
 * @brief  Set System Timer Generator (STGENC) peripheral (ETZPC Securable
 * peripheral) protection.
 *
 * @param  ETZPCx ETZPC Instance
 * @param  protection  : protection level of the peripheral : possible values
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_STGENC_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                          uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_USART1_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                          uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_USART2_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                          uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_SPI4_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                        uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_SPI5_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                        uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_I2C3_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                        uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_I2C4_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                        uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_I2C5_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                        uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_TIM12_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                         uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_TIM13_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                         uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_TIM14_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                         uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_TIM15_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                         uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_TIM16_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                         uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_TIM17_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                         uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_ADC1_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                        uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_ADC2_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                        uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_OTG_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                       uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_RNG_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                       uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_HASH_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                        uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_CRYP_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                        uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_SAES_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                        uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_PKA_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                       uint32_t protection)
{
...
/**
 * @brief  Set Backup RAM (BKPSRAM) peripheral (ETZPC Securable peripheral)
 * protection.
 *
 * @param  ETZPCx ETZPC Instance
 * @param  protection  : protection level of the peripheral : possible values
 ...
 */
__STATIC_INLINE void
LL_ETZPC_Set_BKPSRAM_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                      uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_ETH1_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                        uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_ETH2_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                        uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_SDMMC1_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                          uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_SDMMC2_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                          uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_DDRMCE_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                          uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_FMC_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                       uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_QSPI_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                        uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_SRAM1_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                         uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_SRAM2_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                         uint32_t protection)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ETZPC_Set_SRAM3_PeriphProtection(ETZPC_TypeDef *ETZPCx,
                                                         uint32_t protection)
{
 ...
 */
__STATIC_INLINE void
LL_ETZPC_Lock_VREFBUF_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
LL_ETZPC_Lock_LPTIM2_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
LL_ETZPC_Lock_LPTIM3_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
LL_ETZPC_Lock_DCMIPP_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
LL_ETZPC_Lock_USBPHYC_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
   ETZPC_SET_BIT(DECPROT_LOCK0, USBPHYC);
}

/**
 * @brief  Lock DDRCTRL and DDRPHYC peripheral (ETZPC Securable peripheral)
 * protection.
 *
 * @param  ETZPCx ETZPC Instance
 * @retval None
 */
__STATIC_INLINE void
LL_ETZPC_Lock_DDRCTRL_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
   ETZPC_SET_BIT(DECPROT_LOCK0, DDRCTRL);
}

/**
 * @brief  Lock Independent Watchdog 1 (IWDG1) peripheral (ETZPC Securable
 * peripheral) protection.
 *
 * @param  ETZPCx ETZPC Instance
 * @retval None
...
/**
 * @brief  Lock System Timer Generator (STGENC) peripheral (ETZPC Securable
 * peripheral) protection.
 *
 * @param  ETZPCx ETZPC Instance
 * @retval None
 */
__STATIC_INLINE void
LL_ETZPC_Lock_STGENC_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
   ETZPC_SET_BIT(DECPROT_LOCK0, STGENC);
}

/**
 * @brief  Lock secure USART1 peripheral (ETZPC Securable peripheral)
 * protection.
 *
 * @param  ETZPCx ETZPC Instance
 * @retval None
 */
__STATIC_INLINE void
LL_ETZPC_Lock_USART1_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
   ETZPC_SET_BIT(DECPROT_LOCK0, USART1);
}

/**
 * @brief  Lock secure USART2 peripheral (ETZPC Securable peripheral)
 * protection.
 *
 * @param  ETZPCx ETZPC Instance
 * @retval None
 */
__STATIC_INLINE void
LL_ETZPC_Lock_USART2_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
...
/**
 * @brief  Lock Backup RAM (BKPSRAM) peripheral (ETZPC Securable peripheral)
 * protection.
 *
 * @param  ETZPCx ETZPC Instance
 * @retval None
 */
__STATIC_INLINE void
LL_ETZPC_Lock_BKPSRAM_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
LL_ETZPC_Lock_SDMMC1_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
LL_ETZPC_Lock_SDMMC2_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
 ...
 */
__STATIC_INLINE void
LL_ETZPC_Lock_DDRMCE_PeriphProtection(ETZPC_TypeDef *ETZPCx)
{
