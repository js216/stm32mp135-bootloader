 ...
 */
#define EXTI_LINE_0                                                            \
   (EXTI_GPIO | EXTI_EVENT | EXTI_REG1 | 0x00U) /* EXTI_GPIO                   \
                                                 */
#define EXTI_LINE_1                                                            \
   (EXTI_GPIO | EXTI_EVENT | EXTI_REG1 | 0x01U) /* EXTI_GPIO                   \
                                                 */
#define EXTI_LINE_2                                                            \
   (EXTI_GPIO | EXTI_EVENT | EXTI_REG1 | 0x02U) /* EXTI_GPIO                   \
                                                 */
#define EXTI_LINE_3                                                            \
   (EXTI_GPIO | EXTI_EVENT | EXTI_REG1 | 0x03U) /* EXTI_GPIO                   \
                                                 */
#define EXTI_LINE_4                                                            \
   (EXTI_GPIO | EXTI_EVENT | EXTI_REG1 | 0x04U) /* EXTI_GPIO                   \
                                                 */
#define EXTI_LINE_5                                                            \
   (EXTI_GPIO | EXTI_EVENT | EXTI_REG1 | 0x05U) /* EXTI_GPIO                   \
                                                 */
#define EXTI_LINE_6                                                            \
   (EXTI_GPIO | EXTI_EVENT | EXTI_REG1 | 0x06U) /* EXTI_GPIO                   \
                                                 */
#define EXTI_LINE_7                                                            \
   (EXTI_GPIO | EXTI_EVENT | EXTI_REG1 | 0x07U) /* EXTI_GPIO                   \
                                                 */
#define EXTI_LINE_8                                                            \
   (EXTI_GPIO | EXTI_EVENT | EXTI_REG1 | 0x08U) /* EXTI_GPIO                   \
                                                 */
#define EXTI_LINE_9                                                            \
   (EXTI_GPIO | EXTI_EVENT | EXTI_REG1 | 0x09U) /* EXTI_GPIO                   \
                                                 */
#define EXTI_LINE_10                                                           \
   (EXTI_GPIO | EXTI_EVENT | EXTI_REG1 | 0x0AU) /* EXTI_GPIO */
#define EXTI_LINE_11                                                           \
   (EXTI_GPIO | EXTI_EVENT | EXTI_REG1 | 0x0BU) /* EXTI_GPIO */
#define EXTI_LINE_12                                                           \
   (EXTI_GPIO | EXTI_EVENT | EXTI_REG1 | 0x0CU) /* EXTI_GPIO */
#define EXTI_LINE_13                                                           \
   (EXTI_GPIO | EXTI_EVENT | EXTI_REG1 | 0x0DU) /* EXTI_GPIO */
#define EXTI_LINE_14                                                           \
   (EXTI_GPIO | EXTI_EVENT | EXTI_REG1 | 0x0EU) /* EXTI_GPIO */
#define EXTI_LINE_15                                                           \
   (EXTI_GPIO | EXTI_EVENT | EXTI_REG1 | 0x0FU)        /* EXTI_GPIO */
#define EXTI_LINE_16 (EXTI_CONFIG | EXTI_REG1 | 0x10U) /* PVD and AVD */
#define EXTI_LINE_17                                                           \
   (EXTI_DIRECT | EXTI_EVENT | EXTI_REG1 | 0x11U) /* RTC timestamp and         \
                                                     SecureError wakeup */
#define EXTI_LINE_18                                                           \
   (EXTI_DIRECT | EXTI_EVENT | EXTI_REG1 | 0x12U) /* TAMP tamper and           \
                                                     SecureError wakeup */
#define EXTI_LINE_19                                                           \
   (EXTI_DIRECT | EXTI_EVENT | EXTI_REG1 | 0x13U) /* RTC Wakeup timer and      \
                                                     Alarms (A and B) and      \
                                                     SecureError wakeup */
...
#define EXTI_LINE_42                                                           \
   (EXTI_DIRECT | EXTI_REG2 | 0x0AU) /* USBH port 1 wakeup                     \
                                      */
#define EXTI_LINE_43                                                           \
   (EXTI_DIRECT | EXTI_REG2 | 0x0BU)                     /* USBH port 2 wakeup \
                                                          */
...
#define EXTI_LINE_68                                                           \
   (EXTI_DIRECT | EXTI_REG3 | 0x04U) /* ETH1 pmt_intr_o wakeup */
#define EXTI_LINE_69                                                           \
   (EXTI_DIRECT | EXTI_REG3 | 0x05U) /* ETH1 lpi_intr_o wakeup */
#define EXTI_LINE_70                                                           \
   (EXTI_DIRECT | EXTI_REG3 | 0x06U) /* ETH2 pmt_intr_o wakeup */
#define EXTI_LINE_71                                                           \
   (EXTI_DIRECT | EXTI_REG3 | 0x07U) /* ETH2 lpi_intr_o wakeup */
...
#define EXTI_LINE_75                                                           \
   (EXTI_DIRECT | EXTI_REG3 | 0x0BU) /* CDBGPWRUPREQ event                     \
                                      */
...
#define IS_EXTI_TRIGGER(__EXTI_LINE__)                                         \
   (((__EXTI_LINE__) & ~EXTI_TRIGGER_MASK) == 0x00UL)
...
#define IS_EXTI_CONFIG_LINE(__EXTI_LINE__)                                     \
   (((__EXTI_LINE__) & EXTI_CONFIG) != 0x00UL)
...
HAL_StatusTypeDef HAL_EXTI_GetConfigLine(const EXTI_HandleTypeDef *hexti,
                                         EXTI_ConfigTypeDef *pExtiConfig);
