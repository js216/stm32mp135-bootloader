 ...
 * @retval Error status
 */
uint32_t SDMMC_DMALinkedList_BuildNode(SDMMC_DMALinkNodeTypeDef *pNode,
                                       SDMMC_DMALinkNodeConfTypeDef *pNodeConf)
{
                                        ...
                                        SDMMC_DMALinkNodeTypeDef *pNode)
{
   ...
   if (pLinkedList->NodesCounter == 0U) {
      ...
      if (pLinkedList->NodesCounter == 0U) {
         ...
         MODIFY_REG(prev_node->IDMALAR, SDMMC_IDMALAR_IDMALA,
                    linked_list_offset);
 ...
 */
uint32_t
SDMMC_DMALinkedList_DisableCircularMode(SDMMC_DMALinkedListTypeDef *pLinkedList)
{
