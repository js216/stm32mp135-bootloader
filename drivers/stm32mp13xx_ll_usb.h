...
typedef struct {
   ...
   uint32_t dma_enable; /*!< dma_enable state unused, DMA not supported by FS
                           instance              */
   ...
   uint32_t use_external_vbus; /*!< Enable or disable the use of the external
                                  VBUS.                        */
...
/* Legacy name for USBPHYC defined in CMSIS device but USBCPHYC used in USB
   driver to determine if peripheral is present or not */
#ifdef USB_HS_PHYC
