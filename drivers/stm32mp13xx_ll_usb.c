...
static HAL_StatusTypeDef USB_HS_PHYCInit(const USB_OTG_GlobalTypeDef *USBx)
{
    ...
    *   |          shall be from 19.2MHZ or 38.4MHZ if PHY PLL is in integer
    * Mode | NDIV = integer part of input bits to set the LDF
   ...
   usbphyc_pll = USBPHYC_PLL_PLLDITHEN1 | USBPHYC_PLL_PLLDITHEN0 |
                 USBPHYC_PLL_PLLSTRBYP | ndiv;
